...
return "none" === $(".password-retrieve-area.forgot").css("display") ? (setTimeout(function() {
return $("html body").animate({
scrollTop:$(".password-retrieve-area.forgot input").offset().top
}, 300), setTimeout(function() {
return $(".password-retrieve-area.forgot input").focus();
}, 300);
}, 600), $(".password-retrieve-area.forgot").slideToggle()) :void 0;
...
remember_me = $("#legacy-login input#remember_me").is(":checked"), $(e.currentTarget).addClass("disabled"), 
$(e.currentTarget).html("Verifying.."), $.ajax({
...
success:function(data) {
var error, i, len, _i;
if ($(e.currentTarget).removeClass("disabled"), data.status) return $(e.currentTarget).html("Logging you in..."), 
data.contest_started ? document.location.reload() :document.location.href = document.location.href.replace("/login", "/not_started").replace("/signup", "/not_started");
