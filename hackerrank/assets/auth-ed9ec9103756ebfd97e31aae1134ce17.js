...
data.errors.length > 0 && (error = data.errors[0]), error_msg = "", error_msg = error ? "&signup_error=" + encodeURI(error) :"", 
document.location.href = document.location.protocol + "//" + document.location.host + "/x/login?utm_source=hr_login&email=" + encodeURI(login) + error_msg);
},
error:function() {
