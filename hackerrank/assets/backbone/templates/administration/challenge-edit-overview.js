...
__p += "\n", "create" != action && (__p += '\n    <div class="formgroup horizontal">\n        <label for="translation_language" class="span3">Challenge Difficulty</label>\n        <div class="block span8">\n            <input class="pull-left clear-margin" type="text" id="challenge_difficulty"  style="width:220px !important;"/>\n        </div>\n    </div>\n'), 
