HR.appController.addTemplate("backbone/templates/editorial", function(obj) {
{
var __t, __p = "";
Array.prototype.join;
}
with (obj || {}) {
if (__p += '<div class="row">\n    <div class="span11">\n        ', model.draft && (__p += ' <h2 class="text-center">THIS POST IS STILL A DRAFT.</h2> '), 
__p += "\n        ", model._data) {
...
model._data.difficulty && (__p += '<p class="small bold"><span class="zeta">Difficulty: </span><span class="">' + (null == (__t = model._data.difficulty) ? "" :__t) + "</span></p>"), 
__p += "\n            ", model.statistics) {
__p += "\n            ";
...
__p += "\n            ", model._data.time_complexity && (__p += '<p class="small bold"><span class="zeta">Time Complexity: </span><span class="">' + (null == (__t = model._data.time_complexity) ? "" :__t) + "</span></p>"), 
__p += "\n            ", model._data.required_knowledge && (__p += '<p class="small bold"><span class="zeta">Required Knowledge: </span>' + (null == (__t = model._data.required_knowledge) ? "" :__t) + "</p>"), 
