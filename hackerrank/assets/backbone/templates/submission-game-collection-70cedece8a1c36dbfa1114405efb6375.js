...
collection && _collection.sync_status && (__p += "\n        ", _.each(collection, function(game) {
__p += '\n          <div class="row">\n            <div class="span6">\n              ', 
...
__p += '\n            <div class="span6">\n              ' + (null == (__t = won) ? "" :__t) + "/" + (null == (__t = tied) ? "" :__t) + "/" + (null == (__t = lost) ? "" :__t) + '\n            </div>\n            <div class="span4">\n              <a class="btn show-gameset-button show-gameset-button-' + (null == (__t = game.id) ? "" :__t) + '" data-id="' + (null == (__t = game.id) ? "" :__t) + '" >View Game</a>\n            </div>\n            <div class="span16 show-gameset-container show-gameset-container-' + (null == (__t = game.id) ? "" :__t) + '" data-id="' + (null == (__t = game.id) ? "" :__t) + '" style="display:hidden;">\n            </div>\n          </div>\n        ';
