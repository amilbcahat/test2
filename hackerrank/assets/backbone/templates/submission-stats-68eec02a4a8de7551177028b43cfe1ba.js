...
for (var i = 0; i < model.testcase_message.length; i += 1) __p += '\n                <p><span class="testcase-num"># ' + (null == (__t = i) ? "" :__t) + "</span>\n                ", 
__p += 1 == model.testcase_status[i] ? '<i class="icon-ok success"></i>' :'<i class="icon-cancel-large error"></i> ', 
__p += "\n                " + (null == (__t = Math.round(100 * parseFloat(model.codechecker_time[i])) / 100) ? "" :__t) + "s : " + (null == (__t = model.testcase_message[i]) ? "" :__t) + "\n                ", 
1 == model.downloadable_test_cases && (__p += '\n                    <small><a href="#" class="js-download-test-case small" testcase-num="' + (null == (__t = i) ? "" :__t) + '" data-analytics="TestCase Purchase" rel="tooltip" title="Download testcase #' + (null == (__t = i) ? "" :__t) + '"><i class="icon-download" style="color: rgb(98, 107, 127);" testcase-num="' + (null == (__t = i) ? "" :__t) + '"></i></a></small>\n                '), 
__p += "\n                </p>\n                ";
__p += "\n            </div>\n            ";
}
