...
__p += '</td>\n            <td>\n                <a href="tests/' + (null == (__t = model.tid) ? "" :__t) + "/candidates/" + (null == (__t = model.id) ? "" :__t) + '/report" target="_blank">\n                    ' + (null == (__t = model.email) ? "" :__t) + "\n                </a>\n            </td>\n            <td>" + (null == (__t = model.score) ? "" :__t) + "</td>\n            <td>" + (null == (__t = h[model.ats_state]) ? "" :__t) + '</td>\n            <td>\n                <a href="tests/' + (null == (__t = model.tid) ? "" :__t) + "/candidates/" + (null == (__t = model.id) ? "" :__t) + '/report" target="_blank" class="btn">Open Report</a>\n            </td>\n        </tr>\n        ';
