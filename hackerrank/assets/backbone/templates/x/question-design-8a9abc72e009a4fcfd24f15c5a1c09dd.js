...
"step2" == step && (__p += 'class="active"'), __p += '><a class="js-backbone" href="' + (null == (__t = url_prefix) ? "" :_.escape(__t)) + "/questions/" + (null == (__t = model.id) ? "" :_.escape(__t)) + '/edit/step2"><i class="icon-check"></i> Design Stubs</a></li>\n        </ul>\n        <!-- @akshay add .make-clickable class to the UL below after they cross step 1 -->\n        ') :__p += '\n        <ul class="wizard-steps">\n            <li class="active">\n                <span class="wizard-numb">1</span> PROBLEM STATEMENT\n                <span class="chevron"></span>\n            </li>\n            <li>\n                <span class="wizard-numb">2</span> DESIGN STUBS\n                <span class="chevron"></span>\n            </li>\n        </ul>\n        ', 
