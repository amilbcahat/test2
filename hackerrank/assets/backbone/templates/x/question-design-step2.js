...
"true" !== model.multiple_files && (__p += "checked"), __p += '> <span class="fnt-wt-400">Enable candidate to code in 3 simple tabs, one each for HTML, CSS & Javascript</span></label>\n            <label><input type="radio" name="multiple_files" value="true" ', 
"true" === model.multiple_files && (__p += "checked"), __p += '> <span class="fnt-wt-400">Enable multiple file support (Candidate uses the file structure provided by you).</span></label>\n        </div><!-- end .formgroup -->\n\n    </div><!-- end mjA -->\n\n    <div class="row pjL js-code-stubs-section" ', 
...
"true" === model.multiple_files && model.file_url && (__p += ' (<a href="' + (null == (__t = model.file_url) ? "" :__t) + '" target="_blank">current structure</a>) '), 
