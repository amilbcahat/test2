...
__p += users[userLabel].teams.length > 1 ? "\n                Are you sure you want to remove " + (null == (__t = user_data.firstname + " " + user_data.lastname) ? "" :__t) + " &lt;" + (null == (__t = user_data.email) ? "" :__t) + "&gt; from " + (null == (__t = user_data.team.name) ? "" :__t) + "\n            " :"\n                Are you sure you want to remove " + (null == (__t = user_data.firstname + " " + user_data.lastname) ? "" :__t) + " &lt;" + (null == (__t = user_data.email) ? "" :__t) + "&gt;from " + (null == (__t = user_data.team.name) ? "" :__t) + ". This will also lock his account.\n            ", 
__p += '\n        </div>\n    </div><!-- end .modal-body -->\n    <div class="modal-footer">\n        <div class="text-left mjL">\n            <a href="#" class="btn btn-primary span2 mmR js-remove-user">Yes</a>\n            <a href="" class="btn btn-default" data-dismiss="modal" aria-hidden="true">Cancel</a>\n        </div>\n    </div>\n</div>\n';
return __p;
});