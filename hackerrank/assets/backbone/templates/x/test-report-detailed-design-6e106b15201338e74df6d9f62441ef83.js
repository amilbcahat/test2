HR.appController.addTemplate("backbone/templates/x/test-report-detailed-design", function(obj) {
{
var __p = "";
Array.prototype.join;
}
with (obj || {}) __p += '<div class="msA">\n  ', question.answered !== !1 || anysubmissions ? (__p += "\n    ", 
...
anysubmissions && (__p += '<ul class="nav nav-tabs ungroup js-code-tab"></ul>'), 
