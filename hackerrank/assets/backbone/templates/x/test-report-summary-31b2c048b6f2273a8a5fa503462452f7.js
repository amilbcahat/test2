...
0 != model.status ? (__p += '\n                    <a class="js-backbone" href="tests/' + (null == (__t = model.test.id) ? "" :_.escape(__t)) + "/attempts/" + (null == (__t = model.id) ? "" :_.escape(__t)) + '/report/timeline" ', 
...
__p += '\n            <i class="icon-right-open-mini"></i>\n            <span class="display-inline-block">' + (null == (__t = HR.util.readableQuestionType(question.type)) ? "" :_.escape(__t)) + '</span>\n            <span class="display-block" style="margin-left:37px;"><a href="/tests/' + (null == (__t = test.id) ? "" :_.escape(__t)) + "/attempts/" + (null == (__t = model.id) ? "" :_.escape(__t)) + "/report/detailed/" + (null == (__t = question.id) ? "" :_.escape(__t)) + '" class="js-backbone" data-qid=' + (null == (__t = question.id) ? "" :_.escape(__t)) + ' data-tab="detailed">(view detailed report)</a></span>\n        </td>\n        <td width="15%">' + (null == (__t = tt) ? "" :__t) + "</td>\n        ", 
