...
__p += HR.currentUser.get("company").developers_see_candidate_details && "True" == HR.currentUser.get("company").developers_see_candidate_details && "developer" == HR.currentUser.get("role") ? "\n                    candidate\n                    " :"\n                    " + (null == (__t = model.email) ? "" :_.escape(__t)) + "\n                    ", 
