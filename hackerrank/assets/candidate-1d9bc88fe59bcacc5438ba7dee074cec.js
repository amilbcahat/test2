...
jQuery(function() {
var CandidateActivityModel, CandidateAttemptModel, CandidateCompileTestModel, CandidateQuestionModel, CandidateSolveModel, CandidateTestModel, HR, _ref;
...
this.topbarview && this.topbarview.getTimeLeft && this.topbarview.updateTimer()), 
tbview;
...
HR.candidate.redirectBackTo = href, href ? (HR.candidate.candidateAttemptModel = null, 
...
HR.candidate.secureActivity = new HR.CandidateActivityCollection(), HR.candidate.attemptData = null, 
...
return HR.requires("compound/recruit-candidate", function() {
var clearCookies, redirect, test;
return clearCookies = function() {
return $.removeCookie("email", {
path:"/"
}), $.removeCookie("tid", {
path:"/"
...
}, redirect = function(testmodel, attemptmodel) {
var path, tuid;
return null == attemptmodel && (attemptmodel = null), HR.candidate.redirectBackTo ? (path = HR.candidate.redirectBackTo, 
HR.candidate.redirectBackTo = null, HR.router.navigate(path, {
trigger:!0,
replace:!0
}), void 0) :(tuid = testmodel.get("unique_id"), testmodel.get("attempt_done") ? attemptmodel.get("feedback_given") ? (window.candidatemessage = "You've completed the test.", 
HR.router.navigate("" + tuid + "/message", {
trigger:!0,
replace:!0
}), clearCookies(), void 0) :HR.router.navigate("" + tuid + "/feedback", {
trigger:!0,
replace:!0
...
}, test = new HR.CandidateTestModel(), test.setTidAuth(unique_id, HR.authkey), test.setAction("show"), 
test.fetch({
success:function() {
return function(m) {
var aid, attempt, dat;
return document.title = m.get("name") + " :: powered by HackerRank", HR.candidate.candidateTestModel = m, 
(aid = HR.candidate.candidateTestModel.get("attempt")) ? (attempt = new HR.CandidateAttemptModel(), 
attempt.setAid(aid), dat = HR.candidate.attemptData ? HR.candidate.attemptData :{}, 
attempt.fetch({
data:dat,
processData:!0,
success:function(m) {
return HR.candidate.candidateAttemptModel = m, redirect(test, attempt);
},
error:function() {
return window.candidatemessage = "Unable to receive attempt data.", HR.router.navigate("" + unique_id + "/message", {
trigger:!0,
replace:!0
});
}
})) :($.cookie("fb_data") ? HR.router.navigate("" + unique_id + "/fblogin", {
trigger:!0,
replace:!0
...
error:function() {
return function() {
return clearCookies(), HR.candidate.candidateTestModel = null, window.candidatemessage = "Unable to receive test data from this URL.", 
HR.router.navigate("" + unique_id + "/message", {
trigger:!0,
replace:!0
});
};
...
return HR.requires("compound/recruit-candidate", function() {
var content_view, m;
return HR.candidate.candidateTestModel && HR.candidate.candidateAttemptModel ? (m = HR.candidate.candidateAttemptModel, 
HR.candidate.secureActivity.setAid(m.aid), content_view = new HR.RecruitCandidateListView(), 
...
HR.appView.setSidebarView(HR.RecruitCandidateSideBarView), HR.appView.setFooterView(HR.RecruitCandidateFooterView)) :(HR.candidate.attemptData = {
qlist:!0
...
var m, q;
return HR.candidate.candidateTestModel && HR.candidate.candidateAttemptModel ? (m = HR.candidate.candidateAttemptModel, 
q = new HR.CandidateQuestionModel(), q.setAid(m.get("id")), q.setQid(question_unique_id), 
q.fetch({
success:function() {
return function(m) {
var content_view;
...
var msg, o;
return o = JSON.parse(xhr.responseText), msg = "", o.error && (msg = o.error), new HR.util.ShowConfirmationDialog({
body:"There was a problem with this question page.<br><br>" + msg,
title:"Question error",
buttons:[ {
name:"Go",
callback:function(dialog) {
return dialog.destroy(), HR.router.navigate("" + unique_id + "/redirect", {
trigger:!0,
replace:!0
});
}
...
})) :(HR.candidate.redirectBackTo = Backbone.history.fragment, HR.candidate.attemptData = {
qview:!0,
...
return HR.candidate.candidateTestModel && HR.candidate.candidateAttemptModel ? (m = HR.candidate.candidateAttemptModel, 
HR.candidate.secureActivity.setAid(m.aid), HR.appView.setTopbarView(null), HR.appView.setFooterView(HR.RecruitCandidateFooterView), 
HR.appView.setSidebarView(null), candidate_view = new HR.RecruitCandidateLoginView({
model:HR.candidate.candidateTestModel
}), HR.appView.setContentView(candidate_view)) :(HR.candidate.redirectBackTo = Backbone.history.fragment, 
HR.router.navigate("" + unique_id + "/redirect", {
trigger:!0,
replace:!0
}), void 0);
...
return HR.requires("compound/recruit-candidate", function() {
var candidate_view;
return HR.candidate.candidateTestModel && HR.candidate.candidateAttemptModel ? (candidate_view = new HR.RecruitCandidateInstructionsView({
model:HR.candidate.candidateTestModel
...
HR.appView.setSidebarView(HR.RecruitCandidateSideBarView)) :(HR.candidate.redirectBackTo = Backbone.history.fragment, 
HR.router.navigate("" + unique_id + "/redirect", {
trigger:!0,
replace:!0
}), void 0);
