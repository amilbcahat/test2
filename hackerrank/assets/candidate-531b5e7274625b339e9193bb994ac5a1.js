...
error:function() {
return function() {
return HR.hideThrobber(), window.candidatemessage = "Unable to receive test data from this URL.", 
HR.router.navigate("" + unique_id + "/message", {
trigger:!0,
replace:!0
});
...
console.log(msg), msg ? (msgview = new HR.RecruitMessageView({
...
callback:function() {
return window.location.replace("/tests/" + HR.candidate.candidateTestModel.get("unique_id"));
}
});
