...
HR.candidate.redirectBackTo = null, HR.redirectNeeded = function() {
...
processData:!0,
success:function(m) {
return HR.candidate.attemptRefreshNeeded = !1, HR.candidate.candidateAttemptModel = m, 
redirect(test, attempt);
},
error:function() {
...
return HR.requires("compound/recruit-candidate", function() {
var content_view, m;
return HR.redirectNeeded() ? (HR.candidate.attemptData = {
qlist:!0
...
body:"There was a problem with loading this question page.<br><br>" + msg,
