...
return HR.candidate.candidateTestModel = m, tid = m.get("unique_id"), m.get("logged_in") ? (m.get("logged_in") && !m.get("attempt_done") ? HR.candidate.redirectBackTo ? (path = HR.candidate.redirectBackTo, 
...
return HR.requires("compound/recruit-candidate", function() {
var candidate_view;
return HR.candidate.candidateTestModel ? (candidate_view = new HR.RecruitCandidateInstructionsView({
model:HR.candidate.candidateTestModel
}), HR.candidate.currentQuestion = null, HR.appView.setTopbarView(HR.RecruitCandidateTopBarView), 
HR.appView.setSidebarView(HR.RecruitCandidateSideBarView), HR.appView.setContentView(candidate_view)) :(HR.router.navigate("" + test_unique_id, {
trigger:!0,
replace:!0
}), void 0);
});
