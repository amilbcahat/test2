...
var path, tuid;
return null == attemptmodel && (attemptmodel = null), HR.RecruitCandidateTopBarView && HR.RecruitCandidateTopBarView.updateTimer(), 
...
return $(".toploader").removeClass("hidden");
}, HR.hideThrobber = function(delay) {
return null == delay && (delay = 0), 0 === delay ? $(".toploader").addClass("hidden") :setTimeout(function() {
return $(".toploader").addClass("hidden");
}, delay);
};
});
...
return HR.requires("compound/recruit-candidate", function() {
var test;
return HR.showThrobber(), test = new HR.CandidateTestModel(), test.setTidAuth(unique_id, HR.authkey), 
...
processData:!0,
success:function(m) {
return HR.hideThrobber(1e3), HR.candidate.attemptRefreshNeeded = !1, HR.candidate.candidateAttemptModel = m, 
HR.redirect(test, attempt);
},
error:function() {
return HR.hideThrobber(1e3), window.candidatemessage = "Unable to receive attempt data.", 
...
error:function() {
return function() {
return HR.hideThrobber(), HR.clearCookies(), HR.candidate.candidateTestModel = null, 
window.candidatemessage = "Unable to receive test data from this URL.", HR.router.navigate("" + unique_id + "/message", {
trigger:!0,
replace:!0
});
};
...
model:HR.candidate.candidateTestModel
}), HR.appView.setContentView(candidate_view), window.btoa && window.location.origin.toLowerCase().indexOf("hackerrank.com") >= 0 ? (mixpanel_data = {
