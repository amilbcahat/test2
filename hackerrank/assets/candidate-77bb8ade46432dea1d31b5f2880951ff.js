...
":unique_id/feedback/":"candidate_feedback",
":test_unique_id/questions":"candidate_inner",
":test_unique_id/questions/":"candidate_inner",
":test_unique_id/instructions":"candidate_instructions",
":test_unique_id/instructions/":"candidate_instructions",
":test_unique_id/questions/:question_unique_id":"candidate_inner",
":test_unique_id/questions/:question_unique_id/":"candidate_inner",
...
success:function() {
return function(m) {
var candidate_view, tid;
return HR.candidate.candidateTestModel = m, tid = m.get("unique_id"), m.get("logged_in") ? (m.get("logged_in") && !m.get("attempt_done") ? HR.router.navigate("" + tid + "/questions", {
trigger:!0,
replace:!0
...
}, CandidateRouter.prototype.candidate_inner = function(test_unique_id, question_unique_id) {
return null == question_unique_id && (question_unique_id = null), HR.requires("compound/recruit-candidate", function() {
var attempt, dat, data;
return HR.candidate.candidateTestModel ? (attempt = new HR.CandidateAttemptModel(), 
attempt.setAid(HR.candidate.candidateTestModel.get("attempt")), data = {}, dat = null === question_unique_id ? {
qlist:!0
} :{
qview:!0,
...
return function(m) {
var content_view, q;
return HR.candidate.candidateAttemptModel = m, question_unique_id ? (q = new HR.CandidateQuestionModel(), 
...
var attempt;
return HR.candidate.candidateTestModel ? (attempt = new HR.CandidateAttemptModel(), 
attempt.setAid(HR.candidate.candidateTestModel.get("attempt")), attempt.fetch({
success:function() {
return function(m) {
var candidate_view;
...
var candidate_view;
return candidate_view = new HR.RecruitCandidateInstructionsView({
model:HR.candidate.candidateTestModel
}), HR.appView.setTopbarView(HR.RecruitCandidateTopBarView), HR.appView.setSidebarView(HR.RecruitCandidateSideBarView), 
...
return null == tbview && (tbview = null), this.topbarview = tbview, tbview ? (this.$("#navigation").html(this.topbarview.render().el), 
this.$("#countdown-timer").countdown("destroy").countdown({
...
return HR = window.HR, HR.appController = new HR.CandidateController(), _makeTopLevel = function(source, attributes) {
