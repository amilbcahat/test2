...
HR.candidate.secureActivity = new HR.CandidateActivityCollection(), HR.candidate.questionView = null, 
HR.candidate.questions = {}, HR.candidate.redirectBackTo = null;
...
success:function(m) {
var content_view;
return HR.candidate.candidateAttemptModel = m, m.get("attempt_done") ? HR.router.navigate("" + test_unique_id + "/feedback", {
trigger:!0,
replace:!0
...
return function(m) {
var candidate_view;
return HR.candidate.candidateAttemptModel = m, m.get("attempt_done") ? (HR.candidate.secureActivity.setAid(m.aid), 
...
HR.appView.setSidebarView(HR.RecruitCandidateSideBarView)) :(HR.router.navigate("" + test_unique_id, {
trigger:!0,
replace:!0
}), void 0);
});
