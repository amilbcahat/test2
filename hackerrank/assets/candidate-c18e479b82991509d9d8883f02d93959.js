...
HR.candidate.showFocusMessage = !1, HR.authkey = null, HR.candidate.questionView = null, 
...
var path, tuid;
return null == attemptmodel && (attemptmodel = null), setTimeout(function() {
return function() {
return $("#countdown-timer") && HR.RecruitCandidateTopBarView ? HR.RecruitCandidateTopBarView.updateTimer() :void 0;
};
}(this), 100), HR.candidate.redirectBackTo ? (path = HR.candidate.redirectBackTo, 
