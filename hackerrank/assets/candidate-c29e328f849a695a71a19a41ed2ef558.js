...
console.log("Insider candidate_login route"), HR.requires([ "compound/recruit-candidate" ], function() {
...
}, HR.router = new HR.CandidateRouter(), HR.router ? (console.log("Inside router"), 
Backbone.history.start({
pushState:!0,
root:"/tests/"
