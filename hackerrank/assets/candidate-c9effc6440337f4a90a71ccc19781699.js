...
return "/recruit/attempts/" + this.aid + "/questions/" + this.qid + "/render";
...
}(window.HR.CommonController), HR = null != (_ref = window.HR) ? _ref :{}, HR.CandidateController = CandidateController;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
":unique_id/message":"candidate_message",
":unique_id":"candidate_login",
":unique_id/":"candidate_login",
":unique_id/:authkey":"candidate_login",
":unique_id/:authkey/":"candidate_login",
":unique_id/login/:username":"candidate_login_prefil",
":unique_id/login/:username/":"candidate_login_prefil",
...
}, CandidateRouter.prototype.candidate_message = function(unique_id) {
...
}, CandidateRouter.prototype.public_info = function(subpage) {
return null == subpage && (subpage = "interface"), HR.requires([ "compound/recruit-candidate" ], function() {
var infoview;
return HR.appView.setTopbarView(null), HR.appView.setSidebarView(null), infoview = new HR.RecruitInfoView({
subpage:subpage,
public_url:!0
...
var candidate_view, css, link, m, tid;
return HR.candidate.candidateTestModel ? (m = HR.candidate.candidateTestModel, tid = m.get("unique_id"), 
css = m.get("css"), css && (link = document.createElement("link"), link.type = "text/css", 
link.rel = "stylesheet", link.href = css, document.getElementsByTagName("head")[0].appendChild(link)), 
...
HR.candidate.candidateTestModel || (username && (HR.username = username), password && (HR.password = password), 
...
trigger:!0,
replace:!0
}), void 0) :(candidate_view = new HR.RecruitInfoView({
public_url:!1,
...
h.uml = "UML", h.electrical = "Electrical", h.design = "Design", h.code_upload = "Code upload";
});
...
var unique_id;
return HR.candidate.candidateTestModel ? (unique_id = HR.candidate.candidateTestModel.get("unique_id"), 
HR.util.candidatemsg("Unable to receive test data from this URL.<br><br> Check your internet connection, and continue when you're back online.<br><br><a href='" + unique_id + "/questions' class='backbone btn'>Continue</a>", !1)) :console.log("connectionAlert called when no testmodel available.");
