...
return HR.requires("compound/recruit-candidate", function() {
var test;
return $(".toploader").removeClass("hidden"), test = new HR.CandidateTestModel(), 
test.setTidAuth(unique_id, HR.authkey), test.setAction("show"), test.fetch({
success:function() {
return function(m) {
var aid, attempt, dat;
...
processData:!0,
success:function(m) {
return $(".toploader").addClass("hidden"), HR.candidate.attemptRefreshNeeded = !1, 
HR.candidate.candidateAttemptModel = m, HR.redirect(test, attempt);
},
error:function() {
return $(".toploader").addClass("hidden"), window.candidatemessage = "Unable to receive attempt data.", 
...
error:function() {
return function() {
return $(".toploader").addClass("hidden"), HR.clearCookies(), HR.candidate.candidateTestModel = null, 
