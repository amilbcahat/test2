...
var _errs;
return _errs || (_errs = {}), _errs.meta = {
candidateEmail:HR.candidate.candidateAttemptModel.get("email")
};
}, _this.on("route", function() {
var _errs;
return _errs || (_errs = {}), _errs.history || (_errs.history = []), _errs.history.push(moment(Date.now()).format() + " " + Backbone.history.fragment), 
_errs.history = _errs.history.splice(0, 20);
