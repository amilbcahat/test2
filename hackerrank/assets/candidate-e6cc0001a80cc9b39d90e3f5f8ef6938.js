...
error:function() {
throw HR.connectionAlert && HR.connectionAlert(), "Template `" + that.templatePath("" + template_name + ".html") + "` Not Found";
},
...
error:function() {
return HR.hideThrobber(1), Offline.check(), setTimeout(function() {
return HR.util.candidatemsg("Unable to receive test data from this URL.<br><br> Check your internet connection, and continue when you're back online.<br><br><a href='" + unique_id + "/questions' class='backbone'>Continue</a>", !1);
}, 200);
}
...
error:function() {
return function() {
return HR.hideThrobber(), HR.candidate.candidateTestModel = null, Offline.check(), 
setTimeout(function() {
return HR.util.candidatemsg("Unable to receive test data from this URL.<br><br> Check your internet connection, and continue when you're back online.<br><br><a href='" + unique_id + "/questions' class='backbone'>Continue</a>", !1);
}, 200);
};
...
var msg, msgview;
return msg = window.candidatemessage || $.cookie("candidatemessage") || null, msg ? (msgview = new HR.RecruitMessageView({
