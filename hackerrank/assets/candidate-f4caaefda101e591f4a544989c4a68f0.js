...
}, CandidateController.prototype.loadUmlLibraries = function(callback, errcallback) {
return null == errcallback && (errcallback = null), HR.requires("mxGraph/include", function() {
return function() {
return callback();
};
}(this), function() {
