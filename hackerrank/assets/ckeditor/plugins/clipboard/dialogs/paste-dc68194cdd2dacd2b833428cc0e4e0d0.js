...
d && d.remove(), f.setAttribute("contenteditable", !0), CKEDITOR.env.ie && 8 > CKEDITOR.env.version && b.getWindow().on("blur", function() {
b.$.selection.empty();
...
b && a.preventDefault();
}, this), c.fire("ariaWidget", new CKEDITOR.dom.element(a.frameElement)), b.getWindow().getFrame().removeCustomData("pendingFocus") && f.focus();
}
var e = c.lang.clipboard;
return c.on("pasteDialogCommit", function(a) {
a.data && c.fire("paste", {
type:"auto",
dataValue:a.data
});
...
onShow:function() {
this.parts.dialog.$.offsetHeight, this.setupContent(), this.parts.title.setHtml(this.customTitle || e.title), 
...
commit:function() {
var d, a = this.getDialog().getParentEditor(), b = this.getInputElement().getFrameDocument().getBody(), c = b.getBogus();
c && c.remove(), d = b.getHtml(), setTimeout(function() {
