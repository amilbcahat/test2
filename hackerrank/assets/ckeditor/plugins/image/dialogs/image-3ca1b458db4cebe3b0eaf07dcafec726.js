...
var s, t, f = 1, k = /^\s*(\d+)((px)|\%)?\s*$/i, v = /(^\s*(\d+)((px)|\%)?\s*$)|^$/i, o = /^\d+px$/, w = function() {
var a = this.getValue(), b = this.getDialog(), d = a.match(k);
d && ("%" == d[2] && l(b, !1), a = d[1]), b.lockRatio && (d = b.originalElement, 
"true" == d.getCustomData("isReady") && ("txtHeight" == this.id ? (a && "0" != a && (a = Math.round(d.$.width * (a / d.$.height))), 
isNaN(a) || b.setValueOf("info", "txtWidth", a)) :(a && "0" != a && (a = Math.round(d.$.height * (a / d.$.width))), 
isNaN(a) || b.setValueOf("info", "txtHeight", a)))), g(b);
}, g = function(a) {
...
a.lockRatio = !1, e || c ? !isNaN(d) && !isNaN(f) && Math.round(d) == Math.round(f) && (a.lockRatio = !0) :a.lockRatio = !0;
}
} else void 0 != b ? a.lockRatio = b :(a.userlockRatio = 1, a.lockRatio = !a.lockRatio);
return e = CKEDITOR.document.getById(p), a.lockRatio ? e.removeClass("cke_btn_unlocked") :e.addClass("cke_btn_unlocked"), 
e.setAttribute("aria-checked", a.lockRatio), CKEDITOR.env.hc && e.getChild(0).setHtml(a.lockRatio ? CKEDITOR.env.ie ? "\u25a0" :"\u25a3" :CKEDITOR.env.ie ? "\u25a1" :"\u25a2"), 
a.lockRatio;
}, x = function(a) {
...
d && d.setValue(b.$.width), e && e.setValue(b.$.height);
}
g(a);
}, y = function(a, b) {
function d(a, b) {
...
h && (c = d(h, c)), c = d(b.getStyle(g), c), this.setValue(c);
}
}, q = function() {
var a = this.originalElement;
a.setCustomData("isReady", "true"), a.removeListener("load", q), a.removeListener("error", h), 
a.removeListener("abort", h), CKEDITOR.document.getById(m).setStyle("display", "none"), 
this.dontResetSize || x(this), this.firstLoad && CKEDITOR.tools.setTimeout(function() {
l(this, "check");
}, 0, this), this.dontResetSize = this.firstLoad = !1;
}, h = function() {
var a = this.originalElement;
a.removeListener("load", q), a.removeListener("error", h), a.removeListener("abort", h), 
a = CKEDITOR.getUrl(CKEDITOR.plugins.get("image").path + "images/noimage.png"), 
this.preview && this.preview.setAttribute("src", a), CKEDITOR.document.getById(m).setStyle("display", "none"), 
l(this, !1);
}, n = function(a) {
...
this.lockRatio = !0, this.userlockRatio = 0, this.dontResetSize = !1, this.firstLoad = !0, 
this.addLink = !1;
var a = this.getParentEditor(), b = a.getSelection(), d = (b = b && b.getSelectedElement()) && a.elementPath(b).contains("a", 1);
if (CKEDITOR.document.getById(m).setStyle("display", "none"), t = new CKEDITOR.dom.element("img", a.document), 
this.preview = CKEDITOR.document.getById(z), this.originalElement = a.document.createElement("img"), 
this.originalElement.setAttribute("alt", ""), this.originalElement.setCustomData("isReady", "false"), 
d) {
this.linkElement = d, this.linkEditMode = !0;
var c = d.getChildren();
if (1 == c.count()) {
var g = c.getItem(0).getName();
("img" == g || "input" == g) && (this.imageElement = c.getItem(0), "img" == this.imageElement.getName() ? this.imageEditMode = "img" :"input" == this.imageElement.getName() && (this.imageEditMode = "input"));
}
"image" == j && this.setupContent(2, d);
}
this.customImageElement ? (this.imageEditMode = "img", this.imageElement = this.customImageElement, 
delete this.customImageElement) :(b && "img" == b.getName() && !b.data("cke-realelement") || b && "input" == b.getName() && "image" == b.getAttribute("type")) && (this.imageEditMode = b.getName(), 
this.imageElement = b), this.imageEditMode ? (this.cleanImageElement = this.imageElement, 
this.imageElement = this.cleanImageElement.clone(!0, !0), this.setupContent(f, this.imageElement)) :this.imageElement = a.document.createElement("img"), 
l(this, !0), CKEDITOR.tools.trim(this.getValueOf("info", "txtUrl")) || (this.preview.removeAttribute("src"), 
this.preview.setStyle("display", "none"));
},
onOk:function() {
if (this.imageEditMode) {
var a = this.imageEditMode;
"image" == j && "input" == a && confirm(c.lang.image.button2Img) ? (this.imageElement = c.document.createElement("img"), 
this.imageElement.setAttribute("alt", ""), c.insertElement(this.imageElement)) :"image" != j && "img" == a && confirm(c.lang.image.img2Button) ? (this.imageElement = c.document.createElement("input"), 
this.imageElement.setAttributes({
type:"image",
alt:""
}), c.insertElement(this.imageElement)) :(this.imageElement = this.cleanImageElement, 
delete this.cleanImageElement);
} else "image" == j ? this.imageElement = c.document.createElement("img") :(this.imageElement = c.document.createElement("input"), 
this.imageElement.setAttribute("type", "image")), this.imageElement.setAttribute("alt", "");
this.linkEditMode || (this.linkElement = c.document.createElement("a")), this.commitContent(f, this.imageElement), 
this.commitContent(2, this.linkElement), this.imageElement.getAttribute("style") || this.imageElement.removeAttribute("style"), 
this.imageEditMode ? !this.linkEditMode && this.addLink ? (c.insertElement(this.linkElement), 
this.imageElement.appendTo(this.linkElement)) :this.linkEditMode && !this.addLink && (c.getSelection().selectElement(this.linkElement), 
c.insertElement(this.imageElement)) :this.addLink ? this.linkEditMode ? c.insertElement(this.imageElement) :(c.insertElement(this.linkElement), 
this.linkElement.append(this.imageElement, !1)) :c.insertElement(this.imageElement);
},
onLoad:function() {
"image" != j && this.hidePage("Link");
var a = this._.element.getDocument();
this.getContentElement("info", "ratioLock") && (this.addFocusable(a.getById(u), 5), 
this.addFocusable(a.getById(p), 5)), this.commitContent = r;
},
onHide:function() {
this.preview && this.commitContent(8, this.preview), this.originalElement && (this.originalElement.removeListener("load", q), 
this.originalElement.removeListener("error", h), this.originalElement.removeListener("abort", h), 
this.originalElement.remove(), this.originalElement = !1), delete this.imageElement;
},
contents:[ {
id:"info",
...
a.preview.removeStyle("display"), d.setCustomData("isReady", "false");
var c = CKEDITOR.document.getById(m);
c && c.setStyle("display", ""), d.on("load", q, a), d.on("error", h, a), d.on("abort", h, a), 
d.setAttribute("src", b), t.setAttribute("src", b), a.preview.setAttribute("src", t.$.src), 
g(a);
...
this.getDialog().dontResetSize = !0, this.setValue(d), this.setInitValue();
}
},
commit:function(a, b) {
...
var c = this.getValue();
a == f ? (c ? b.setStyle("width", CKEDITOR.tools.cssLength(c)) :b.removeStyle("width"), 
!d && b.removeAttribute("width")) :4 == a ? c.match(k) ? b.setStyle("width", CKEDITOR.tools.cssLength(c)) :(a = this.getDialog().originalElement, 
"true" == a.getCustomData("isReady") && b.setStyle("width", a.$.width + "px")) :8 == a && (b.removeAttribute("width"), 
b.removeStyle("width"));
}
}, {
type:"text",
...
commit:function(a, b, d) {
var c = this.getValue();
a == f ? (c ? b.setStyle("height", CKEDITOR.tools.cssLength(c)) :b.removeStyle("height"), 
!d && b.removeAttribute("height")) :4 == a ? c.match(k) ? b.setStyle("height", CKEDITOR.tools.cssLength(c)) :(a = this.getDialog().originalElement, 
"true" == a.getCustomData("isReady") && b.setStyle("height", a.$.height + "px")) :8 == a && (b.removeAttribute("height"), 
...
"true" == b.getCustomData("isReady") && c && (b = b.$.height / b.$.width * c, isNaN(b) || (this.setValueOf("info", "txtHeight", Math.round(b)), 
g(this))), a.data && a.data.preventDefault();
...
isNaN(parseInt(d, 10)) && (d = b.getAttribute("border")), this.setValue(d);
}
},
commit:function(a, b, d) {
...
b.setStyle("border-style", "solid")), !d && a == f && b.removeAttribute("border")) :8 == a && (b.removeAttribute("border"), 
b.removeStyle("border-width"), b.removeStyle("border-style"), b.removeStyle("border-color"));
}
}, {
type:"text",
id:"txtHSpace",
...
if (a == f) {
var d, c;
d = b.getStyle("margin-left"), c = b.getStyle("margin-right"), d = d && d.match(o), 
c = c && c.match(o), d = parseInt(d, 10), c = parseInt(c, 10), d = d == c && d, 
isNaN(parseInt(d, 10)) && (d = b.getAttribute("hspace")), this.setValue(d);
}
},
commit:function(a, b, c) {
var e = parseInt(this.getValue(), 10);
a == f || 4 == a ? (isNaN(e) ? !e && this.isChanged() && (b.removeStyle("margin-left"), 
b.removeStyle("margin-right")) :(b.setStyle("margin-left", CKEDITOR.tools.cssLength(e)), 
b.setStyle("margin-right", CKEDITOR.tools.cssLength(e))), !c && a == f && b.removeAttribute("hspace")) :8 == a && (b.removeAttribute("hspace"), 
...
if (a == f) {
var c, e;
c = b.getStyle("margin-top"), e = b.getStyle("margin-bottom"), c = c && c.match(o), 
e = e && e.match(o), c = parseInt(c, 10), e = parseInt(e, 10), c = c == e && c, 
isNaN(parseInt(c, 10)) && (c = b.getAttribute("vspace")), this.setValue(c);
}
},
commit:function(a, b, c) {
var e = parseInt(this.getValue(), 10);
a == f || 4 == a ? (isNaN(e) ? !e && this.isChanged() && (b.removeStyle("margin-top"), 
b.removeStyle("margin-bottom")) :(b.setStyle("margin-top", CKEDITOR.tools.cssLength(e)), 
b.setStyle("margin-bottom", CKEDITOR.tools.cssLength(e))), !c && a == f && b.removeAttribute("vspace")) :8 == a && (b.removeAttribute("vspace"), 
...
b.data("cke-saved-href", d), b.setAttribute("href", d), (this.getValue() || !c.config.image_removeLinkByEmptyURL) && (this.getDialog().addLink = !0);
}
}
}, {
type:"button",
