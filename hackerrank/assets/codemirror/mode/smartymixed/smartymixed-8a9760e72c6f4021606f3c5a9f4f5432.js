...
!function(mod) {
"object" == typeof exports && "object" == typeof module ? mod(require("../../lib/codemirror"), require("../htmlmixed/htmlmixed"), require("../smarty/smarty")) :"function" == typeof define && define.amd ? define([ "../../lib/codemirror", "../htmlmixed/htmlmixed", "../smarty/smarty" ], mod) :mod(CodeMirror);
}(function(CodeMirror) {
"use strict";
...
var htmlMixedMode = CodeMirror.getMode(config, "htmlmixed"), smartyMode = CodeMirror.getMode(config, "smarty"), settings = {
rightDelimiter:"}",
leftDelimiter:"{"
};
...
var reLeft = reEsc(settings.leftDelimiter), reRight = reEsc(settings.rightDelimiter), regs = {
...
}, "htmlmixed", "smarty"), CodeMirror.defineMIME("text/x-smarty", "smartymixed");
});