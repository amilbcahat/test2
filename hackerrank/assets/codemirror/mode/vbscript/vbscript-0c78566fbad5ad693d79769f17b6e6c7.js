...
"variable" === style.substr(0, 8) || "builtin" === style || "keyword" === style ? (("builtin" === style || "keyword" === style) && (style = "variable"), 
knownWords.indexOf(current.substr(1)) > -1 && (style = "variable-2"), style) :ERRORCLASS) :style;
}
