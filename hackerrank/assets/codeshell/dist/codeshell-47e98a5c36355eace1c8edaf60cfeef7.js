...
_create:function() {
var e, that, _autoCompleteReqestStatus, _suggestionBoxDisplayStatus;
...
}), this.options.enableIntellisense && this.codeEditor.on("keydown", function() {
that._autoCompleteReqestStatus === !0 && (that._autoCompleteReqestStatus = !1);
...
}(this)), this.options.enableIntellisense && this._initializeAutoComplete(), _suggestionBoxDisplayStatus = !1, 
_autoCompleteReqestStatus = !1, this._bindVersionBall(), this._bindCurrentVersionBall(), 
...
var adjustTop, box, cm, ele, height, newTop, pos, winH, winW;
