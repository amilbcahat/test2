...
$(".code-body").css("height", "400px"), $(".code-editors").css("max-height", "400px");
},
...
return $(".compiletest-dialog").hide(), $(".hidden-compiletest").show(), $(".resize-compiletest").click(function() {
return $(".compiletest-dialog").show(), $(".hidden-compiletest").hide();
});
},
...
$(".hidden-compiletest").hide(), $(".compiletest-dialog-body").css("max-height", $(document).height() / 2 + "px"), 
