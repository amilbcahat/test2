...
var data, i, lineCh, offsetpos, retHintValues, that;
for (lineCh = cm.getCursor(), offsetpos = 0, i = 0; i < lineCh.line; ) offsetpos += cm.getLine(i).length + 1, 
i++;
return offsetpos += lineCh.ch, data = {
offset:offsetpos,
fileType:this.options.language,
code:cm.getValue()
