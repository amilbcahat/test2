...
tabSize:4,
lineWrapping:!0
}, this.$("textarea.problem-statement").get(0) && !this.problem_statement_editor && (this.problem_statement_editor = CodeMirror.fromTextArea(this.$("textarea.problem-statement").get(0), editorOptions), 
this.problem_statement_editor.on("change", this.throttledSave)), this.setData(this.model.toJSON());
...
_this.description_editor.on("change", _this.throttledSave), _this.setData(_this.model.toJSON())) :void 0;
};
