...
showFullScreen:!1,
showTheme:!0
}), _.isString(this.model.get("checker_program")) && _.isString(this.model.get("custom_language")) ? this.$("#codeeditor").codeshell("setValue", {
code:this.model.get("checker_program"),
language:this.model.get("custom_language")
}) :this.$("#codeeditor").codeshell("setValue", {
code:"",
language:"python"
});
