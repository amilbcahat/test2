...
var ex_data;
return ex_data = data.editorial.extra_data, ex_data && (ex_data.difficulty && this.$("input#difficulty").val(ex_data.difficulty), 
...
data.time_complexity = this.$("input#time_complexity").val(), data.setter_code_markdown = data.setter_code, 
data.tester_code_markdown = data.tester_code, data.approach_markdown = data.approach, 
data;
...
return function() {
var converter, sanitized_text;
return converter = Markdown.getSanitizingConverter(), sanitized_text = converter.makeHtml(HR.util.convert_tilde(e.getValue())), 
"" === sanitized_text ? _this.$(preview_wrap).hide() :_this.$(preview_wrap).show(), 
...
_model:this.model.toJSON(),
action:this.action
})), that = this, this.$("input.tags").length > 0 && this.$("input.tags").tagsInput({
width:"98%",
...
this.problem_statement_editor.on("change", this.throttledSave), this.problem_statement_editor.on("change", function() {
...
data.body && this.problem_statement_editor && this.problem_statement_editor.setValue(data.body_original), 
...
return this.model.get("name") !== this.$("input#name").val() ? !0 :this.model.get("preview") !== this.$("textarea.description").val() ? !0 :this.model.get("body_original") !== this.problem_statement_editor.getValue() ? !0 :_.difference(this.model.getTags(), this.getTags()).length > 0 || _.difference(this.getTags(), this.model.getTags()).length > 0 ? !0 :!1;
...
data.body_original = data.body, data.tags = this.getTags(), "" === data.body && (data.body = null), 
data;
...
return function() {
var converter, sanitized_text;
return converter = Markdown.getSanitizingConverter(), sanitized_text = converter.makeHtml(HR.util.convert_tilde(_this.problem_statement_editor.getValue())), 
...
_this.description_editor.on("change", _this.throttledSave), _this.setData(_this.model.toJSON()), 
_this.description_editor.on("change", function() {
return that.updatePreview();
})) :void 0;
};
...
var timestamps;
return timestamps = this.getTimeStamps(), this.model.get("starttime") !== timestamps._starttime ? !0 :this.model.get("endtime") !== timestamps._endtime ? !0 :this.$("input#name").val() !== this.model.get("name") ? !0 :this.$("textarea.tagline").val() !== this.model.get("tagline") ? !0 :this.description_editor.getValue() !== this.model.get("description_original") ? !0 :!1;
...
data.description_original = data.description, "" === data.description && (data.description = null), 
data;
...
data.description_original && this.description_editor && this.description_editor.setValue(data.description_original), 
...
return function() {
var converter, sanitized_text;
return converter = Markdown.getSanitizingConverter(), sanitized_text = converter.makeHtml(HR.util.convert_tilde(_this.description_editor.getValue())), 
"" === sanitized_text ? _this.$(".preview-wrap").hide() :_this.$(".preview-wrap").show(), 
