...
return converter = Markdown.getSanitizingConverter(), sanitized_text = converter.makeHtml(e.getValue()), 
...
return function() {
var converter, sanitized_text;
return converter = Markdown.getSanitizingConverter(), sanitized_text = converter.makeHtml(_this.problem_statement_editor.getValue()), 
...
return function() {
var converter, sanitized_text;
return converter = Markdown.getSanitizingConverter(), sanitized_text = converter.makeHtml(_this.description_editor.getValue()), 
"" === sanitized_text ? _this.$(".preview-wrap").hide() :_this.$(".preview-wrap").show(), 
