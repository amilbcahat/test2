...
_model:this.model.toJSON(),
action:this.action
})), this.setupTranslationLanguageSelect(), that = this, this.$("input.tags").length > 0 && this.$("input.tags").tagsInput({
width:"98%",
...
return _.difference(this.model.getTags(), this.getTags()).length > 0 || _.difference(this.getTags(), this.model.getTags()).length > 0 ? !0 :!1;
