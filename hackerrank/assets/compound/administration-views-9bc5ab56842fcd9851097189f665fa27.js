...
return HR.requires("languagelist", function(_this) {
return function() {
var data, languages;
return languages = HR.TRANSLATION_LANGUAGES, data = [], _.each(languages, function(code, name) {
return data.push({
id:name,
text:name
});
...
return HR.requires("languagelist", function(_this) {
return function() {
return _this.setData(_this.model.toJSON());
};
}(this));
