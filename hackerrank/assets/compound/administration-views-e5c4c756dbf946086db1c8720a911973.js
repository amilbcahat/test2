...
return weights[parseInt($(val).attr("data-id"))] = parseInt($(val).find("input.weight").val()), 
$(val).find("span.weight").html($(val).find("input.weight").val());
}), $.ajax({
...
contest.save(null, {
success:function(model) {
return HR.router.navigate("/administration/contests/edit/" + model.get("id"), {
trigger:!0,
replace:!0
}), $(e.currentTarget).removeAttr("disabled"), $(e.currentTarget).html("Save Contest");
}
