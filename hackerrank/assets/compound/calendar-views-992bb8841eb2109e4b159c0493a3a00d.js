...
content:"<div class='text-center'><h3>" + event.startdate + "</h3><h3> " + event.starttime + "</h3><img width='48' height='48' src='https://" + window.location.host + "/assets/calendar/" + event.preview + "' alt=''/></div><p class='margin-large top text-center'><a href= " + event.url + " target='_blank'>View Contest</a></p><p class='margin-large top text-center'><a href= 'http://www.google.com/calendar/render?cid=http://" + window.location.host + "/calendar/" + event.id + "/cal.ics' class='btn' target='_blank'>Add to Calendar</a></p>",
