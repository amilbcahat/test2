...
success:function(_this) {
return function() {
return _this.contest.get("signed_up") ? ($("div.popover").addClass("hr-contest-popover-registered").removeClass("hr-contest-loader"), 
$(".register_p." + event.id).empty(), $(".register_p." + event.id).append("Registered"), 
$(".register_p." + event.id).removeClass("register").addClass("disabled")) :($("div.popover").removeClass("hr-contest-loader").addClass("hr-contest-popover-register"), 
$(".register_p." + event.id).empty(), $(".register_p." + event.id).append("Register"));
};
}(this)
})) :void 0;
