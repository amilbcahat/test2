...
$(e.currentTarget).html("Signing up..."), $("div.popover").addClass("hr-contest-popover-signup"), 
$(e.currentTarget).attr("disabled", "disabled"), that = this, $.ajax({
type:"POST",
...
} ]), data.status ? ($(e.currentTarget).html("Registered"), $("div.popover").addClass("hr-contest-popover-registered").removeClass("hr-contest-popover-signup"), 
...
$("div.popover").removeClass("hr-contest-popover-signup"));
};
}(this)
})) :void 0;
...
success:function(_this) {
return function() {
return _this.contest.get("signed_up") ? ($(".register_p." + event.id).empty(), $(".register_p." + event.id).append("Registered"), 
$(".register_p." + event.id).removeClass("register").addClass("disabled"), $("div.popover").addClass("hr-contest-popover-registered").removeClass("hr-contest-loader")) :($(".register_p." + event.id).empty(), 
$(".register_p." + event.id).append("Register"), $("div.popover").addClass("hr-contest-popover-register").removeClass("hr-contest-loader"));
};
}(this)
})) :void 0;
...
var viewloader;
return viewloader = "", "hackerrank.png" === event.preview && (viewloader = "<p class='btn btn-green btn-small inline register register_p " + event.id + "'><img height='20' src='/assets/ajax-view-loader.gif'> <p>"), 
element.popover({
animation:!0,
html:!0,
placement:"top",
...
content:"<div class='text-center'><h3>" + event.startdate + "</h3><h3> " + event.starttime + "</h3><img width='48' height='48' src='https://" + window.location.host + "/assets/calendar/" + event.preview + "' alt=''/></div><p class='inline viewcontest'><a href= " + event.url + " class='btn btn-small' target='_blank'>View Contest</a></p><p class='inline addtocalendar' id= " + event.id + " ><a href= " + event.url + " class='btn btn-small' target='_blank'>Add to Calendar</a></p>" + viewloader,
...
"hackerrank.png" === event.preview ? $("div.popover").addClass("hr-contest-loader") :$("div.popover").addClass("other-contest-popover"), 
!1;
},
