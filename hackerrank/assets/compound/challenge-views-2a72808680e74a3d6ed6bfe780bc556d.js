...
return function() {
return _this.applyCodeshell(), _this.isFullscreened && _this.$(".fullscreen").click(), 
HR.clipboard && HR.setClipBoard ? (_this.codeshellwrapper.codeshell("setValue", HR.clipboard), 
_this.scrollToEditor(), HR.setClipBoard = !1) :void 0;
};
}(this))), this;
