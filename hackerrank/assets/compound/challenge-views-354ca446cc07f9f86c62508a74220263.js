...
}), 1 === filter.length ? ($(".challenge-text").html(filter[0].body_html || this.model.get("body_html")), 
$(".hr_tour-challenge-name").html(filter[0].name || this.model.get("name"))) :($(".challenge-text").html(this.model.get("body_html")), 
$(".hr_tour-challenge-name").html(this.model.get("name")));
