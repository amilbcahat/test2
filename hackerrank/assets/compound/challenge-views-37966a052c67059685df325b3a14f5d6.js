...
return that.body = new HR.SubmissionView({
...
gameset_collection.setSid(submissionId), gameset_collection.cached(), that.body.setGameSetCollection(gameset_collection)), 
that.body.gameset && that.body.gameset.resetGameSetView(), that.assign({
".challenge-body":that.body
