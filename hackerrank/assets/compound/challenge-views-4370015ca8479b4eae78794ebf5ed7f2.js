...
return HR.clipboard && HR.setClipBoard ? (setTimeout(this.codeshellwrapper.codeshell("setValue", HR.clipboard)), 
this.scrollToEditor(), HR.setClipBoard = !1) :void 0;
}, CodeEditorView.prototype.scrollToEditor = function() {
return $("body").scrollTop($("#codeshell-wrapper").offset().top - 50);
}, CodeEditorView;
