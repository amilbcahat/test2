...
return changed_language = $(e.currentTarget).val(), filter = _.select(this.model.get("available_translations"), function(translation) {
...
return current_language = _.contains(this.model.get("available_translation_languages"), this.current_hacker.get("local_language")) ? this.current_hacker.get("local_language") :"English", 
