...
var body, form_properties, options;
...
options = {
title:"WELCOME IN, " + HR.profile().get("username").toUpperCase()
}, body = "<div class='padding-large right left onboarding_modal'> <p class='text-center margin-large top bottom'> This is the code editor. You can compile your code, view this problems leaderboard, submissions, and discussions, and submit for scoring when you are ready. We have left some helpful hints in case you get stuck. </p> </div> <footer><a class='margin-large bottom span4 block-center btn btn-green btn-large close'>Start</a></footer>", 
options.body = body, options.width = 640, this.dialog = new HR.util.ShowDialog(options, form_properties), 
