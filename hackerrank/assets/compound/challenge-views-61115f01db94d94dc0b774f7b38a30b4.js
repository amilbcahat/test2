...
fullScreenSelector:".span11.hr_tour-problem-statement",
compileTest:".challenge-response",
...
that.submitLock = !0, $("#codeshell-wrapper").codeshell("deleteLangCode"), $("#codeshell-wrapper").codeshell("teardown"), 
...
that.submitLock = !1, response.status ? (dialog.destroy(), $("body").removeClass("fullscreen-body"), 
