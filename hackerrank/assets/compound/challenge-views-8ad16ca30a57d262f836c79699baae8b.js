...
}, this.model.getLanguageTemplates())), this.$("#codeshell-wrapper").codeshell("onChange", this.setClipboard), 
this.$("#codeshell-wrapper").codeshell("onChange", this.deleteMarkersOnSource);
