...
this.model.bind("reset", this.render, this), this.contest = options.contest, this.get_recent_hackers(), 
...
$(".hr_tour-challenge-name").html(filter[0].name || _this.model.get("name")), _this.updatePdfLink(filter[0].language)) :($(".challenge-text").html(_this.model.get("body_html")), 
$(".hr_tour-challenge-name").html(_this.model.get("name")), _this.updatePdfLink("English"));
};
}(this), HR.requires([ "MathJax/MathJax" ], render_name_html), render_name_html();
}, ChallengeContentView.prototype.updatePdfLink = function(language) {
var element, pdf_url, rest;
return $("#pdf-link").size() > 0 ? (element = $("#pdf-link")[0], pdf_url = "/rest" + HR.appController.namespace(HR.appController.get_current_contest_slug(), rest = !0) + "challenges/" + this.model.get("slug") + "/download_pdf?language=" + language, 
$("#pdf-link")[0].href = pdf_url) :void 0;
...
recent_hackers:_this.recent_hackers
})), _this.setLanguageSelected();
};
...
$("option[value=" + current_language + "]").attr("selected", "selected"), this.updatePdfLink(current_language);
