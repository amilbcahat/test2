...
}), 1 === filter.length && ($(".challenge-text").html(filter[0].body_html), $(".hr_tour-challenge-name").html(filter[0].name)), 
this.current_hacker.get("local_language") ? void 0 :$("#preference-msg").css("display", "inline-block");
