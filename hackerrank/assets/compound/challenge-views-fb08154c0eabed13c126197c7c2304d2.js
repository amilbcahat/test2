...
contest_slug = this.model.get("contest_slug"), this.setTab("#problemTab"), this.body && this.body.model.get("id") === this.model.get("id") || (this.body && this.body.destroy(), 
this.body = new HR.ChallengeTemplateView({
model:this.model
})), this.assign({
