...
}), this.processBlank() ? this :(keys = _.keys(this.collection.filters), keys.length > 0 && (keys.length > 0 && (this.activeFilter = keys[0]), 
filterValue = this.collection.filters[this.activeFilter], this.$(".filter-value-" + this.activeFilter).click(), 
this.setFilter(filterValue)), this.collection.sync_status && (leadersDiv = $(), 
that = this, _.each(this.collection.models, function(model) {
var _view;
return _view = new HR.OverallLeaderboardListView({
leader:model
