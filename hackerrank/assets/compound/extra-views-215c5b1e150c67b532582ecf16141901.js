...
return "<div class='leaderboard-overall-list-view'> <div class='row padding-small top bottom' style='height: 38px'> <div class='span1 text-center'> <p>" + leader.rank + "</p> </div> <div class='span4'> <p> <a class='backbone cursor leaderboard-hackername rg_" + leader.level + "' data-action='hacker-modal' rel='tooltip' data-value='" + leader.hacker + "' href='/" + leader.hacker + "' target='_blank'> <img class='avatar' width='30' height='30' src='" + leader.avatar + "'> " + leader.hacker + " </a> </p> </div> <div class='span1'> <p>" + leader.score.toFixed(2) + "</p> </div> </div> </div>";
...
var _model;
return _model = this.model.toJSON(), this.model.sync_status && $(this.el).html(HR.appController.template(this.template, this)({
model:_model,
current_hacker:this.current_hacker.toJSON()
})), this;
}, EditorialView;
