...
var dialog;
return event && event.data ? event.data.status === !0 ? (dialog = new HR.util.ShowConfirmationDialog({
title:"Successfully submitted",
body:"Thank you for submitting the blog. We will review it and publish it soon."
}), dialog.render()) :$("#error-message").html(event.data.error).show() :void 0;
}, WriteblogView.prototype.postBlog = function(e) {
var data, dialog, receiver, that;
...
receiver = $("#receiver")[0].contentWindow, receiver.postMessage(data, "" + this.getWordpressBaseUrl() + "/editor/editor.php")) :(dialog = new HR.util.ShowLoginDialog({
