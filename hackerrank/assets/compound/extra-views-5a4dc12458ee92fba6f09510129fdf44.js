...
return this.$(".filter-input").val(value), this.$(".filter-input").css("background-color", "lightgray").prop("disabled", "true"), 
...
})), that = this, this.$(".track-selection select").select2(), this.$(".track-selection select").on("change", function(e) {
