...
this.renderNotifications()), this.$(".manage-switch").not(".has-switch").bootstrapSwitch(), 
this.current_tab) ? $("a[data-target=#" + this.current_tab + "]").trigger("click") :void 0;
...
var error_html;
return status ? $(this.el).find(".message").removeClass("error").addClass("success").html("<ul style='margin-left:30px'><li>Your Changes have been saved</li></ul>").show() :($(this.el).find(".message").removeClass("success").addClass("error"), 
...
}(this)), $(this.el).find(".message").html("<ul style='margin-left:30px'>" + error_html + "</ul>").show());
...
WriteblogView.prototype.className = "write-blog container", WriteblogView.prototype.initialize = function() {
...
return $(this.el).html(HR.appController.template(this.template, this)({
wordpressbaseurl:this.getWordpressBaseUrl()
})), window.addEventListener("message", this.receiveMessage, !1), this;
}, WriteblogView.prototype.newArticle = function(e) {
return e.preventDefault(), $(".wp-editor").removeClass("hide"), $("#message").addClass("hide");
}, WriteblogView.prototype.getWordpressBaseUrl = function() {
return HR.development ? "http://localhost/wordpress" :"https://blog.hackerrank.com";
}, WriteblogView.prototype.receiveMessage = function(event) {
var $btn, dialog;
return $btn = $("#postblog"), event && event.data && (event.data.status === !0 ? (dialog = new HR.util.ShowConfirmationDialog({
title:"Successfully submitted",
body:"Thank you for submitting your article. We will review and publish it soon."
}), dialog.render(), $(".wp-editor").addClass("hide"), $("#message").removeClass("hide")) :($("#error-message").html(event.data.error).show(), 
$("html, body").animate({
scrollTop:0
}, "slow"))), $btn.removeAttr("btn-disabled"), $btn.removeClass("disabled");
...
$btn.addClass("disabled"), data = {}, data.username = this.profile.get("username"), 
data.wordpressBaseUrl = this.getWordpressBaseUrl(), sender = $("#editor-iframe")[0].contentWindow, 
sender.postMessage(data, "" + this.getWordpressBaseUrl() + "/editor/editor.php")) :(dialog = new HR.util.ShowLoginDialog({
