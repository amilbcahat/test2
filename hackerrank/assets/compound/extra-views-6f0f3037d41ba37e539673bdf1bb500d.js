...
}), dialog.render()) :$("#error-message").html(event.data.error).show()), $btn.removeAttr("btn-disabled")) :void 0;
...
}(this), HR.requires("MathJax/MathJax", render_template), render_template(), this;
}, EditorialView;
