...
return function() {
var sender;
return sender = $("#editor-iframe")[0].contentWindow, sender.postMessage(_this.getData("initMessage"), "" + HR.util.getWordpressBaseUrl() + "/editor/editor.php");
};
}(this));
...
$btn.addClass("disabled"), sender = $("#editor-iframe")[0].contentWindow, sender.postMessage(this.getData("submit"), "" + HR.util.getWordpressBaseUrl() + "/editor/editor.php")) :(dialog = new HR.util.ShowLoginDialog({
...
that = this, this.profile.isLoggedIn() ? ($btn.attr("btn-disabled", "disabled"), 
$btn.addClass("disabled"), sender = $("#editor-iframe")[0].contentWindow, sender.postMessage(this.getData("save"), "" + HR.util.getWordpressBaseUrl() + "/editor/editor.php")) :(dialog = new HR.util.ShowLoginDialog({
