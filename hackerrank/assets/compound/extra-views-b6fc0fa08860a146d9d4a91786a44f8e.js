...
var that;
if (!(this.scores.count > 0 || this.rendering_score)) return that = this, this.rendering_score = !0, 
$.ajax({
...
var leadersDiv, level_to_title, that, tracks;
return tracks = [ {
slug:"algorithms",
...
} ], level_to_title = [ "O(1)", "O(logN)", "O(N)", "O(N<sup>2</sup>)", "O(2<sup>N</sup>)" ], 
$(this.el).html(HR.appController.template(this.template, this)({
level:this.level,
track:this.track,
type:this.type,
