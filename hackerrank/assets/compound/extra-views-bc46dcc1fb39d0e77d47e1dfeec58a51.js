...
return "<div class='leaderboard-overall-list-view'> <div class='row padding-small top bottom' style='height: 38px'> <div class='span1 text-center'> <p>" + leader.rank + "</p> </div> <div class='span5'> <p> <a class='backbone cursor leaderboard-hackername rg_" + leader.level + "' data-action='hacker-modal' rel='tooltip' data-value='" + leader.hacker + "' href='/" + leader.hacker + "' target='_blank'> <img class='avatar' width='30' height='30' src='" + leader.avatar + "'> " + leader.hacker + " </a> </p> </div> <div class='span2'> <p>" + leader.score.toFixed(2) + "</p> </div> </div> </div>";
