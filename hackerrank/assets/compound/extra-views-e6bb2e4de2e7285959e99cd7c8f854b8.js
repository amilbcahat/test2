...
}, LeaderboardMainView.prototype.initialize = function(options) {
...
return this.collection = HR.collection("track-leaderboard"), this.collection.setPage(1), 
this.collection.setLevel(this.level), this.collection.setTrack(this.track), this.collection.setType(this.type), 
this.collection.cached(), this.listenTo(this.collection, "reset", this.render), 
HR.router.navigate(this.collection.pageURL() + ("/" + this.collection.page), !1), 
this.render();
...
var leadersDiv, level_to_title, score, that, track, tracks, _i, _j, _len, _len1, _ref;
for (tracks = [ {
slug:"algorithms",
name:"Algorithms",
"short":"AL"
...
}), this.processBlank() ? this :(this.collection.sync_status && (leadersDiv = $(), 
that = this, _.each(this.collection.models, function(model) {
var _view;
return _view = new HR.OverallLeaderboardListView({
leader:model
