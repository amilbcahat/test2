...
})), question_stubs = $(), that = this, this.collection.sync_status && _.each(this.collection.models, function(model) {
var _view;
...
return event.preventDefault(), this.model.trigger("question:link:clicked", this.challenge, this.model);
}, QuestionStubView;
