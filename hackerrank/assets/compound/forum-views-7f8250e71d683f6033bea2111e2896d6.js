...
}, $codeeditor = this.$("#question-description").get(0), HR.appController.loadCodeMirrorMode("markdown", function(_this) {
return function() {
return $codeeditor && (_this.editor = CodeMirror.fromTextArea($codeeditor, editorOptions), 
_this.editor.setSize(650, 120), _this.question.get("description")) ? _this.editor.setValue(_this.question.get("description")) :void 0;
};
}(this)), this) :this;
...
return sanitized_text = html_sanitize(this.editor.getValue(), urlX, idX), html = this.converter.makeHtml(sanitized_text), 
"" === sanitized_text ? this.$(".preview-wrap").hide() :this.$(".preview-wrap").show(), 
