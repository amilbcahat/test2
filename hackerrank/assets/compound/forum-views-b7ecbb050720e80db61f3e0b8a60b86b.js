...
description:_.escape(this.editor.getValue()),
...
return HR.requires("html-sanitizer", function(_this) {
return function() {
var html, sanitized_text;
return sanitized_text = html_sanitize(_this.editor.getValue(), urlX, idX), html = _this.converter.makeHtml(sanitized_text), 
"" === sanitized_text ? _this.$(".preview-wrap").hide() :_this.$(".preview-wrap").show(), 
_this.$("#question-preview").html(html);
};
}(this));
}, urlX = function(url) {
return url;
...
indentUnit:4
}, $codeeditor = this.$("#question-description").get(0), $codeeditor && !this.editor ? HR.appController.loadCodeMirrorMode("markdown", function(_this) {
return function() {
return _this.editor = CodeMirror.fromTextArea($codeeditor, editorOptions), _this.editor.setSize(650, 120), 
_this.question.get("description") && _this.editor.setValue(_this.question.get("description")), 
...
return sanitized_text = html_sanitize(_this.editor.getValue(), urlX, idX), html = _this.converter.makeHtml(sanitized_text), 
"" === sanitized_text ? _this.$(".preview-wrap").hide() :_this.$(".preview-wrap").show(), 
_this.$("#answer-preview").html(html);
};
}(this));
}, urlX = function(url) {
return url;
