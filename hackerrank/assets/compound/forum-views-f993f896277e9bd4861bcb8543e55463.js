...
var html, text;
return text = _.escape(this.editor.getValue()), html = this.converter.makeHtml(text), 
"" === text ? this.$(".preview-wrap").hide() :this.$(".preview-wrap").show(), this.$("#answer-preview").html(html);
