...
return ArimaaView = function() {
function ArimaaView() {}
return ArimaaView.prototype.template = "games/arimaa", ArimaaView.prototype.className = "arimaa-view", 
ArimaaView.prototype.initialize = function(options) {
return this.parent = options.parent, this.current_move = 0, this;
}, ArimaaView.prototype.render = function() {
return $(this.el).html(HR.appController.template(this.template, this)({
model:this.model.toJSON()
})), this;
}, ArimaaView.prototype.playMove = function(i, moves_array) {
var board_x, board_y, current_move, current_move_lines, _i, _j;
for (current_move = moves_array[i], current_move_lines = current_move.split("\n"), 
board_x = _i = 0; 8 > _i; board_x = ++_i) for (board_y = _j = 0; 8 > _j; board_y = ++_j) $(this.el).find(".game-grid").find("td." + board_x + "-" + board_y).html(player_symbol[current_move_lines[board_x][board_y]]);
return this;
}, ArimaaView.prototype.stopGame = function() {
return this.current_move = 0, this;
}, ArimaaView;
}(), HR = null != (_ref = window.HR) ? _ref :{}, HR.ArimaaView = ArimaaView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
}(this))) :i - this.current_move === 1 ? (mine_img = "<img src='/assets/games/battleship-mine.png' class='battleship-mine'>", 
...
mine_img = "<img src='/assets/games/battleship-mine.png' class='battleship-mine'>", 
