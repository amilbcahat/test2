...
if (move_objects = moves_array[i].split(":"), num_moves = move_objects[2]) for (i = _i = 1; num_moves >= 1 ? num_moves >= _i :_i >= num_moves; i = num_moves >= 1 ? ++_i :--_i) moves = move_objects[2 + i].split(" "), 
