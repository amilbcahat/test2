...
this.attr = {}, this.attr.me = (10 * Math.random() + "").replace(/\D/g, ""), this.attr.click_event_ns = "click." + this.attr.me + " touchstart." + this.attr.me, 
options || (options = {}), options.trigger = "manual", this.init(type, element, options), 
this.$element.on("click", this.options.selector, $.proxy(this.clickery, this));
},
clickery:function(e) {
if (e && (e.preventDefault(), e.stopPropagation()), this.options.width && this.tip().width(this.options.width), 
...
that.tip().has(e.target).length || that.clickery();
}), this.options.esc_close && $(document).bind("keyup.clickery", function(e) {
27 == e.keyCode && that.clickery();
}), !this.options.allow_multiple && $("[data-clickover-open=1]").each(function() {
$(this).data("clickover") && $(this).data("clickover").clickery();
}), this.$element.attr("data-clickover-open", 1), this.tip().on("click", '[data-dismiss="clickover"]', $.proxy(this.clickery, this)), 
this.options.auto_close && this.options.auto_close > 0 && (this.attr.tid = setTimeout($.proxy(this.clickery, this), this.options.auto_close)), 
"function" == typeof this.options.onShown && this.options.onShown.call(this), this.$element.trigger("shown");
} else this.$element.removeAttr("data-clickover-open"), this.options.esc_close && $(document).unbind("keyup.clickery"), 
$("body").off(this.attr.click_event_ns), "number" == typeof this.attr.tid && (clearTimeout(this.attr.tid), 
delete this.attr.tid), "function" == typeof this.options.onHidden && this.options.onHidden.call(this), 
...
switch ($tip = this.tip(), placement = "function" == typeof this.options.placement ? this.options.placement.call(this, $tip[0], this.$element[0]) :this.options.placement, 
inside = /in/.test(placement), pos = this.getPosition(inside), actualWidth = $tip[0].offsetWidth, 
actualHeight = $tip[0].offsetHeight, inside ? placement.split(" ")[1] :placement) {
case "bottom":
tp = {
...
console.log(dt + ": clickover hide"), this.hide();
}
}), $.fn.clickover = function(option) {
return this.each(function() {
var $this = $(this), data = $this.data("clickover"), options = "object" == typeof option && option;
data || $this.data("clickover", data = new Clickover(this, options)), "string" == typeof option && data[option]();
});
}, $.fn.clickover.Constructor = Clickover, $.fn.clickover.defaults = $.extend({}, $.fn.popover.defaults, {
trigger:"manual",
auto_close:0,
global_close:1,
esc_close:1,
