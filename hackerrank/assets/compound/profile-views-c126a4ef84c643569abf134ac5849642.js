...
if ("tsize" === field) {
if (null === that.model.get(field) && "--" !== val) return changed = !0;
} else if ("local_language" === field) {
if (null === that.model.get(field) && "English" !== val) return changed = !0;
} else if (null === that.model.get(field) && "" !== val) return changed = !0;
}), changed;
