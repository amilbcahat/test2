...
error ? this.$(".alert.error").html(error).parent().fadeIn() :(this.parent.showSavingMsg(), 
$.ajax({
...
var that;
return that = this, this.$("#profileTabs").length > 0 ? (this.$(".hr_settingsToggle").removeClass("current"), 
this.$("#" + this.tab + ".hr_settingsToggle").addClass("current")) :void 0;
