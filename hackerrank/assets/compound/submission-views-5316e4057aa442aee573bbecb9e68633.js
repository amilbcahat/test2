...
return this.rendered && this.previous_model_id === this.model.id || this._template && this.model && ($(this.el).html(HR.appController.template(this._template, this)({
model:this.model.toJSON(),
_model:this.model,
...
}(this))), this.rendered = !0, this.renderSubViews(), this._ThrobberTimer && window.clearTimeout(this._ThrobberTimer), 
