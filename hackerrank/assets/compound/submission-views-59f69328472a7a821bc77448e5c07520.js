...
var $code_area, bread_crumbs_view, editorOptions, showBusyThrobber, that;
return this.rendered && this.previous_model_id === this.model.get("id") || this._template && this.model && ($(this.el).html(this._template({
model:this.model.toJSON(),
challengePageURL:HR.appController.get_challenge_pageURL(this.model.get("contest_slug"), this.model.get("slug")),
_model:this.model,
...
}, this.editor = CodeMirror($code_area, editorOptions)), this.rendered = !0, this.renderSubViews(), 
this.previous_model_id = this.model.get("id"), this._ThrobberTimer && window.clearTimeout(this._ThrobberTimer), 
this.model.get("slug") || (that = this, showBusyThrobber = function(index) {
var messages;
...
var paste_code, that;
return e.preventDefault(), HR.router.navigate("" + HR.appController.get_current_contest_namespace() + "/challenges/" + this.model.get("slug"), !0), 
that = this, (paste_code = function() {
var error, scroll_to_editor;
try {
return HR.appView.getSubViews().content.body.request_view.codeeditor.header.parent.body.editor ? (HR.appView.getSubViews().content.body.request_view.codeeditor.header.setLangFromSubmission(that.model.get("language"), that.model.get("code")), 
(scroll_to_editor = function() {
var offset, top;
return offset = HR.appView.getSubViews().content.body.request_view.codeeditor.header.$el.offset(), 
offset && offset.top ? (top = offset.top, $("body,html").animate({
scrollTop:top - 10
}, 200)) :setTimeout(scroll_to_editor, 100);
})()) :setTimeout(paste_code, 100);
} catch (_error) {
return error = _error, setTimeout(paste_code, 100);
}
})();
}, SubmissionView;
...
return function(e) {
return e.preventDefault(), that = _this, $.ajax({
...
error:function() {
return $(".alert.error").show().html("Insufficient Hackos");
}
});
};
}(this),
...
return HR.appController.get_current_contest_slug();
}, SubmissionStatsView;
...
return score = Math.floor(100 * this.model.score) / 100 || 0, score > 0 ? (1 === this.hacker.get("facebook_allow_opengraph") && this.fbGraphChallengeCompleted(), 
...
window.touring && setTimeout(function() {
...
prefix + suffix;
}, SubmissionSuccessView.prototype.fbGraphChallengeCompleted = function() {
return window.HR.appController.facebook_graph_activity("solve", "challenge", this.getURL());
...
jQuery(function() {
var GroupedHackerVsHackerView, HR, _ref;
return GroupedHackerVsHackerView = function(_super) {
function GroupedHackerVsHackerView() {
return GroupedHackerVsHackerView.__super__.constructor.apply(this, arguments);
}
return __extends(GroupedHackerVsHackerView, _super), GroupedHackerVsHackerView.prototype.template = "grouped-hackervshacker", 
GroupedHackerVsHackerView.prototype.className = "grouped-hackervshacker-view", GroupedHackerVsHackerView.prototype.initialize = function() {
return this.collection.fetch(), this.listenTo(this.collection, "reset", this.render), 
_.isObject(this.collection.challenge) ? this.collection.challenge.bind("reset", this.render, this) :void 0;
}, GroupedHackerVsHackerView.prototype.events = {
"click .expand":"expandChallenge"
}, GroupedHackerVsHackerView.prototype.expandChallenge = function(e) {
var subDiv;
return e.preventDefault(), subDiv = $(e.currentTarget).parents(".table-primary").find(".table-sub"), 
subDiv.hasClass("block") ? subDiv.slideUp(200).removeClass("block").css("height: auto") :subDiv.slideDown(200).addClass("block").css("height: auto");
}, GroupedHackerVsHackerView.prototype.render = function() {
var that;
return this.collection.hacker1 && ($(this.el).html(HR.appController.template(this.template, this)({
collection:this.collection
})), HR.util.pagination(this.$(".pagination-wrapper"), this.collection.getTotal(), this.collection.pageURL(), this.collection.getCurrentPage(), null, this.collection.getLimit()), 
this.$(".hackervshacker-list-wrapper").length > 0 && (this.$(".hackervshacker-list-wrapper").html(""), 
that = this, _.each(this.collection.models, function(model) {
return HR.requires("compound/submission-views", "moment", function() {
var _view;
return _view = new HR.GroupedHackerVsHackerListView({
model:model,
hacker1:that.collection.hacker1,
hacker2:that.collection.hacker2
}), that.$(".hackervshacker-list-wrapper").append(_view.render().el), that.add_subview(_view);
});
}))), this;
}, GroupedHackerVsHackerView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.GroupedHackerVsHackerView = GroupedHackerVsHackerView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var GroupedHackerVsHackerListView, HR, _ref;
return GroupedHackerVsHackerListView = function(_super) {
function GroupedHackerVsHackerListView() {
return GroupedHackerVsHackerListView.__super__.constructor.apply(this, arguments);
}
return __extends(GroupedHackerVsHackerListView, _super), GroupedHackerVsHackerListView.prototype.template = "grouped-hackervshacker-list", 
GroupedHackerVsHackerListView.prototype.className = "grouped-hackervshacker-list-view", 
GroupedHackerVsHackerListView.prototype.initialize = function(options) {
return this.hacker1 = options.hacker1, this.hacker2 = options.hacker2, this.listenTo(this.model, "change", this.render), 
this.listenTo(this.model, "reset", this.render);
}, GroupedHackerVsHackerListView.prototype.events = {
"click .playgame":"showGameContainer"
}, GroupedHackerVsHackerListView.prototype.showGameContainer = function(e) {
return e.preventDefault(), this.game_container && (this.game_container.remove(), 
this.$("div.row.container").html('<div class="submission-game-container-wrapper" style="margin-left: 18px;"></div>')), 
this.game_id = $(e.target).attr("data-id"), this.gamemodel = HR.appController.getModel("gameset", "game_id-" + this.game_id, null, !1, !1), 
this.gamemodel.set("game_id", this.game_id), this.listenTo(this.gamemodel, "reset", this.renderGameContainer), 
this.listenTo(this.gamemodel, "change", this.renderGameContainer), this.gamemodel.fetch();
}, GroupedHackerVsHackerListView.prototype.renderGameContainer = function() {
var that;
return that = this, HR.requires("compound/game-views", function() {
return that.game_container = new HR.GameContainerView({
gameset:that.gamemodel,
collection:that.gamemodel.getGameCollection()
}), that.game_container.setElement($(".row.container.game-" + this.game_id + " .submission-game-container-wrapper")).render(), 
that.add_subview(that.game_container);
});
}, GroupedHackerVsHackerListView.prototype.render = function() {
var games;
return this.model.get("challenge") && (games = this.model.get("games"), $(this.el).html(HR.appController.template(this.template, this)({
model:this.model.toJSON(),
games:games,
hacker1:this.hacker1,
hacker2:this.hacker2
}))), this.delegateEvents(), this;
}, GroupedHackerVsHackerListView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.GroupedHackerVsHackerListView = GroupedHackerVsHackerListView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
