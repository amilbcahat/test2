...
this.$(".zero-content").hide(), 0 === this.collection.length && (this.model.get("filter") ? this.$(".zero-content-" + this.model.get("filter")).show() :this.$(".zero-content-all").show())) :(this.$(".throbber-row").hide(), 
this.$(".game-view-rows").show()), this.setPagination(), this;
...
that.refreshGameSet(gameset_collection);
}), this;
}, SubmissionGameCollectionView.prototype.refreshGameSet = function(new_collection) {
var that;
return this.collection = new_collection, that = this, this.collection.fetch({
success:function() {
return that.render();
}
});
