...
var personalize, score, that;
return score = Math.floor(100 * this.model.score) / 100 || 0, score > 0 ? (that = this, 
$.ajax({
url:"rest/hackers/" + this.hacker.get("username") + "/opengraph_preferences",
type:"GET",
dataType:"json",
success:function(resp) {
return 2 === resp.model.solved_challenge ? that.askPermission(resp) :void 0;
}
...
prefix + suffix;
}, SubmissionSuccessView.prototype.askPermission = function(data) {
var body, buttons, dialog, options, that;
return that = this, options = {
title:"Opengraph Permissions"
}, body = "<p class = 'text-center mlT mlB'> Do you want to post your Submission actions on facebook? </p>", 
buttons = [ {
name:"Yes",
...
} ], options.bottons = buttons, options.body = body, options.width = 640, dialog = HR.util.ShowDialog(options), 
dialog.render();
}, SubmissionSuccessView.prototype.updatePermission = function(data, value) {
var modified_data;
return modified_data = {
asked_question:data.model.asked_question,
answerd_question:data.model.answerd_question,
solved_challenge:value
}, $.ajax({
url:"rest/hackers/me/opengraph_preferences",
type:"PUT",
data:modified_data
});
}, SubmissionSuccessView.prototype.checkfbPermission = function() {
return 0 === this.hacker.get("facebook_allow_opengraph") ? window.HR.appController.facebook_permission() :void 0;
