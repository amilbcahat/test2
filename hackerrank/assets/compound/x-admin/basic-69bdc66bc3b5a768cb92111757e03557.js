...
AdminAttemptReportsView.prototype.companyDataAction = "attempt_reports", AdminAttemptReportsView.prototype.reportGenerationUrl = "/xrest/admin/reports/generate_attempt_report", 
...
AdminInviteReportsView.prototype.companyDataAction = "invite_reports", AdminInviteReportsView.prototype.reportGenerationUrl = "/xrest/admin/reports/generate_invite_report", 
...
sAjaxSource:"/xrest/admin/attempts?" + this.filterString(),
...
this.filters.company_id && filters.push("company_id=" + this.filters.company_id), 
this.filters.user_id && filters.push("user_id=" + this.filters.user_id), this.filters.date_range && filters.push("date_range=" + this.filters.date_range), 
filters.join("&");
...
var ret;
return ret = [], ret.push(row.id), ret.push(row.company_id), ret.push(row.company_name), 
ret.push(row.full_name), ret.push(row.email), ret.push(row.test_id), ret.push(row.test_name), 
ret.push(row.invited_by), ret;
...
AttemptsDashboardView.prototype.companySearchBySelected = !1, AttemptsDashboardView.prototype.userSearchBy = "id", 
AttemptsDashboardView.prototype.companySearchBy = "id", AttemptsDashboardView.prototype.userFields = {
id:"id",
...
return that.initUserSelect2(), that.initCompanySelect2(), that.initDatePicker(), 
that.filterAttempts();
}), this;
...
}, options = _.extend(defaultOptions, options), this.userSelectBox = $("#invited-by-attempts-filter"), 
this.userSelectBox.select2(options), this.userSelectBox.on("change", function() {
...
}, options = _.extend(defaultOptions, options), this.companySelectBox = $("#company-attempts-filter"), 
this.companySelectBox.select2(options), this.companySelectBox.on("change", function() {
return that.filterAttempts();
});
...
return e && e.preventDefault(), this.filters.time_type = this.attemptedAtType, this.filters.company_id = this.companySelectBox.select2("val"), 
this.filters.user_id = this.userSelectBox.select2("val"), this.initTableView();
...
jQuery(function() {
var AttemptModel, HR, _ref;
return AttemptModel = function(_super) {
function AttemptModel() {
return AttemptModel.__super__.constructor.apply(this, arguments);
}
return __extends(AttemptModel, _super), AttemptModel.prototype.url = function() {
return this.get("id") ? "/xrest/admin/attempts/" + this.get("id") :"/xrest/admin/attempts";
}, AttemptModel;
}(window.HR.GenericModel), HR = null != (_ref = window.HR) ? _ref :{}, HR.AttemptModel = AttemptModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return this.get("id") ? "/xrest/admin/periodic_reports/" + this.get("id") :"/xrest/admin/periodic_reports";
}, PeriodicReportModel;
...
jQuery(function() {
var AttemptsCollection, HR, _ref;
return AttemptsCollection = function(_super) {
function AttemptsCollection() {
return AttemptsCollection.__super__.constructor.apply(this, arguments);
}
return __extends(AttemptsCollection, _super), AttemptsCollection.prototype.url = function() {
return "/xrest/admin/attempts";
}, AttemptsCollection.prototype.model = window.HR.AttemptModel, AttemptsCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.AttemptsCollection = AttemptsCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return "/xrest/admin/periodic_reports?page=" + this.page;
