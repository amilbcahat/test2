...
placeholder:"Select a Company",
ajax:{
url:"/x/admin/v1/search/companies",
type:"GET",
quietMillis:800,
dataType:"json",
data:function(term) {
...
var that;
return e.preventDefault(), that = this, this.$(".message-box").empty(), 0 === $(":file")[0].files.length ? (this.$(".message-box.error").append("You need to upload a valid csv file"), 
!1) :$.ajax({
url:"/x/api/v1/admin/tests/invite_candidates",
data:{
force_invite:$("input[name=force-invite]").get(0).checked,
...
files:$(":file"),
success:function(response) {
return that.$(".message-box").empty(), that.$(".message-box.success").append(response.message);
},
error:function(response) {
return that.$(".message-box").empty(), that.$(".message-box.error").append(response.message);
}
});
