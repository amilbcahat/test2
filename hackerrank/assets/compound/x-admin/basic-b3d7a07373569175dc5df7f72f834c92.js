...
return __extends(AdminInviteReportsActionsView, _super), AdminInviteReportsActionsView.prototype.template = "x-admin/admin-invite-reports-actions", 
AdminInviteReportsActionsView.prototype.startDate = moment().subtract("month", 1), 
AdminInviteReportsActionsView.prototype.endDate = moment(), AdminInviteReportsActionsView.prototype.tableOpened = {
"user-custom-container":!1,
"tests-custom-container":!1,
"fields-custom-container":!1
}, AdminInviteReportsActionsView.prototype.events = {
...
}, AdminInviteReportsActionsView.prototype.initialize = function(options) {
...
_.each(defaultFieldsHash, function(field) {
...
}, AdminInviteReportsActionsView.prototype._render = function() {
var content, that;
...
return that.initDateRangeSelect(), that.initUsersDataTable();
}), this;
}, AdminInviteReportsActionsView.prototype.initDateRangeSelect = function() {
...
last_week_end = moment().subtract("week", 1).endOf("week"), $("input#invite-report-date-range").daterangepicker({
format:"YYYY/MM/DD",
ranges:{
...
minDate:moment(that.model.get("created_at")).subtract("day", 1),
maxDate:moment().add("day", 1)
}, function(start, end) {
return that.startDate = start.format("YYYY/MM/DD"), that.endDate = end.format("YYYY/MM/DD"), 
$("input#invite-report-date-range").val(that.startDate + " - " + that.endDate);
});
}, AdminInviteReportsActionsView.prototype.initUsersDataTable = function() {
...
}, AdminInviteReportsActionsView.prototype.selectAll = function(e) {
...
}, AdminInviteReportsActionsView.prototype.selectAllFields = function(e) {
...
}, AdminInviteReportsActionsView.prototype.selectDefaultFields = function(e) {
...
}, AdminInviteReportsActionsView.prototype.selectDefaultInputs = function(e) {
...
}, AdminInviteReportsActionsView.prototype.deselectAllAndDefault = function(e) {
var currentTarget;
return currentTarget = $(e.currentTarget), currentTarget.closest(".custom-container").parent().find(".select-all").prop("checked", !1);
}, AdminInviteReportsActionsView.prototype.showCustomContainer = function(e) {
var currentTarget;
...
}, AdminInviteReportsActionsView.prototype.openContainer = function(className) {
var container;
...
}, AdminInviteReportsActionsView.prototype.hideCustomContainer = function(e) {
var currentTarget;
return e.preventDefault(), currentTarget = $(e.currentTarget), currentTarget.addClass("hidden"), 
...
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.AdminInviteReportsActionsView = AdminInviteReportsActionsView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return __extends(AdminInviteReportsView, _super), AdminInviteReportsView.prototype.searchBy = "id", 
AdminInviteReportsView.prototype.companyFields = {
id:"id",
name:"name",
email:"email"
}, AdminInviteReportsView.prototype.template = "x-admin/admin-invite-reports", AdminInviteReportsView.prototype.events = {
"submit form#invites-report-form":"generateReport"
}, AdminInviteReportsView.prototype._render = function() {
var content, that;
return that = this, content = HR.appController.template(this.template, this)({
...
}, AdminInviteReportsView.prototype.initCompanySelect2 = function() {
...
}, AdminInviteReportsView.prototype.fetchCompany = function(id, view) {
var model;
return model = new HR.CompanyModel(), model.set("id", id), view.model = model, model.fetch({
data:{
company_data_action:"invite_reports"
},
success:function(model) {
var actionsView;
return actionsView = new HR.AdminInviteReportsActionsView({
model:model
}), view.actionsView = actionsView, $(".company-action-section").html(actionsView.render().el);
}
});
}, AdminInviteReportsView.prototype.generateReport = function(e) {
var button, currentTarget, fieldInputs, params, testInputs, userInputs;
return e.preventDefault(), $("a#link-box").addClass("hidden"), currentTarget = $(e.currentTarget), 
...
$.ajax({
url:"/xrest/admin/reports/generate_invite_report",
type:"GET",
data:params,
...
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.AdminInviteReportsView = AdminInviteReportsView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
