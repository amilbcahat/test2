...
AdminCommonPeriodicFormView.prototype.searchBy = "id", AdminCommonPeriodicFormView.prototype.companyFields = {
id:"id",
name:"name",
email:"email"
...
AdminCommonReportsView.prototype.companyFields = {
id:"id",
name:"name",
email:"email"
...
fields = this.fetchFields(), user_ids = this.fetchUserIds(), test_ids = this.fetchTestIds(), 
model = new HR.PeriodicReportModel(), model.set("entity_id", this.companySelectBox.select2("val")), 
