...
this.filters.company_ids && filters.push("company_ids=" + this.filters.company_ids.join(",")), 
this.filters.user_ids && filters.push("user_ids=" + this.filters.user_ids.join(",")), 
this.filters.test_ids && filters.push("test_ids=" + this.filters.test_ids.join(",")), 
...
AttemptsDashboardView.prototype.filters = {
...
this.userSelectBox.on("change", function(e) {
return that.filters.user_ids = e.val, that.filterAttempts();
});
...
this.companySelectBox.on("change", function(e) {
return that.filters.company_ids = e.val, that.filterAttempts();
});
...
return that.filters.test_ids = e.val, that.filterAttempts();
});
...
return e && e.preventDefault(), this.filters.time_type = this.attemptedAtType, this.initTableView();
