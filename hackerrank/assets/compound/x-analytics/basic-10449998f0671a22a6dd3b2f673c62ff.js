...
CompanyAttemptsTimeGraphView.prototype.plotclick = function() {}, CompanyAttemptsTimeGraphView.prototype.initGraph = function() {
var categories, data, params, results, tickInterval;
return data = this.company.get("data_usage").attempts_time, categories = _.map(data, function(elem) {
return elem.date;
...
return e.preventDefault(), currentTarget = $(e.currentTarget), type = currentTarget.data("view-type"), 
type !== this.subViewType ? (this.subViewType = type, this.render(), this.renderSubView()) :void 0;
...
CompanyInterviewsTimeGraphView.prototype.plotclick = function() {}, CompanyInterviewsTimeGraphView.prototype.initGraph = function() {
var categories, data, params, results, tickInterval;
return data = this.company.get("data_usage").interviews_time, categories = _.map(data, function(elem) {
return elem.date;
}), results = _.map(data, function(elem) {
return elem.count;
}), tickInterval = Math.ceil(categories.length / 9), params = {
...
CompanyInvitesTimeGraphView.prototype.plotclick = function() {}, CompanyInvitesTimeGraphView.prototype.initGraph = function() {
var categories, data, params, results, tickInterval;
return data = this.company.get("data_usage").invites_time, categories = _.map(data, function(elem) {
return elem.date;
}), results = _.map(data, function(elem) {
return elem.count;
}), tickInterval = Math.ceil(categories.length / 9), params = {
...
var that;
return that = this, this.dataTable.fnClearTable(), this.companies.setDateRange(this.startDate + "-" + this.endDate), 
...
var button;
return e.preventDefault(), button = $(e.currentTarget), this.viewType !== button.data("view-type") ? (this.viewType = button.data("view-type"), 
this.render()) :void 0;
}, CompaniesListView;
...
var categories, data, params, results, tickInterval;
return data = this.company.get("license_usage").teams_time, categories = _.map(data, function(elem) {
return elem.date;
}), results = _.map(data, function(elem) {
return elem.count;
}), tickInterval = Math.ceil(categories.length / 9), params = {
...
var categories, data, params, results, tickInterval;
return data = this.company.get("data_usage").tests_time, categories = _.map(data, function(elem) {
return elem.date;
}), results = _.map(data, function(elem) {
return elem.count;
}), tickInterval = Math.ceil(categories.length / 9), params = {
...
var admin_data, admin_results, categories, data, defaultOptions, developer_data, developer_results, options, params, recruiter_data, recruiter_results, tickInterval, user_data, user_results;
return data = this.company.get("license_usage").users_time, user_data = data.user_data, 
