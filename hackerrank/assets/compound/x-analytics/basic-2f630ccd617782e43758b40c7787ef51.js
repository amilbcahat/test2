...
CompaniesListView.prototype.localStorageKey = "companies_table_type", CompaniesListView.prototype.viewType = "dataUsage", 
CompaniesListView.prototype.startDate = moment().subtract("month", 1).format("YYYY/MM/DD"), 
...
return that.initDataTable(), that.initDateRangeSelect(), "compact" === that.tableType ? HR.appView.closeSidebar() :void 0;
}), this;
...
aoColumnDefs:[ {
sType:"x-percent",
aTargets:that.xPercentTargets[that.viewType][that.tableType]
} ]
...
}, CompaniesListView.prototype.setTableTypeFromLocal = function() {
var tableType;
return tableType = HR.AnalyticsLocalStorage.get(this.localStorageKey), this.tableType = tableType ? tableType :"full";
}, CompaniesListView.prototype.toggleTableType = function(e) {
...
return that = this, button = $(e.currentTarget), type = this.companies.getType(), 
type !== button.val() ? (this.companies.setType(button.val()), this.searchText = $(".dataTables_filter input").val(), 
...
return that = this, button = $(e.currentTarget), duration = this.companies.getDuration(), 
duration !== button.val() ? "custom" === button.val() ? this.customDuration() :(this.companies.setDuration(button.val()), 
...
}, CompaniesListView.prototype.customDuration = function() {
return this.companies.setDuration("custom"), this.fetchCustomData();
...
var currentTarget, that;
return that = this, e.preventDefault(), currentTarget = $(e.currentTarget), this.month = currentTarget.data("month"), 
this.model.fetch({
data:{
month:that.month
}
...
url:"/xrest/analytics/revenue/update_goal",
...
jQuery(function() {
var HR, WatchlistView, _ref;
return WatchlistView = function(_super) {
function WatchlistView() {
return WatchlistView.__super__.constructor.apply(this, arguments);
}
return __extends(WatchlistView, _super), WatchlistView.prototype.template = "x-analytics/watchlist", 
WatchlistView.prototype.searchBy = "id", WatchlistView.prototype.userFields = {
id:"id",
name:"firstname,email"
}, WatchlistView.prototype.events = {
"click a.delete-item":"removeFromWatchList"
}, WatchlistView.prototype.initialize = function(options) {
return null == options && (options = {}), this.list = options.collection, this.listenTo(this.list, "add", this.render);
}, WatchlistView.prototype._render = function() {
var content, that;
return that = this, content = HR.appController.template(this.template, this)({
...
}, WatchlistView.prototype.initUserSelect2 = function() {
var defaultOptions, options, that;
return that = this, defaultOptions = HR.util.admin.defaultSelect2Options(), options = {
...
}, WatchlistView.prototype.initWatchlistDataTable = function() {
var that;
return that = this, HR.util.admin.initDataTablePercentSort(), this.dataTable = $(".watchlist-table").dataTable({
sDom:"<'row-fluid'<'span6'T><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>",
bPaginate:!0,
sPaginationType:"bootstrap",
iDisplayLength:50,
bDestroy:!0,
aaSorting:[ [ 0, "asc" ] ]
}), this.searchText ? this.dataTable.fnFilter(this.searchText) :void 0;
}, WatchlistView.prototype.addToWatchList = function(userId, collection) {
var model;
return model = new HR.WatchlistUserModel(), model.set("user_id", userId), model.save(null, {
success:function(model) {
return HR.util.ajaxmsg("User has been added to your watchlist", !1, !0, 2), collection.add(model);
},
error:function(resp) {
return resp = JSON.parse(resp), HR.util.ajaxmsg(resp.message, !1, !0, 2);
}
});
}, WatchlistView.prototype.removeFromWatchList = function(e) {
...
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.WatchlistView = WatchlistView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return this.dataAction ? "/xrest/analytics/revenue/opportunities_data" :"/xrest/analytics/revenue";
...
jQuery(function() {
var HR, WatchlistUserModel, _ref;
return WatchlistUserModel = function(_super) {
function WatchlistUserModel() {
return WatchlistUserModel.__super__.constructor.apply(this, arguments);
}
return __extends(WatchlistUserModel, _super), WatchlistUserModel.prototype.url = function() {
return this.id ? "/xrest/analytics/watchlist/" + this.id :"/xrest/analytics/watchlist";
}, WatchlistUserModel;
}(window.HR.GenericModel), HR = null != (_ref = window.HR) ? _ref :{}, HR.WatchlistUserModel = WatchlistUserModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var HR, WatchlistCollection, _ref;
return WatchlistCollection = function(_super) {
function WatchlistCollection() {
return WatchlistCollection.__super__.constructor.apply(this, arguments);
}
return __extends(WatchlistCollection, _super), WatchlistCollection.prototype.url = function() {
return "/xrest/analytics/watchlist";
}, WatchlistCollection.prototype.model = window.HR.WatchlistUserModel, WatchlistCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.WatchlistCollection = WatchlistCollection;
});
