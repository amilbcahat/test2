...
url:"/xrest/analytics/users/signups",
type:"GET",
data:params,
success:function(response) {
...
return __extends(CommonWatchlistView, _super), CommonWatchlistView.prototype.events = {
...
CompanySignupsDataView.prototype.dataUrl = "/xrest/analytics/companies/trial_signups_data", 
...
CompanyWatchlistView.prototype.searchBy = "id", CompanyWatchlistView.prototype.companyFields = {
id:"id",
name:"name",
email:"email"
...
UserSignupsDataView.prototype.dataUrl = "/xrest/analytics/users/signups_data", UserSignupsDataView;
}(window.HR.CommonSignupsDataView), HR = null != (_ref = window.HR) ? _ref :{}, 
...
UserWatchlistView.prototype.searchBy = "id", UserWatchlistView.prototype.userFields = {
id:"id",
...
return this.id ? "/xrest/analytics/companies/watchlist/" + this.id :"/xrest/analytics/companies/watchlist";
...
return this.id ? "/xrest/analytics/users/watchlist/" + this.id :"/xrest/analytics/users/watchlist";
...
return "/xrest/analytics/companies/watchlist";
...
return "/xrest/analytics/users/watchlist";
