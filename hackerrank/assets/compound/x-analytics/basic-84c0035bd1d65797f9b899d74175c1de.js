...
sAjaxSource:"/x/api/v1/analytics/companies?type=" + that.companyType + "&duration=" + that.duration + "&date_range=" + that.dateRange + "&table_type=" + that.tableType + "&view_type=" + that.viewType,
...
}).fnSetFilteringDelay(800), this.searchText && this.dataTable.fnFilter(this.searchText), 
