...
var tableType;
return tableType = HR.AnalyticsLocalStorage.get(this.localStorageKey), tableType ? (this.tableType = tableType, 
"compact" === tableType ? setTimeout(function() {
return function() {
return HR.appView.closeSidebar();
};
}(this), 500) :void 0) :this.tableType = "full";
