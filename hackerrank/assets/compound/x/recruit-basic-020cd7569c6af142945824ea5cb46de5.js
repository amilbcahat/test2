...
deselectLanguages ? unsupportedLanguages.forEach(function(lang) {
return $(lang).addClass("active"), that.$("input[name=allowedLanguages][value=" + lang + "]").removeAttr("checked").closest(".hr-checkbox").removeClass("active");
}) :void 0;
