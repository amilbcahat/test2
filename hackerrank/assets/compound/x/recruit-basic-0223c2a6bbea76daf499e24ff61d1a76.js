...
return this._subviews = [], this.testmodel = options.testmodel, window.CIPHER = this.model;
}, QuestionCodeEditStep2View.prototype.events = function() {
return {
"submit form[name=coding-question-step2-form]":"saveQuestion",
"click label.hr-checkbox":"toggleCheckbox",
...
}, QuestionCodeEditStep2View.prototype.changeTemplateType = function(temp_type) {
switch (temp_type) {
case 0:
return this.model.set("template_type", "" + temp_type, {
silent:!0
}), this.model.set("codestub_info", "", {
silent:!0
}), this.$(".js-codestub-info").addClass("hidden");

case 1:
return this.model.set({
template_type:"" + temp_type,
codestub_info:"You are using HackerRank generated code template"
}, {
silent:!0
}), this.$(".js-codestub-info").text("You are using HackerRank generated code template").removeClass("hidden");

case 2:
return "1" === this.model.get("template_type") ? (this.model.set("codestub_info", "You have modified HackerRank generated code templates", {
silent:!0
}), this.$(".js-codestub-info").text("You have modified HackerRank generated code templates").removeClass("hidden")) :(this.$(".js-codestub-info").addClass("hidden"), 
this.model.set("codestub_info", "", {
silent:!0
})), this.model.set("template_type", "" + temp_type, {
silent:!0
});
}
}, QuestionCodeEditStep2View.prototype.changeLanguage = function(e) {
var id, lang;
return e.preventDefault(), id = this.$(".js-code-section-tabs-list li.active").find(".js-code-section-tab").data("id"), 
this.model.get("" + this.language + "_" + id) !== this.tbody_editor.getValue() && (this.changeTemplateType(2), 
this.model.set("" + this.language + "_" + id, this.tbody_editor.getValue(), {
silent:!0
})), this.$(".js-code-section-tabs-list li").removeClass("active"), this.$(".js-code-section-tab[data-id=template]").parent().addClass("active"), 
lang = this.$(e.currentTarget).val(), HR.appController.loadCodeMirrorMode(lang, function(_this) {
...
silent:!0
}), this.changeTemplateType(1), this.model.set("allowedLanguages", this.$("input[name=allowedLanguages]:checked").map(function(i, lang) {
return lang.value;
}).toArray().join(",")), this.model.save(null, {
silent:!0,
success:function(_this) {
...
"0" === this.$("input[name=template_type]:checked").val() ? this.changeTemplateType(0) :this.model.get("" + this.language + "_" + id) !== this.tbody_editor.getValue() && (this.changeTemplateType(2), 
this.model.set("" + this.language + "_" + id, this.tbody_editor.getValue(), {
silent:!0
})), newLanguages = _.difference(allowedLanguages, this.model.get("languages")).map(function(_this) {
return function(lang) {
...
var a, qtype;
return qtype = this.model.get("type"), _.contains([ "code", "approx", "textAns" ], qtype) ? this.view ? (a = {
type:qtype,
