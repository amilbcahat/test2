...
candidate:"" + HR.INTERVIEWS_DOMAIN + "/api/attempts?auth_v2=" + HR.currentUser.get("auth_v2") + "&api_key=" + HR.currentUser.get("apiKey"),
...
type:"GET",
url:"/xrest/taskattempts/" + this.question.authkey,
success:function(_this) {
...
url:"/x/api/v1/tests/" + that.model.get("id") + "/attempts/invite",
data:attrs,
type:"POST",
success:function(_this) {
return function(data) {
...
new_url = "/x/tests/" + this.tid + "/attempts/" + this.aid + "/report/" + tab, qid && (new_url += "/" + qid), 
window.history && history.pushState && window.history.pushState(null, null, new_url), 
...
var client, that, url;
return that = this, url = "" + document.location.host + "/x/tests/" + this.testmodel.get("id") + "/attempts/" + this.model.get("id") + "/report?authkey=" + this.testmodel.get("authkey"), 
...
this.currentAnswer = {}, that = this, this.mime_lang_mapping = {}, "true" === this.question.multiple_files ? _.each(lang_mime_mapping, function(i, v) {
...
this.datatable_view.ats = this.subtype, window.history && history.pushState && window.history.pushState(null, null, "/x/tests/" + this.testmodel.get("id") + "/attempts/completed/" + this.subtype), 
...
HR.router.navigate("/tests/" + this.testmodel.id + "/attempts/invite", !0));
...
var url;
return url = "/x/api/v1/attempts/search";
