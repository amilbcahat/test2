...
this.callback = options.callback, this.team_id = options.team_id;
...
return old_view.remove(), this.addTeam(this.addUserCallback);
}, SettingsTeamView.prototype.addTeam = function(callback) {
var new_team_modal;
return new_team_modal = new HR.NewTeamView({
parent:this,
collection:this.collection,
