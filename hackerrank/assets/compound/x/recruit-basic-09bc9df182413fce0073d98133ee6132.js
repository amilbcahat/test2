...
var filter_url;
return filter_url = this.filterString(), "/tests/search/" + filter_url;
}, TestAdvancedSearchView.prototype.filterString = function() {
return _.map(this.filters, function() {
...
return Backbone.history.navigate(this.searchPath()), this.parent.collection.setFilterString(this.filterString()), 
...
this.$("#search-loading").hide(), this.advanced_search_open ? this.showAdvanceSearch() :this.hideAdvanceSearch();
