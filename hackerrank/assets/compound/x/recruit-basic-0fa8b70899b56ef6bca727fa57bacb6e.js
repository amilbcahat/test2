...
return null == error && (error = "Unable to save your answer. Please retry after sometime."), 
...
var editor, i;
if (e && change && "True" === HR.candidate.candidateAttemptModel.get("secure") && this.checkCopyPaste(change), 
