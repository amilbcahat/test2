...
return console.log("Render inside RecruitCandidateLoginView"), console.log(this, this.model), 
console.log(this.cid, this.model.cid), console.log(this.el), $(this.el).html(HR.appController.template(this.template, this)({
test:this.model.attributes
})), window.test = this, this.model.get("facebook_login") && !window.fbAdded && (window.fbAdded = !0, 
