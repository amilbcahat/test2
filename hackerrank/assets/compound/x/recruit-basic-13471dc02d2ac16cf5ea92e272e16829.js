...
this.anonymize = !1, ZeroClipboard.config({
debug:!1
...
this.checkAnonymize(), content = HR.appController.template(this.template, this)({
...
}, TestReportView.prototype.checkAnonymize = function() {
return this.testmodel.get("authkey_used") ? this.anonymize = this.testmodel.get("anonymize") ? !0 :this.model.get("anonymize") ? "developer" === HR.currentUser.get("role") ? !0 :HR.currentUser.get("role") ? HR.currentUser.get("company_id") !== this.testmodel.get("company_id") ? !0 :!1 :!0 :!1 :HR.currentUser && HR.currentUser.get("email") ? this.anonymize = this.model.get("anonymize") && "developer" === HR.currentUser.get("role") ? !0 :!HR.currentUser.canViewCandidateDetails() :void 0;
...
return more_details = [], this.model.get("test") && (this.parent.anonymize === !1 && _.each(this.model.get("candidate_details"), function(detail) {
...
tq_split:this.tq_split,
anonymize:this.parent.anonymize,
...
this.$(".js-rendered-data").ready(this.hideLoading), init_url = HR.development ? "" + window.location.protocol + "//design." + window.location.host :"" + window.location.protocol + "//design.hackerrank.com", 
this.$(".js-rendered-data").attr("src", "" + init_url + this.suburl + "/?showAlert=" + this.showAlert);
...
HR.currentUser.canViewCandidateDetails() === !1 && (row.email = "candidate - " + row.id, 
row.full_name && (row.full_name = "Candidate - " + row.id)), _this.mapColumns(row, ix);
};
}(this))), result;
...
var track_data;
return e.preventDefault(), track_data = {}, "wizard-modal-link" === e.target.id ? HR.util.track("Launched Test Wizard - New", track_data) :HR.util.track("Launched Test Wizard - Welcome", track_data), 
this.$(".welcome-modal").addClass("hidden"), this.$(".first-test-modal").addClass("hidden"), 
this.$("#new-test-popup").addClass("hidden"), this.$(".wizard-modal").removeClass("hidden");
...
var attributes, company_name, that;
return e.preventDefault(), HR.util.ajaxmsg("Creating Test...", !1, !0, 1e3), company_name = HR.currentUser.get("company").name, 
this.lang = "", "java-test" === e.currentTarget.id ? (this.lang = "Java", attributes = {
name:company_name + " Java Test",
tid:24974
}) :"csharp-test" === e.currentTarget.id ? (this.lang = "C#", attributes = {
name:company_name + " C# Test",
tid:28764
}) :"cpp-test" === e.currentTarget.id && (this.lang = "C++", attributes = {
name:company_name + " C++ Test",
tid:24975
}), that = this, this.collection.create(attributes, {
silent:!0,
success:function(_this) {
return function(model) {
var track_data;
...
lang:that.lang
}, HR.util.track("New Wizard Test", track_data), HR.util.trackTotango("New Wizard Test", "Tests");
};
}(this),
error:function() {
return this.$(".response-message").removeClass("hidden").addClass("error").html("Could not Save Test");
