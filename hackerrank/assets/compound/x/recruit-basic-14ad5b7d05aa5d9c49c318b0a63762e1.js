...
}), this.recording.set("ops", this.question.ops), 0 === this.question.ops.length && setTimeout(function() {
return function() {
return HR.util.ajaxmsg("<center>We are doing some data migration to make the reports load faster.<br/> All your reports will be available in 3 hours. Sorry for the inconvenience</center>", !1, !1, 1e3);
};
}(this), 1e3), this.$(".slider").slider({
...
this.test.get("show_template") && ("true" === this.test.get("show_template").toLowerCase() ? this.show_template = !0 :"false" === this.test.get("show_template").toLowerCase() && (this.show_template = !1)), 
...
showHeadTail:this.show_template,
