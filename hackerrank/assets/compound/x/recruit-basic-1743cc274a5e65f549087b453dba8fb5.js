...
void 0;
if ("developer" !== role && "trial" === this.currentUser.get("company").striple_plan && this.userLabels.length >= 30) return alert("You can add only upto 30 users in the trial period"), 
null;
}
...
return function() {
return _this.showCodeEditor(current_recording.code, lang_mime_mapping[editor_lang]);
};
}(this)) :this.showCodeEditor(current_recording.code, lang_mime_mapping[editor_lang])) :"ops" === this.type && this.recording ? (this.question.language ? (editor_lang = this.question.language, 
...
void 0) :"invited_by" === column ? (ret.push(row.invited_by), void 0) :"endtime" === column ? (ret.push(moment(row[column]).format("D MMM, YYYY - HH:mm Z")), 
...
var report, url;
return report = HR.currentUser.get("report"), report && report.interview_id && parseInt(this.id) === report.interview_id ? url = "" + HR.INTERVIEWS_DOMAIN + "/api/interviews/" + report.interview_id + ("?api_key=" + report.apiKey + "&_=" + 1e7 * Math.random()) :(url = "" + HR.INTERVIEWS_DOMAIN + "/api/interviews", 
this.get("id") && (url += "/" + this.get("id")), url += "?auth_v2=" + HR.currentUser.get("auth_v2") + "&api_key=" + HR.currentUser.get("apiKey") + "&_=" + 1e7 * Math.random()), 
url;
...
var report, url;
return report = HR.currentUser.get("report"), url = report && report.interview_id && parseInt(this.interview_id) === report.interview_id ? "" + HR.INTERVIEWS_DOMAIN + "/api/interviews/" + report.interview_id + "/recordings/code?auth_v2=" + HR.currentUser.get("auth_v2") + "&api_key=" + report.apiKey :"" + HR.INTERVIEWS_DOMAIN + "/api/interviews/" + this.interview_id + "/recordings/code?auth_v2=" + HR.currentUser.get("auth_v2") + "&api_key=" + HR.currentUser.get("apiKey");
...
var report, url;
return report = HR.currentUser.get("report"), url = report && report.interview_id && parseInt(this.interview_id) === report.interview_id ? "" + HR.INTERVIEWS_DOMAIN + "/api/interviews/" + report.interview_id + "/recordings/?auth_v2=" + HR.currentUser.get("auth_v2") + "&api_key=" + report.apiKey :"" + HR.INTERVIEWS_DOMAIN + "/api/interviews/" + this.interview_id + "/recordings/?auth_v2=" + HR.currentUser.get("auth_v2") + "&api_key=" + HR.currentUser.get("apiKey");
