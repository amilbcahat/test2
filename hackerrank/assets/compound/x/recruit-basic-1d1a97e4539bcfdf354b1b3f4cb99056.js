...
this._choices_views = [], window.HR.appView.dirty = !1, this.listenTo(window.HR.Vent, "view:dirty", this.openDirtyModal);
...
success:function(_this) {
return function() {
return _this.isLibrary ? Backbone.history.navigate("library/personal/", !0) :Backbone.history.navigate("tests/" + _this.testmodel.get("id") + "/questions/", !0);
};
}(this)
});
...
success:function(_this) {
return function(model) {
return _this.isLibrary ? Backbone.history.navigate("library/questions/" + model.get("id") + "/edit/step3", !0) :Backbone.history.navigate("tests/" + _this.testmodel.get("id") + "/questions/" + model.get("id") + "/edit/step3", !0);
};
}(this)
}));
