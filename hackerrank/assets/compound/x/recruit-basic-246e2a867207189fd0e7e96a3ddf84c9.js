...
this) :(this.enableButton("test-submit"), this.$("#login-form").before('<div class="text-center alert error" id="acknowledge-alert"> You cannot take this test without agreeing to the specified conditions. </div>'), 
void 0);
