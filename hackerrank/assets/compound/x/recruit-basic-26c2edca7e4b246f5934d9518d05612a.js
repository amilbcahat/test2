...
return function(xhr) {
var next_url;
return data = xhr, data.error ? _this.showError(data.error) :(next_url = _this.model.get("nextqid") ? "" + _this.tid + "/questions/" + _this.model.get("nextqid") :"" + _this.tid + "/questions", 
...
error:function(_this) {
return function(xhr) {
return data = xhr, data.error ? _this.showError(data.error) :_this.showError();
};
}(this)
