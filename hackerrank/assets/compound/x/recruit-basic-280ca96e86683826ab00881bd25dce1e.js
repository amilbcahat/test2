...
jQuery(function() {
var AddApiClientView;
return AddApiClientView = function(_super) {
function AddApiClientView() {
return AddApiClientView.__super__.constructor.apply(this, arguments);
}
var HR, _ref;
return __extends(AddApiClientView, _super), AddApiClientView.prototype.template = "x/add-api-client-modal", 
AddApiClientView.prototype.tagName = "div", AddApiClientView.prototype.initialize = function(options) {
return this.parent = options.parent, AddApiClientView.__super__.initialize.call(this, options);
}, AddApiClientView.prototype.render = function() {
return this.$el.html(HR.appController.template(this.template, this)({
model:this.model.toJSON()
})), this.$("#add-client-modal").modal(), this;
}, AddApiClientView.prototype.events = function() {
return {
"submit form[name=add-client-form]":"addClient"
};
}, AddApiClientView.prototype.disableForm = function() {
return this.$("button[type=submit]").attr("disabled", !0).addClass("disabled");
}, AddApiClientView.prototype.enableForm = function() {
return this.$("button[type=submit]").attr("disabled", !1).removeClass("disabled");
}, AddApiClientView.prototype.addClient = function(e) {
return e.preventDefault(), $(".alert-error").addClass("hidden"), this.disableForm(), 
this.model.set("name", this.$("input[name=new-client-name]").val(), {
silent:!0
}), this.model.set("redirect_uri", this.$("input[name=new-client-uri]").val(), {
silent:!0
}), this.model.save(null, {
suppressMessage:!0,
success:function(_this) {
return function() {
return _this.$("button.close").click(), _this.enableForm(), _this.collection.fetch();
};
}(this),
...
_this.$(".alert-error").removeClass("hidden"), $("div#ajax-msg-wrap #ajax-msg").addClass("hidden"), 
_this.enableForm();
};
}(this)
});
}, HR = null != (_ref = window.HR) ? _ref :{}, HR.AddApiClientView = AddApiClientView, 
AddApiClientView;
...
return model.get("is_owner_team") ? null :"real" === model.get("type") && model.get("edit") === !0 ? {
id:model.get("id"),
text:model.get("name")
} :null;
};
...
var Switchery;
return Switchery = require__("switchery"), $.map($(_this.el).find(".js-switch"), function(item) {
return window.n = _this.$(item).parent().find(".switchery"), _this.$(item).parent().find(".switchery").remove(), 
new Switchery(item), _this.$(item).attr("checked") ? _this.$(item).next().find("small").css("left", "20px") :void 0;
});
};
}(this));
...
this.enableForm(), void 0;
if ("developer" !== role && "trial" === HR.currentUser.get("company").striple_plan && this.userLabels.length >= 30) return this.enableForm(), 
...
role = this.user_data.role, user_data = {
user_id:user_id,
team_id:team_id
}, user_team_model = new HR.UserTeamModel()) :"edit" === this.type && (role = this.user_data.role, 
...
jQuery(function() {
var EditApiClientView;
return EditApiClientView = function(_super) {
function EditApiClientView() {
return EditApiClientView.__super__.constructor.apply(this, arguments);
}
var HR, _ref;
return __extends(EditApiClientView, _super), EditApiClientView.prototype.template = "x/edit-api-client-modal", 
EditApiClientView.prototype.tagName = "div", EditApiClientView.prototype.initialize = function(options) {
return this.parent = options.parent, this.collection = options.collection, EditApiClientView.__super__.initialize.call(this, options);
}, EditApiClientView.prototype.render = function() {
return console.log(this.model.toJSON()), this.$el.html(HR.appController.template(this.template, this)({
model:this.model.toJSON()
})), this.$("#edit-client-modal").modal(), this;
}, EditApiClientView.prototype.events = function() {
return {
"submit form[name=edit-client-form]":"editClient"
};
}, EditApiClientView.prototype.disableForm = function() {
return this.$("button[type=submit]").attr("disabled", !0).addClass("disabled");
}, EditApiClientView.prototype.enableForm = function() {
return this.$("button[type=submit]").attr("disabled", !1).removeClass("disabled");
}, EditApiClientView.prototype.editClient = function(e) {
return e.preventDefault(), $(".alert-error").addClass("hidden"), this.disableForm(), 
this.model.set("name", this.$("input[name=edit-client-name]").val(), {
silent:!0
}), this.model.set("redirect_uri", this.$("input[name=edit-client-uri]").val(), {
silent:!0
}), this.$("button.close").click(), this.model.save(null, {
suppressMessage:!0,
success:function(_this) {
return function() {
return _this.$("button.close").click(), _this.enableForm(), _this.collection.fetch();
...
}, HR = null != (_ref = window.HR) ? _ref :{}, HR.EditApiClientView = EditApiClientView, 
EditApiClientView;
}(window.HR.GenericView);
});
}.call(this), function() {
...
jQuery(function() {
var HR, SettingsApiView, _ref;
return SettingsApiView = function(_super) {
function SettingsApiView() {
return SettingsApiView.__super__.constructor.apply(this, arguments);
}
return __extends(SettingsApiView, _super), SettingsApiView.prototype.template = "x/settings-api", 
SettingsApiView.prototype.class_name = "settings-api", SettingsApiView.prototype.initialize = function(options) {
return SettingsApiView.__super__.initialize.call(this, options), this.clients = options.clients, 
this.tokens = options.tokens, this.subviews = [], this.listenTo(this.clients, "change", this.render), 
this.listenTo(this.clients, "reset", this.render), this.listenTo(this.clients, "add", this.render), 
this.listenTo(this.clients, "remove", this.render), this.listenTo(this.tokens, "change", this.render), 
this.listenTo(this.tokens, "reset", this.render), this.listenTo(this.tokens, "add", this.render), 
this.listenTo(this.tokens, "remove", this.render);
}, SettingsApiView.prototype.events = function() {
return {
"click .add-client":"addClient",
"click .edit-client":"editClient",
"click .remove-client":"removeClient",
"click .add-token":"addToken",
"click .edit-token":"editToken",
"click .remove-token":"removeToken"
};
}, SettingsApiView.prototype.render = function() {
var content;
return content = HR.appController.template(this.template, this)({
clients:this.clients,
tokens:this.tokens
}), this.$el.html(content), this;
}, SettingsApiView.prototype.editClient = function(e) {
var client, client_id, editApiClientModal;
return e.preventDefault(), client_id = this.$(e.currentTarget).data("client-id"), 
client = this.clients.get(parseInt(client_id, 10)), editApiClientModal = new HR.EditApiClientView({
parent:this,
model:client,
collection:this.clients
}), this.subviews.push(editApiClientModal), this.$(".dialog-wrapper").html(editApiClientModal.render().el);
}, SettingsApiView.prototype.addClient = function(e) {
var addApiClientModal, client;
return e.preventDefault(), client = new HR.ApiClientModel(), addApiClientModal = new HR.AddApiClientView({
parent:this,
model:client,
collection:this.clients
}), this.subviews.push(addApiClientModal), this.$(".dialog-wrapper").html(addApiClientModal.render().el);
}, SettingsApiView.prototype.removeClient = function(e) {
var client, client_id;
return e.preventDefault(), client_id = this.$(e.currentTarget).data("client-id"), 
this.disableThrobber = !0, client = this.clients.get(parseInt(client_id, 10)), client.destroy(), 
$("div#ajax-msg-wrap #ajax-msg").addClass("hidden");
}, SettingsApiView.prototype.addToken = function(e) {
var token;
return e.preventDefault(), token = new HR.ApiTokenModel(), token.save(null, {
suppressMessage:!0
}), this.tokens.fetch();
}, SettingsApiView.prototype.removeToken = function(e) {
var token, token_id;
return e.preventDefault(), token_id = this.$(e.currentTarget).data("token-id"), 
this.disableThrobber = !0, token = this.tokens.get(parseInt(token_id, 10)), token.destroy(), 
$("div#ajax-msg-wrap #ajax-msg").addClass("hidden");
}, SettingsApiView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.SettingsApiView = SettingsApiView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
var add_user_modal;
return e.preventDefault(), this.collection.models.length > 1 ? (add_user_modal = new HR.TeamUserView({
parent:this,
collection:this.collection,
userLabels:this.userLabels,
users:this.users,
type:"add user"
}), this.subviews.push(add_user_modal), this.$(".dialog-wrapper").html(add_user_modal.render().el)) :HR.util.alert({
title:"Need to create a team",
message:"You need to create a team before adding a new user",
okButtonText:"OK",
callback:function(_this) {
return function() {
return _this.$(".js-add-team").click();
};
}(this)
});
...
}, HR.util.track("Invited candidate", track_data), HR.util.trackTotango("Invited Candidates", "Tests")), 
data.model.not_invited.length > 0 ? (that.$(".js-erroralert").removeClass("hidden"), 
...
jQuery(function() {
var ApiClientModel, HR, _ref;
return ApiClientModel = function(_super) {
function ApiClientModel() {
return ApiClientModel.__super__.constructor.apply(this, arguments);
}
return __extends(ApiClientModel, _super), ApiClientModel.prototype.defaultRedirectUri = "urn:ietf:wg:oauth:2.0:oob", 
ApiClientModel.prototype.url = function() {
var url;
return url = "/x/api/v1/oauth/applications", this.get("id") && (url += "/" + this.get("id")), 
this.get("redirect_uri") && this.get("name") && (url += "?application[name]=" + this.get("name") + "&application[redirect_uri]=" + this.get("redirect_uri")), 
url;
}, ApiClientModel;
}(window.HR.GenericModel), HR = null != (_ref = window.HR) ? _ref :{}, HR.ApiClientModel = ApiClientModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var ApiTokenModel, HR, _ref;
return ApiTokenModel = function(_super) {
function ApiTokenModel() {
return ApiTokenModel.__super__.constructor.apply(this, arguments);
}
return __extends(ApiTokenModel, _super), ApiTokenModel.prototype.url = function() {
var url;
return url = "/x/api/v1/oauth/custom_tokens", this.get("id") && (url += "/" + this.get("id")), 
url;
}, ApiTokenModel;
}(window.HR.GenericModel), HR = null != (_ref = window.HR) ? _ref :{}, HR.ApiTokenModel = ApiTokenModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var ApiClientsCollection, HR, _ref;
return ApiClientsCollection = function(_super) {
function ApiClientsCollection() {
return ApiClientsCollection.__super__.constructor.apply(this, arguments);
}
return __extends(ApiClientsCollection, _super), ApiClientsCollection.prototype.model = window.HR.ApiClientModel, 
ApiClientsCollection.prototype.url = function() {
var url;
return url = "/x/api/v1/oauth/applications/";
}, ApiClientsCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.ApiClientsCollection = ApiClientsCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var ApiTokensCollection, HR, _ref;
return ApiTokensCollection = function(_super) {
function ApiTokensCollection() {
return ApiTokensCollection.__super__.constructor.apply(this, arguments);
}
return __extends(ApiTokensCollection, _super), ApiTokensCollection.prototype.model = window.HR.ApiTokenModel, 
ApiTokensCollection.prototype.url = function() {
var url;
return url = "/x/api/v1/oauth/custom_tokens/";
}, ApiTokensCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.ApiTokensCollection = ApiTokensCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
