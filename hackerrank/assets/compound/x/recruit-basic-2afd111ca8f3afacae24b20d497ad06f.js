...
r.status ? (HR.util.trackTotango("Candidate Attempted", "Tests"), r.model.new_attempt && r.model.new_attempt === !0 && localStorage.clear(), 
r.model.attempt_done ? HR.router.navigate("" + uniqid) :HR.router.navigate("" + uniqid + "/questions", {
trigger:!0,
replace:!0
