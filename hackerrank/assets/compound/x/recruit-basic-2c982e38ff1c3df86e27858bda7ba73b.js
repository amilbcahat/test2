...
this.tokens = options.tokens, this.authorized_clients = options.authorized_clients, 
this.subviews = [], this.listenTo(this.clients, "change", this.render), this.listenTo(this.clients, "reset", this.render), 
this.listenTo(this.clients, "add", this.render), this.listenTo(this.clients, "remove", this.render), 
this.listenTo(this.tokens, "change", this.render), this.listenTo(this.tokens, "reset", this.render), 
this.listenTo(this.tokens, "add", this.render), this.listenTo(this.tokens, "remove", this.render), 
this.listenTo(this.authorized_clients, "change", this.render), this.listenTo(this.authorized_clients, "reset", this.render), 
this.listenTo(this.authorized_clients, "add", this.render), this.listenTo(this.authorized_clients, "remove", this.render);
...
"click .revoke-authorized-client":"revokeAuthorizedClient"
};
...
tokens:this.tokens,
authorized_clients:this.authorized_clients
}), this.$el.html(content), this;
...
$("div#ajax-msg-wrap #ajax-msg").addClass("hidden");
}, SettingsApiView.prototype.revokeAuthorizedClient = function(e) {
var authorized_client, authorized_client_id;
return e.preventDefault(), authorized_client_id = this.$(e.currentTarget).data("authorized-client-id"), 
this.disableThrobber = !0, authorized_client = this.authorized_clients.get(parseInt(authorized_client_id, 10)), 
authorized_client.destroy(), $("div#ajax-msg-wrap #ajax-msg").addClass("hidden");
}, SettingsApiView;
...
jQuery(function() {
var HR, MCQChoiceView, QuestionCodeEditStep1View, QuestionCodeEditStep2View, QuestionCodeEditStep3View, QuestionCodeEditStep4View, QuestionCodeEditView, QuestionCompleteEditView, QuestionDesignEditStep1View, QuestionDesignEditStep2View, QuestionDesignEditView, QuestionMCQEditView, QuestionSubjectiveEditView, QuestionTaskEditView, TestQuestionEditView, TestcaseAlertModalView, TestcaseDeleteModalView, TestcaseEditModalView, TestcaseView, TestcasesUploadModalView, _ref;
...
jQuery(function() {
var ApiAuthorizedClientModel, HR, _ref;
return ApiAuthorizedClientModel = function(_super) {
function ApiAuthorizedClientModel() {
return ApiAuthorizedClientModel.__super__.constructor.apply(this, arguments);
}
return __extends(ApiAuthorizedClientModel, _super), ApiAuthorizedClientModel.prototype.defaultRedirectUri = "urn:ietf:wg:oauth:2.0:oob", 
ApiAuthorizedClientModel.prototype.url = function() {
var url;
return url = "/x/api/v1/oauth/authorized_applications", this.get("id") && (url += "/" + this.get("id")), 
url;
}, ApiAuthorizedClientModel;
}(window.HR.GenericModel), HR = null != (_ref = window.HR) ? _ref :{}, HR.ApiAuthorizedClientModel = ApiAuthorizedClientModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var ApiAuthorizedClientsCollection, HR, _ref;
return ApiAuthorizedClientsCollection = function(_super) {
function ApiAuthorizedClientsCollection() {
return ApiAuthorizedClientsCollection.__super__.constructor.apply(this, arguments);
}
return __extends(ApiAuthorizedClientsCollection, _super), ApiAuthorizedClientsCollection.prototype.model = window.HR.ApiAuthorizedClientModel, 
ApiAuthorizedClientsCollection.prototype.url = function() {
var url;
return url = "/x/api/v1/oauth/authorized_applications/";
}, ApiAuthorizedClientsCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.ApiAuthorizedClientsCollection = ApiAuthorizedClientsCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
