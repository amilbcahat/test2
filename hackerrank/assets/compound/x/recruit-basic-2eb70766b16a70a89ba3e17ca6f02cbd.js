...
success:function() {
return 1 === parseInt(HR.currentUser.get("created_tests_count"), 10) ? (this.$(".first-test-modal").removeClass("hidden"), 
HR.util.ajaxmsg("Successfully created test...", !1, !0, 1e3)) :(HR.util.ajaxmsg("Taking you to the test...", !1, !0, 1e3), 
