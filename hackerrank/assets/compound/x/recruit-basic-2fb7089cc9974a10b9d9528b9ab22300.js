...
var a, all_ids, checked, id_array, loc, _i, _len, _ref, _ref1;
...
return console.log("localhost" === (_ref = window.location.hostname) || "localhost.com" === _ref || "127.0.0.1" === _ref), 
loc = "localhost" === (_ref1 = window.location.hostname) || "localhost.com" === _ref1 || "127.0.0.1" === _ref1 ? window.location.hostname :"www.interviewstreet.com", 
window.open("http://" + loc + "/recruit2/report/downloadcsvreport/" + this.testmodel.id + "/?authkey=" + this.testmodel.authkey + "&attempt_id=" + checked.join(","), "_blank");
