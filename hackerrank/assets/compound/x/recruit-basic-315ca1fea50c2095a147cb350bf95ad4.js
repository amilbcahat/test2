...
this.$(".js-rendered-data").ready(this.hideLoading), this.$(".js-rendered-data").attr("src", "" + window.location.protocol + "//design.private.vpc.hackerrank.com" + this.suburl + "/?showAlert=" + this.showAlert);
