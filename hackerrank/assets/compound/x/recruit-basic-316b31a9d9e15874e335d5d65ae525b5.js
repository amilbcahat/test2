...
this.$(".js-rendered-data").attr("src", this.suburl + "?showAlert=" + this.showAlert);
...
this.$(".js-rendered-data").load(this.hideLoading), this.question.submissions && ("undefined" == typeof CodeMirror ? HR.appController.loadCodeMirror(function(_this) {
return function() {
...
return $(this.el).html(HR.appController.template(this.template, this)({
question:this.question
})), this.$("#runstatus").load(this.hideLoading), this.show_template = !1, this.question.show_template && "true" === this.question.show_template.toLowerCase() && (this.show_template = !0), 
this.test.get("show_template") && "true" === this.test.get("show_template").toLowerCase() && (this.show_template = !0), 
HR.appController.loadCodeMirror(function(_this) {
return function() {
return _this.applyCodeshell();
...
"testing" === this.aid && (opts.showSubmit = !1, opts.showCompileTest = !0), opts.showCompileTest !== !1 && (opts.showCompileTest = !0), 
