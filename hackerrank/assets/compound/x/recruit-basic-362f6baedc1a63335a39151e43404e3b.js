...
success:function(model) {
var unsupportedLanguages;
return unsupportedLanguages = model.get("unsupportedLanguages"), unsupportedLanguages && unsupportedLanguages.length > 0 ? HR.util.confirm({
okButtonText:"Yes, Generate Code",
okCallback:function() {
var id;
return that.model = tempQuesModel, lang = that.$("#code-editor-lang-select2").val(), 
id = that.$(".js-code-section-tabs-list li.active").find(".js-code-section-tab").data("id"), 
setTimeout(function() {
return that.tbody_editor.setValue(model.get("" + lang + "_" + id)), that.tbody_editor.refresh();
}, 10);
},
message:"The template generator does not support the following languages you have selected: " + unsupportedLanguages.map(function(l) {
return this.lang_display_mapping[l];
}).join(", ") + ". You need to manually edit the code editor windows to provide stubs for your candidates, or deselect some of the languages from the list and regenerate the code.",
cancelCallback:function() {}
}) :void 0;
}
});
