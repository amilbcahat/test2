...
jQuery(function() {
var HR, MCQChoiceView, QuestionCodeEditStep1View, QuestionCodeEditStep2View, QuestionCodeEditStep3View, QuestionCodeEditStep4View, QuestionCodeEditView, QuestionCompleteEditView, QuestionDesignEditStep1View, QuestionDesignEditStep2View, QuestionDesignEditView, QuestionDiagramEditStep2View, QuestionDiagramEditView, QuestionMCQEditView, QuestionSubjectiveEditView, QuestionTaskEditView, TestQuestionEditView, TestcaseAlertModalView, TestcaseDeleteModalView, TestcaseEditModalView, TestcaseView, TestcasesUploadModalView, _ref;
...
case "uml":
case "electrical":
question_view = new QuestionDiagramEditView({
model:this.model,
testmodel:this.testmodel,
isLibrary:this.isLibrary,
step:this.step
...
return function(model) {
var redirection_url;
if (_.isEmpty(track_data) || (HR.util.track("Added new other question", track_data), 
_this.isLibrary ? HR.util.trackTotango("Added Question - Other", "Library") :HR.util.trackTotango("Added Question - Other", "Tests"), 
track_data = {}, track_data.question_id = model.get("id"), _this.isLibrary || (track_data.test_id = _this.testmodel.get("id")), 
HR.util.track("Added question", track_data)), add_another) return setTimeout(function() {
return HR.util.ajaxmsg("Question saved", !1, !0, 5);
}, 300), setTimeout(function() {
return _this.isLibrary ? (Backbone.history.navigate("library/questions/new/" + model.get("type"), !0), 
HR.router.createLibraryQuestion(model.get("type"))) :(Backbone.history.navigate("tests/" + _this.testmodel.get("id") + "/questions/new/" + model.get("type"), !0), 
...
case "uml":
case "electrical":
redirection_url = "/questions/" + model.get("id") + "/edit/step2";
break;

default:
redirection_url = "/questions/" + model.get("id") + "/edit";
}
return _this.isLibrary ? Backbone.history.navigate("library" + redirection_url, !0) :Backbone.history.navigate("tests/" + _this.testmodel.get("id") + redirection_url, !0);
};
}(this)
...
}(window.HR.GenericView), QuestionDiagramEditView = function(_super) {
function QuestionDiagramEditView() {
return QuestionDiagramEditView.__super__.constructor.apply(this, arguments);
}
return __extends(QuestionDiagramEditView, _super), QuestionDiagramEditView.prototype.template = "x/question-diagram", 
QuestionDiagramEditView.prototype.className = "question-diagram", QuestionDiagramEditView.prototype.initialize = function(options) {
return this._subviews = [], this.step = options.step, this.isLibrary = options.isLibrary, 
this.isLibrary ? void 0 :this.testmodel = options.testmodel;
}, QuestionDiagramEditView.prototype.render = function() {
var content;
return content = HR.appController.template(this.template, this)({
model:this.model.toJSON(),
edit:this.model.get("id") ? !0 :!1,
...
}, QuestionDiagramEditView.prototype.renderStep = function(step) {
var step_view;
switch (step) {
case "step1":
step_view = new QuestionSubjectiveEditView({
model:this.model,
testmodel:this.testmodel,
isLibrary:this.isLibrary
});
...
case "step2":
step_view = new QuestionDiagramEditStep2View({
model:this.model,
testmodel:this.testmodel,
isLibrary:this.isLibrary
});
}
return step_view ? (this._subviews.push(step_view), this.$("#control-overflow").html(step_view.render().el)) :void 0;
}, QuestionDiagramEditView;
}(window.HR.GenericView), QuestionDiagramEditStep2View = function(_super) {
function QuestionDiagramEditStep2View() {
return QuestionDiagramEditStep2View.__super__.constructor.apply(this, arguments);
}
return __extends(QuestionDiagramEditStep2View, _super), QuestionDiagramEditStep2View.prototype.template = "x/question-diagram-step2", 
QuestionDiagramEditStep2View.prototype.className = "question-diagram-step2", QuestionDiagramEditStep2View.prototype.palettes = {
general:{
displayName:"General",
funcName:"addGeneralPalette",
expand:!0
},
basic:{
displayName:"Basic",
funcName:"addBasicPalette",
expand:!0
},
arrows:{
displayName:"Arrows",
funcName:"addArrowsPalette",
expand:!0
},
bpmn:{
displayName:"BPMN",
funcName:"addBpmnPalette",
expand:!0
},
uml:{
displayName:"UML",
funcName:"addUmlPalette",
expand:!0
},
electrical:{
displayName:"Electrical",
funcName:"addElectricalPalette",
expand:!1
},
flowchart:{
displayName:"Flowchart",
funcName:"addFlowchartPalette",
expand:!0
},
aws:{
displayName:"AWS",
funcName:"addAWSPalette",
expand:!1
},
image:{
displayName:"Clipart",
funcName:"addClipartPalette",
expand:!0
},
cisco:{
displayName:"Cisco",
funcName:"addCiscoPalette",
expand:!1
}
}, QuestionDiagramEditStep2View.prototype.initialize = function(options) {
if (this._subviews = [], this.isLibrary = options.isLibrary, this.testmodel = options.testmodel, 
this.language = "html", this.custom_draw_menus = this.model.get("custom_draw_menus").split(","), 
!this.custom_draw_menus) switch (this.model.get("type")) {
case "uml":
this.custom_draw_menus = [ "uml" ];
break;

case "electrical":
this.custom_draw_menus = [ "electrical" ];
break;

default:
this.custom_draw_menus = [];
}
return this.sidebar = null;
}, QuestionDiagramEditStep2View.prototype.events = function() {
return {
"submit form[name=diagram-question-step2-form]":"saveQuestion",
"click .js-code-section-tab":"switchCodeSection",
"click button.js-save-and-add":"saveAndAdd",
"click .js-toggle-list":"togglePalette"
};
}, QuestionDiagramEditStep2View.prototype.render = function() {
var content;
return content = HR.appController.template(this.template, this)({
model:this.model.toJSON(),
palettes:this.palettes,
selected_palettes:this.custom_draw_menus
}), $(this.el).html(content), "undefined" != typeof mxClient && null !== mxClient ? this.initializePalettes() :HR.appController.loadGraphLibraries(function(_this) {
return function() {
return _this.initializePalettes();
};
}(this), function() {
return console.log("error");
}), this;
}, QuestionDiagramEditStep2View.prototype.initializePalettes = function() {
var that;
return this.sidebar || (this.sidebar = new Sidebar()), that = this, this.sidebar.thumbHeight = 50, 
this.sidebar.thumbWidth = 50, _.each(this.palettes, function(p, ptype) {
var palette_body;
return palette_body = that.$el.find("#palette-" + ptype + " > .panel-body").empty(), 
that.sidebar[p.funcName](p.expand, palette_body[0]);
});
}, QuestionDiagramEditStep2View.prototype.saveAndAdd = function(e) {
return this.saveQuestion(e, !0);
}, QuestionDiagramEditStep2View.prototype.togglePalette = function(e) {
var action_type, palette, palette_name;
switch (e.preventDefault(), action_type = this.$(e.target).hasClass("icon-plus") ? "add" :"remove", 
palette = this.$(e.target).closest(".panel-default"), palette_name = this.$(e.target).data("diag"), 
action_type) {
case "add":
if (palette.find("div.panel-title > a").data("parent", "palette-selected-accordion"), 
palette.detach().appendTo("#palette-selected-accordion"), palette.find("i.icon-plus").removeClass("icon-plus txt-green").addClass("icon2-delete txt-orange"), 
-1 === _.indexOf(this.custom_draw_menus, palette_name)) return this.custom_draw_menus.push(palette_name);
break;

case "remove":
return palette.find("div.panel-title > a").data("parent", "palette-accordion"), 
palette.detach().appendTo("#palette-accordion"), palette.find("i.icon2-delete").removeClass("icon2-delete txt-orange").addClass("icon-plus txt-green"), 
this.custom_draw_menus = _.without(this.custom_draw_menus, palette_name);
}
}, QuestionDiagramEditStep2View.prototype.saveQuestion = function(e, add_another) {
return null == add_another && (add_another = !1), e.preventDefault(), this.model.set("custom_draw_menus", this.custom_draw_menus, {
silent:!0
}), this.model.save(null, {
silent:!0,
success:function(_this) {
...
this.xml = this.localSubmissionData ? this.localSubmissionData.xml :null, console.log(this.question.custom_draw_menus), 
this.question.custom_draw_menus) choices = this.question.custom_draw_menus.split(","); else switch (this.question.type) {
case "uml":
choices = [ "uml" ];
break;
