...
return this.$(".js-filterclear").show(), HR.util.ajaxmsg("Loading...", !1, !0, 1e3), 
...
this.$(".filter-quickpad").addClass("mjL"), this.$("#quickpad-name-filter").on("submit", function(_this) {
return function(e) {
...
return this.renderedDialog ? void 0 :("undefined" == typeof this.renderedDialog && document.addEventListener(screenfull.raw.fullscreenchange, function(_this) {
return function() {
...
title:"Switch to fullScreeenMode",
...
debug = !1, debug && console.log("Welcome to Secure Monitoring"), HR.candidate.candidateAttemptModel.get("secure") ? (debug && console.log("Enabling Security"), 
HR.requires("ifvisible", function() {
return function(ifvisible) {
var logEvent;
return debug && console.log("Fetched ifVisible"), window.ifvisible = ifvisible, 
HR.candidate.secureActivity = new HR.CandidateActivityCollection(), HR.candidate.secureActivity.setAid(HR.candidate.candidateAttemptModel.get("id")), 
logEvent = function(data) {
return data.insertTime = new Date(), HR.candidate.secureActivity.add(data);
}, ifvisible.setIdleDuration(5), ifvisible.on("blur", function() {
return logEvent({
action:"blur",
eid:7
});
...
})), this.secureMonitoring(), HR.candidate.candidateAttemptModel.get("secure") && this.fullScreeenMode(), 
