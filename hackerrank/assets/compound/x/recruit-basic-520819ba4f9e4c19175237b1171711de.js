...
return e.preventDefault(), company_name = HR.currentUser.get("company").name, "java-test" === e.currentTarget.id ? attributes = {
...
success:function() {
return 1 === parseInt(HR.currentUser.get("created_tests_count"), 10) ? this.$(".first-test-modal").removeClass("hidden") :Backbone.history.navigate("tests/" + model.id + "/questions", !0);
}
}), track_data = {
step:"Finish"
}, HR.util.track("Created test", track_data), HR.util.trackTotango("Created Test", "Tests");
