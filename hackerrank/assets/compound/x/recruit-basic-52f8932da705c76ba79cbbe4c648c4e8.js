...
return __extends(EnvironmentView, _super), EnvironmentView.prototype.template = "x/environment", 
EnvironmentView.prototype.className = "environment-view container", EnvironmentView.prototype.render = function() {
return $(this.el).html(HR.appController.template(this.template, this)({
...
}, HR.util.track("Invited candidate", track_data), totango.track("Invited Candidates", "Tests")), 
...
return track_data = {
step:"Finish"
}, HR.util.track("Created test", track_data), totango.track("Created Test", "Tests"), 
