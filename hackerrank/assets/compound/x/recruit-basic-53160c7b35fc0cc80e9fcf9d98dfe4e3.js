...
var that;
return that = this, this.type = this.question.ops ? "ops" :this.question.runs ? "runs" :"", 
$(this.el).html(HR.appController.template(this.template, this)({
...
}(this)), this.question.runs && this.setupRuns(), this.question.ops && (this.$("#report-codeshell").show(), 
this.setupOps()), "runs" === this.type ? this.showRunVersion(this.question.runs.length - 1) :this.showOpVersion(this.question.ops.length - 1), 
this;
...
var option;
return option = "<option value='" + i + "'>" + moment(run.time).format("MMMM Do YYYY, h:mm:ss a") + "</option>", 
_this.$("select[name=code-versions]").append(option);
};
}(this)), this.$("select[name=code-versions]").select2({
width:300
}), this.showSelect2();
...
return this.$("select[name=code-versions]").val(i), current_recording = this.question.runs[i], 
this.$(".code-lang").html(this.lang_mapping[current_recording.lang]), this.$(".lang-container").removeClass("hidden"), 
this.$(".run-time").html(moment(current_recording.time).format("MMMM Do YYYY, h:mm:ss a")), 
...
var onlyRuns;
return onlyRuns = e.target.checked, this.question.runs && !onlyRuns ? (this.type = "runs", 
this.showSelect2(), this.showRunVersion(this.question.runs.length - 1)) :(this.type = "ops", 
this.showSlider(), this.showOpVersion(this.question.ops.length - 1));
