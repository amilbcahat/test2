...
jQuery(function() {
var AddUserTeamView, TeamUserView;
...
}(window.HR.GenericView), TeamUserView = function(_super) {
function TeamUserView() {
return TeamUserView.__super__.constructor.apply(this, arguments);
}
var HR, _ref;
return __extends(TeamUserView, _super), TeamUserView.prototype.template = "x/add-user-modal", 
TeamUserView.prototype.tagName = "div", TeamUserView.prototype.questions_permission = {
share:2,
owned:3
}, TeamUserView.prototype.tests_permission = {
share:2,
owned:3
}, TeamUserView.prototype.candidates_permission = {
share:2,
owned:3
}, TeamUserView.prototype.interviews_permission = {
share:2,
owned:3
}, TeamUserView.prototype.initialize = function(options) {
...
this.data = options.data, TeamUserView.__super__.initialize.call(this, options);
...
}(this)), "add user" === this.type ? (name = "new", multiple = !0, disabled = !1, 
this.showPermissions(this.questions_permission, this.tests_permission, this.candidates_permission, this.interviews_permission)) :"add to team" === this.type ? (name = "select2", 
this.$("input[name=user-email]").attr("disabled", "disabled"), this.$("input[name=user-teams-select]").attr("disabled", "disabled"), 
this.$("input[name=user-teams-select]").val(this.collection.get(this.team_id).get("name")), 
this.$("select[name=user-role]").attr("disabled", "disabled"), this.$("input[name=user-admin]").attr("disabled", "disabled"), 
multiple = !1, disabled = !0, this.showPermissions(this.questions_permission, this.tests_permission, this.candidates_permission, this.interviews_permission)) :"edit" === this.type && (name = "pre-filled", 
...
}(this)), this.user_data && (this.$("input[name=user-name]").val(this.user_data.firstname + " " + this.user_data.lastname).attr("disabled", "disabled"), 
this.$("input[name=user-email]").val(this.user_data.email).attr("disabled", "disabled"), 
this.$("input[name=user-teams-select]").val(this.user_data.team.name).attr("disabled", "disabled"), 
"admin" === this.user_data.role ? (this.$("select[name=user-role]").val("recruiter").attr("disabled", !0).trigger("change"), 
this.$("input[name=user-admin]").attr("checked", "checked")) :"recruiter" === this.user_data.role ? (this.$("select[name=user-role]").val("recruiter").attr("disabled", !0).trigger("change"), 
this.$("input[name=user-admin]").removeAttr("checked")) :(this.$("select[name=user-role]").val("developer").attr("disabled", !0).trigger("change"), 
this.$("input[name=user-admin]").removeAttr("checked").addClass("hidden"))), questions_permission = JSON.parse(this.user_data.questions_permission_json), 
tests_permission = JSON.parse(this.user_data.tests_permission_json), candidates_permission = JSON.parse(this.user_data.candidates_permission_json), 
interviews_permission = JSON.parse(this.user_data.interviews_permission_json), this.showPermissions(questions_permission, tests_permission, candidates_permission, interviews_permission)), 
setTimeout(function(_this) {
return function() {
return "new" === _this.type ? _this.$("input[name=user-teams-select]").select2({
data:teams,
multiple:!0
}) :void 0;
};
}(this)), "select2" === name && this.userLabels && setTimeout(function(_this) {
return function() {
...
var data;
return _.isEmpty(object) ? void 0 :(data = _this.users[object.id], _this.$("input[name=user-email]").val(data.email), 
"admin" === data.role ? (_this.$("select[name=user-role]").val("recruiter").trigger("change"), 
_this.$("input[name=user-admin]").click()) :"recruiter" === data.role ? (_this.$("select[name=user-role]").val("recruiter").trigger("change"), 
_this.$("input[name=user-admin]").removeAttr("checked")) :(_this.$("select[name=user-role]").val("developer").trigger("change"), 
_this.$("input[name=user-admin]").removeAttr("checked")), _this.user_id = data.user_id, 
_.compact([ data.firstname, data.lastname ]).join(" "));
}
});
};
}(this), 800), this;
...
return this.$("button[type=submit]").attr("disabled", !1).removeClass("disabled");
}, TeamUserView.prototype.showPermissions = function(questions_permission, tests_permission, candidates_permission, interviews_permission) {
return this.defaultPermissions = {
questions_permission:questions_permission,
tests_permission:tests_permission,
candidates_permission:candidates_permission,
interviews_permission:interviews_permission
}, questions_permission.share > 1 ? this.$("input[name=questions-permission]").attr("checked", "checked") :this.$("input[name=questions-permission]").removeAttr("checked"), 
...
tests_permission.share > 1 ? this.$("input[name=tests-permission][value=share-tests]").attr("checked", "checked") :this.$("input[name=tests-permission][value=share-tests]").removeAttr("checked"), 
candidates_permission.share > 1 ? this.$("input[name=candidates-permission][value=share-candidates]").attr("checked", "checked") :this.$("input[name=candidates-permission][value=share-candidates]").removeAttr("checked"), 
...
interviews_permission.share > 1 ? this.$("input[name=interviews-permission][value=share-interviews]").attr("checked", "checked") :this.$("input[name=interviews-permission][value=share-interviews]").removeAttr("checked"), 
setTimeout(function(_this) {
return function() {
var Switchery;
...
}, TeamUserView.prototype.getPermissions = function() {
var permissions;
return permissions = {
...
}, permissions.questions_permission.share = this.$("input[name=questions-permission]").is(":checked") ? this.defaultPermissions.questions_permission.share >= 2 ? this.defaultPermissions.questions_permission.share :2 :this.defaultPermissions.questions_permission.share <= 1 ? this.defaultPermissions.questions_permission.share :1, 
permissions.tests_permission.owned = this.$("input[name=tests-permission][value=create-tests]").is(":checked") ? 3 :0, 
permissions.tests_permission.share = this.$("input[name=tests-permission][value=share-tests]").is(":checked") ? this.defaultPermissions.tests_permission.share >= 2 ? this.defaultPermissions.tests_permission.share :2 :this.defaultPermissions.tests_permission.share <= 1 ? this.defaultPermissions.tests_permission.share :1, 
permissions.candidates_permission.share = this.$("input[name=candidates-permission][value=share-candidates]").is(":checked") ? this.defaultPermissions.candidates_permission.share >= 2 ? this.defaultPermissions.candidates_permission.share :2 :0, 
permissions.interviews_permission.owned = this.$("input[name=interviews-permission][value=schedule-interviews]").is(":checked") ? 3 :0, 
permissions.interviews_permission.share = this.$("input[name=interviews-permission][value=share-interviews]").is(":checked") ? this.defaultPermissions.interviews_permission.share >= 2 ? this.defaultPermissions.interviews_permission.share :2 :0, 
permissions;
}, TeamUserView.prototype.addUser = function(e) {
var email, firstname, lastname, name, nameComponents, permissions, role, team_id, teams, user_data, user_id, user_team_model;
if (e.preventDefault(), "add user" === this.type) {
if (name = this.$("input[name=user-name]").removeClass("error").val(), nameComponents = name.split(" "), 
firstname = nameComponents.shift(), lastname = nameComponents.join(" "), email = this.$("input[name=user-email]").val(), 
teams = this.$("input[name=user-teams-select]").val().split(","), role = this.$("select[name=user-role]").val(), 
this.$("input[name=user-admin]:checked").length > 0 && (role = "admin"), _.isEmpty(firstname)) return this.$("input[name=user-name]").addClass("error"), 
this.enableForm(), void 0;
if (_.isEmpty(email)) return this.$("input[name=user-email]").addClass("error"), 
this.enableForm(), void 0;
if (_.isEmpty(teams)) return this.$("input[name=user-teams-select]").addClass("error"), 
this.enableForm(), void 0;
user_data = {
firstname:firstname,
lastname:lastname,
...
teams:teams,
role:role
}, user_team_model = new HR.UserTeamModel();
} else "add to team" === this.type ? (team_id = this.team_id, user_id = this.user_id, 
user_data = {
user_id:user_id,
team_id:team_id
}, user_team_model = new HR.UserTeamModel()) :"edit" === this.type && (user_team_model = this.model, 
user_data = {
id:this.mapping_id
});
return permissions = this.getPermissions(), user_data.questions_permission = permissions.questions_permission, 
...
HR.TeamUserView = TeamUserView, TeamUserView;
...
return {
"click .js-add-team-member":"addNewTeamMember",
...
var members, name;
return e.preventDefault(), name = this.$("input[name=team-name]").removeClass("error").val(), 
...
success:function(_this) {
return function() {
return _this.$(".close").click(), _this.collection.fetch({
success:function() {
return _this.parent.render();
}
});
...
jQuery(function() {
var HR, RemoveUserView, SettingsTeamView, TeamsUserSearchView, _ref;
...
"change .teams-main-container .table-body .checkbox input":"multiSelect",
...
}, SettingsTeamView.prototype.addTeam = function(e) {
var new_team_modal;
return e.preventDefault(), e.stopPropagation(), new_team_modal = new HR.NewTeamView({
parent:this,
collection:this.collection,
userLabels:this.userLabels,
users:this.users
}), this.subviews.push(new_team_modal), this.$(".dialog-wrapper").html(new_team_modal.render().el);
}, SettingsTeamView.prototype.addUser = function(e) {
var add_user_modal;
return e.preventDefault(), add_user_modal = new HR.TeamUserView({
parent:this,
collection:this.collection,
userLabels:this.userLabels,
users:this.users,
...
return function(user_label) {
return user_label.id.search(search_str) > -1 ? !0 :!1;
};
}(this)), data = {
users:this.users,
searched_users:searched_users
}, this.search_view.setData(data), this.$(".js-search-container").html(this.search_view.render().el), 
this.$(".js-search-container").removeClass("hidden"), this.$(".js-teams-container").addClass("hidden")) :(this.$(".js-search-container").addClass("hidden"), 
this.$(".js-teams-container").removeClass("hidden"));
...
$(e.currentTarget).is(":checked") && counter > 0 ? $(".teams_main_cta").hasClass("invisible") && ($(e.currentTarget).closest(".table-data").find(".teams_main_cta").removeClass("invisible"), 
$(e.currentTarget).closest(".table-data").find(".team-mem-selected").removeClass("hidden"), 
$(e.currentTarget).closest(".table-data").find(".team-mem-count").addClass("hidden")) :1 > counter && ($(e.currentTarget).closest(".table-data").find(".teams_main_cta").addClass("invisible"), 
$(e.currentTarget).closest(".table-data").find(".team-mem-selected").addClass("hidden"), 
$(e.currentTarget).closest(".table-data").find(".team-mem-count").removeClass("hidden")), 
$(e.currentTarget).closest(".table-data").find(".check_count").html($(e.currentTarget).closest(".table-data").find(".table-body .checkbox input:checked").length);
...
return e.stopPropagation(), e.preventDefault(), console.log($(e.currentTarget).data("action"));
...
}, SettingsTeamView.prototype.addTeamMember2 = function(e) {
...
TeamsUserSearchView.prototype.className = "teams-user-search", TeamsUserSearchView.prototype.setData = function(data) {
...
this._choices_views = [], window.HR.appView.dirty = !1, window.HR.Vent.off("view:dirty").on("view:dirty", this.openDirtyModal);
...
return this.isLibrary = options.isLibrary, this.testmodel = options.testmodel, this.edit = this.model.get("id") ? !0 :!1;
...
var lang;
return null == add_another && (add_another = !1), e.preventDefault(), lang = this.$(".js-code-section-tabs-list li.active").find(".js-code-section-tab").data("lang"), 
this.model.get("" + lang + "_template") !== this.tbody_editor.getValue() && this.model.set("" + lang + "_template", this.tbody_editor.getValue(), {
silent:!0
}), this.model.save(null, {
silent:!0,
...
success:function(model) {
var unsupportedLanguageList, unsupportedLanguages, updateTemplates;
return unsupportedLanguages = model.get("unsupportedLanguages"), updateTemplates = function(deselectLanguages) {
var id;
...
var languages;
return e.preventDefault(), window.HR.appView.dirty = !0, languages = this.$(".hr-checkbox.languages"), 
_.each(languages, function() {
return function(lang) {
return $(lang).addClass("active"), $(lang).find("input").attr("checked", "checked");
};
...
$.fileDownload("tests/" + _this.model.get("id") + "/download?authkey=" + _this.model.get("authkey") + "&withAns=" + withAns, {
httpMethod:"GET",
timeout:1e4,
...
this.suburl = null, this.include_aid = "", this.lastView = "html", this.showAlert = !1, 
this.currentAnswer = {};
...
this.$(".js-rendered-data").ready(this.hideLoading), this.$(".js-rendered-data").attr("src", this.suburl + "?showAlert=" + this.showAlert + this.include_aid);
...
}), $(this.el).html(content), $(".js-btn-render-" + this.question.id).off().click(this.renderIframe), 
$("[for=js-render-" + this.question.id + "-alert]").off("click", this.toggleAlert).on("click", this.toggleAlert), 
this.question.submissions && ("undefined" == typeof CodeMirror ? HR.appController.loadCodeMirror(function(_this) {
return function() {
...
var code_content, code_tab, sub_id, submission, that;
if (null == renIframe && (renIframe = !1), submissions) {
if (that = this, submission = submissions[i], !submission) return;
return this.include_aid = "", "undefined" == typeof submission.id ? (sub_id = "saved", 
this.include_aid = "&aid=" + this.model.get("id") + "&qid=" + this.question.id) :sub_id = submission.id, 
this.suburl = "pdf" !== this.tab ? "" + this.model.url() + "/render/" + sub_id :"" + this.model.url() + "/render/" + sub_id + "?authkey=" + this.testmodel.get("authkey"), 
...
return this.get("id") ? "/xrest/tests/" + this.tid + "/questions/" + this.qid + "/render/" + this.get("id") :"/xrest/tests/" + this.tid + "/questions/" + this.qid + "/render";
...
return "/xrest/tests/" + this.get("id") + "/candidate";
}, RecruitTestModel;
...
"download" === this.operation ? document.location = "/xrest/questions/" + this.qid + "/testcases/batch_ops?tcids=" + tcids_string + "&operation=" + this.operation :_.include([ "changescore", "changedifficulty", "marksample", "delete" ], this.operation) ? $.ajax({
type:"POST",
url:"/xrest/questions/" + this.qid + "/testcases/batch_ops?tcids=" + tcids_string + "&operation=" + this.operation,
data:params,
success:function(_this) {
return function() {
return _this.fetch({
