...
return question_view && (this._subviews.push(question_view), $(this.el).html(question_view.render().el)), 
this;
...
QuestionDiagramEditStep2View.prototype.className = "question-diagram-step2", QuestionDiagramEditStep2View.prototype.initialize = function(options) {
return this._subviews = [], this.isLibrary = options.isLibrary, this.testmodel = options.testmodel, 
this.language = "html", this.palettes = [ "General", "Basic", "Arrows", "Bpmn", "Uml", "Electrical", "Flowchart", "AWS", "Clipart" ], 
this.sidebar = null;
...
return function() {
return _this.sidebar = new Sidebar(), _this.initializePalettes();
};
}(this), function() {
return console.log("error");
}), this;
...
var that;
return that = this, this.sidebar.thumbHeight = 50, this.sidebar.thumbWidth = 50, 
_.each(this.palettes, function(p) {
return console.log("add" + p + "Palette"), that.sidebar["add" + p + "Palette"](!0, that.$el.find("#palette-" + p + " > .panel-body")[0]);
});
...
return this.ui = new EditorUi(this.editor, [ "flowchart" ], this.$("#geEditor")[0]), 
this.xml && this.ui && mxGraphFiles.load_xml(this.ui, this.xml), this.ui ? setTimeout(this.saveUml, 3e3) :void 0;
