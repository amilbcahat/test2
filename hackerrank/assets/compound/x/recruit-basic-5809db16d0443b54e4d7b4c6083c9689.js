...
var download_questions, ques, question_index, view, _i, _len, _ref;
for (download_questions = this.$("#questions-download"), question_index = 1, _ref = this.model.get("questions_data"), 
_i = 0, _len = _ref.length; _len > _i; _i++) ques = _ref[_i], ques.question_index = question_index++, 
view = new HR.TestLibraryQuestionView({
question:ques,
test:this.model,
noexpand:!0,
actions:"download"
}), download_questions.append(view.render().el);
return window.PhantomJSPrinting = {
header:{
height:"100px",
contents:function() {
return "<div style='background-color:#39424e; width:'100%;'> <img src='" + location.protocol + "//" + location.host + "/assets/brand/hrx_formerlyIS_white.png' style='height:35px; margin-left: 10px;margin-top:8px; margin-bottom:15px;'></img></div>";
}
},
footer:{
height:"80px",
contents:function(pageNum, numPages) {
return "<center style='margin-top:10px;'>" + pageNum + "/" + numPages + "</center>";
}
}
};
