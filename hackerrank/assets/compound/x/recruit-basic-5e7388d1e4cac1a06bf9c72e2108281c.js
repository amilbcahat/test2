...
e.preventDefault(), this.$(".error-msg").addClass("hidden"), submitUrl = "/xrest/users/upload_logo", 
...
}, that = this, $("#company-logo").hide(), $('<div  id="logo-throbber" width="100px" height="100px"><span class="inline-throbber loading" ></span></div>').insertAfter("#company-logo"), 
$.ajax({
url:submitUrl,
type:"POST",
dataType:"json",
...
}).attr("src", data.url + "?" + new Date().getTime()), that.$("#upload-logo-modal").modal("hide");
}
});
},
error:function(data) {
