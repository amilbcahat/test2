...
return "new-test-popup-link" === e.target.id || "icon2-createtest" === e.target.className || $(e.target).closest("#new-test-popup").length || that.closeCreateTestPopup(), 
...
success:function() {
return 1 === parseInt(HR.currentUser.get("sign_in_count"), 10) && 0 === parseInt(HR.currentUser.get("created_tests_count"), 10) ? this.$(".welcome-modal").removeClass("hidden") :void 0;
}
}), this;
...
var attributes;
return e.preventDefault(), "java-test" === e.currentTarget.id ? attributes = {
name:"New Java Test",
tid:24974
...
success:function() {
var track_data;
return this.$(".welcome-modal").addClass("hidden"), HR.currentUser.fetch({
success:function() {
return 1 === parseInt(HR.currentUser.get("created_tests_count"), 10) ? this.$(".first-test-modal").removeClass("hidden") :void 0;
}
}), track_data = {
step:"Finish"
}, HR.util.track("Created test", track_data), HR.util.trackTotango("Created Test", "Tests");
