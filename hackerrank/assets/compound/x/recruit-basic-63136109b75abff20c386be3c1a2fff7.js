...
return function() {
return _this.$("button.close").click(), HR.util.trackTotango("Add User to Team", "Application"), 
setTimeout(function() {
...
type:"QuickPad",
step:"Finish"
}, HR.util.track("Created Interview", track_data), HR.util.trackTotango("Created Interview", "Interviews"), 
...
}(this)), this.set_answer(), this.question.has_samples && (this.$(".bb-runall").remove(), 
this.$(".bb-submit").closest("div.pull-right").prepend('<div class="bb-runall pull-left mjR mmT">\n<label class="disabled"><input type="checkbox" id="js-runall-cases" disabled="disabled"> Run against all testcases.</label>\n</div>')), 
setTimeout(function(_this) {
return function() {
...
($("#js-runall-cases").attr("checked") || !this.question.has_samples || "runalltestcases" === e) && (e = "runalltestcases", 
HR.candidate.ctmodel.setAllCases(!0)), HR.candidate.ctview = new HR.RecruitCandidateCompileTestView(), 
...
0 === m.get("testcase_status").length ? HR.candidate.ctview.setStatus("Compiled successfully.", "orange") :0 === pass ? HR.candidate.ctview.setStatus("No test cases passed.", "red") :i > pass ? "runalltestcases" === e ? HR.candidate.ctview.setStatus("Compiled successfully. " + pass + "/" + i + " test cases passed.", "orange") :(HR.candidate.ctview.setStatus("Compiled successfully. " + pass + "/" + i + " sample test cases passed.", "orange"), 
_this.$("#js-runall-cases").removeAttr("checked").attr("disabled", "disabled").closest("label").addClass("disabled")) :"runalltestcases" !== e ? (HR.candidate.ctview.setStatus("Compiled successfully. All sample test cases passed!", "green"), 
_this.$("#js-runall-cases").attr("checked", "checked").removeAttr("disabled", "disabled").closest("label").removeClass("disabled")) :HR.candidate.ctview.setStatus("Compiled successfully. All test cases passed!", "green");
}
...
success:function(_this) {
return function(xhr) {
return xhr.error ? _this.showError(xhr.error) :(HR.candidate.ctmodel = new HR.CandidateCompileTestModel(), 
...
error:function() {
return function(xhr) {
return HR.candidate.ctview.setStatus(xhr.error);
};
}(this)
}, request_params.iframe = !0, request_params.processData = !1, request_params.files = answer, 
$.ajax(request_params)) :(this.showError("Please upload a file"), void 0);
...
return that.checkForResult(that, data, e);
}, 2e3), void 0) :(0 !== m.get("status") && (_this.enableRunCode(), clearTimeout(HR.candidate.ctloop), 
HR.candidate.ctloop = null, m.get("result") > 0 ? (HR.candidate.ctview.setStatus("Error.", "red"), 
