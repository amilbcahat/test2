...
"click .formgroup.disabled":"showNoToggleError"
};
...
}, QuestionMCQEditView.prototype.checkAndToggleType = function() {
return this.$("ul#choices-container li.active").length > 1 ? this.$("input#js-toggle-multiple-mcq").attr("disabled", !0).closest(".formgroup").addClass("disabled") :this.$("input#js-toggle-multiple-mcq").removeAttr("disabled").closest(".formgroup").removeClass("disabled");
}, QuestionMCQEditView.prototype.showNoToggleError = function() {
return HR.util.ajaxmsg("<div class='error'>Please select atmost one answer to enable.</div>", !1, !0, 5);
}, QuestionMCQEditView.prototype.toggleMultipleAnswers = function(e) {
...
silent:!0
}), HR.util.ajaxmsg("Candidate will be able to select multiple answers.", !1, !0, 5);
break;

case "multiple_mcq":
this.$("ul#choices-container li.active").length > 1 ? e.preventDefault() :(this.model.set({
type:"mcq"
}, {
silent:!0
}), HR.util.ajaxmsg("Candidate will be able to select only one answer.", !1, !0, 5));
}
return this;
...
selector.find(".js-mark-answer").html("Unmark as answer")), this.checkAndToggleType()) :selector.hasClass("active") ? (selector.removeClass("active"), 
selector.find(".js-mark-answer").html("Mark as answer")) :(selector.addClass("active"), 
selector.find(".js-mark-answer").html("Unmark as answer"), this.$("ul#choices-container li.active").length > 1 ? this.$("#js-toggle-multiple-mcq").click() :void 0);
