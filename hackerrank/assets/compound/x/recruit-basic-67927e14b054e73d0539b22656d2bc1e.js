...
var that;
return e.preventDefault(), that = this.parent, this.$(".close").click(), this.model.removeQuestion(this.qid, {
success:function() {
var track_data;
return track_data = {
question_id:this.qid,
test_id:that.model.get("id")
}, HR.util.track("Deleted question", track_data), that.showUndoMessage(this.qid, this.index), 
setTimeout(function() {
