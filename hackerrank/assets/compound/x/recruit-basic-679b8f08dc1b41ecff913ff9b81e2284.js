...
}), $(this.el).html(content), this.setupTimezoneSelect(), this.$("input[type=file]").bootstrapFileInput(), 
...
this.$(".filter-owner").addClass("mjL");
...
var diff_view, i, innerHTML, left, opcodes, outobj, output, right, sm, tname, _i, _len, _ref, _results;
...
outobj.too_large ? _results.push(this.$(".js-output").append("<p class='mdL'><em>Too large to include here.</em></p>")) :"code" === this.question.type ? (left = difflib.stringAsLines(outobj.expected), 
...
viewType:0
}), _results.push(this.$(".js-output").append(diff_view))) :(output = $.trim(outobj.actual), 
output = output.replace(/\n/g, "<br />"), innerHTML = '<table class="diff table table-bordered"><thead><tr><th class="texttitle">Candidate\'s Output</th></tr></thead><tbody><tr><td style="padding-left: 10px">' + output + "</td></tr></tbody></table>", 
_results.push(this.$(".js-output").append(innerHTML)));
return _results;
