...
return this.$(".js-select-tc:checked").length > 0 ? (this.$(".js-select-tc:checked").length < this.$(".js-select-tc").length && this.$(".js-select-all").prop("indeterminate", !0), 
this.$(".batch-operations").show()) :(this.$(".js-select-all").prop("indeterminate", !1), 
this.$(".batch-operations").hide()), this.updateTcids();
...
this.$(".batch-operations").find("input, .btn, .dropdown").addClass("disabled").attr("disabled", "true");
...
var score;
return score = this.$("input.score").val(), this.testcases.setOperation("changescore"), 
this.performOperation({
score:score
});
...
return e && e.preventDefault(), this.testcases.setOperation("download"), this.performOperation();
}, QuestionCodeEditStep3View.prototype.deleteSelected = function() {
return this.testcases.setOperation("delete"), this.performOperation();
...
this.$("tbody").empty(), this.testcases.models.length > 0 && _.each(this.testcases.models, function(_this) {
...
question_id:qid,
test_id:that.model.get("id")
}, HR.util.track("Deleted question", track_data), that.showUndoMessage(qid, index), 
setTimeout(function() {
...
"download" === this.operation ? document.location = "/xrest/questions/" + this.qid + "/testcases/" + tcids_string + "/batch_ops?operation=" + this.operation :_.include([ "changescore", "changedifficulty", "marksample", "delete" ], this.operation) ? $.ajax({
type:"POST",
url:"/xrest/questions/" + this.qid + "/testcases/" + tcids_string + "/batch_ops?operation=" + this.operation,
data:params,
success:function(_this) {
return function() {
return _this.fetch({
