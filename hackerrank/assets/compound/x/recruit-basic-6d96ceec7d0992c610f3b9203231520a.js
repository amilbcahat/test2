...
return more_details = [], this.model.get("test") && (HR.currentUser.canViewCandidateDetails() === !0 && _.each(this.model.get("candidate_details"), function(detail) {
...
"click .js-section-timeleft-action":"sectionSetTime"
};
...
}).get(), actionsShown = !1, this.sel_ids.length > 0 && "in-progress" !== this.type && (this.$(".js-acount").html(" " + this.sel_ids.length + " "), 
this.$(".js-reports-actions").show(200), actionsShown = !0), this.sel_ids.length > 0 && "in-progress" === this.type && this.testmodel.get("time_slots") && (this.$(".js-acount").html(" " + this.sel_ids.length + " "), 
this.$(".js-section-timeleft").show(), this.$(".js-reports-actions").show(200), 
actionsShown = !0), actionsShown ? void 0 :this.$(".js-reports-actions").hide(200);
...
}, TestReportsDataTableView.prototype.sectionSetTime = function(e) {
var candidate_section, ids, mins_left;
return e.preventDefault(), ids = this.getCheckedIds(), mins_left = this.$(".js-mins-left").val(), 
candidate_section = this.$(".js-candidate-section").val(), HR.util.ajaxmsg("Setting candidate state..", !0, !1), 
$.ajax({
type:"put",
url:"/x/api/v1/tests/" + this.testmodel.get("id") + "/set_attempts_sectiontime",
data:{
ids:ids.join(","),
mins_left:mins_left,
...
success:function(_this) {
return function() {
return _this.makeDT(), _this.parent.render();
};
}(this),
error:function(e) {
var jsn;
return jsn = JSON.parse(e.responseText), HR.util.ajaxmsg("Unable to set this state. Use valid values: " + jsn.message, !1, !0, 10);
}
});
