...
return SettingsApiView.__super__.initialize.call(this, options), this.collection = options.collection, 
this.subviews = [], this.listenTo(this.collection, "change", this.render), this.listenTo(this.collection, "reset", this.render), 
...
client = this.collection.get(parseInt(client_id, 10)), editApiClientModal = new HR.EditApiClientView({
parent:this,
model:client,
collection:this.collection
...
return e.preventDefault(), client_id = this.$(e.currentTarget).data("client-id"), 
this.disableThrobber = !0, client = this.collection.get(parseInt(client_id, 10)), 
client.destroy(), $("div#ajax-msg-wrap #ajax-msg").addClass("hidden");
}, SettingsApiView;
...
var url;
return url = "/xrest/oauth/applications", this.get("id") && (url += "/" + this.get("id")), 
...
var url;
return url = "/xrest/oauth/applications/";
