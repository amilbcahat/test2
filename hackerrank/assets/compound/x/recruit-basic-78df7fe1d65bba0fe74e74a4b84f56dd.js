...
url:"/x/api/v1/tests/" + that.model.get("id") + "/candidates/invite",
data:attrs,
type:"POST",
success:function(_this) {
return function(data) {
...
comment:comment,
qid:0
}, url = "/x/api/v1/tests/" + this.model.get("tid") + "/candidates/" + this.model.get("id") + "/report_comment", 
...
url:"/x/api/v1/tests/" + this.test.get("id") + "/candidates/" + this.model.id + "/update_score",
type:"PUT",
data:{
...
HR.router.navigate("/tests/" + this.testmodel.id + "/candidates/invite", !0));
...
type:"put",
url:"/x/api/v1/tests/" + this.testmodel.get("id") + "/candidates/" + aid,
data:{
action_type:"addtime",
time:time
},
...
sAjaxSource:"/x/api/v1/tests/" + _this.testmodel.get("id") + "/candidates?state=" + _this.state + "&ats=" + _this.ats + searchparam + dateparam,
fnServerData:function(sSource, aoData, fnCallback) {
...
var url;
return this.id && this.tid ? url = "/x/tests/" + this.tid + "/candidates/{@id}" :void 0;
}, TestAttemptModel;
...
return __extends(TestAttemptModel, _super), TestAttemptModel.prototype.url = function() {
var url;
return this.tid = this.get("tid"), this.id && this.tid && (url = "/x/api/v1/tests/" + this.tid + "/candidates/" + this.id), 
url;
}, TestAttemptModel;
}(window.HR.GenericModel), HR = null != (_ref = window.HR) ? _ref :{}, HR.TestAttemptModel = TestAttemptModel;
});
...
var url;
return this.tid && (url = this.type ? "/x/api/v1/tests/" + this.tid + "/candidates?type=" + this.type :"/x/api/v1/tests/" + this.tid + "/candidates"), 
url;
...
var url;
return url = "/x/api/v1/candidates_search";
