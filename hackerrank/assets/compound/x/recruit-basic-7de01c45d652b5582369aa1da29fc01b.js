...
return this.suburl = "pdf" !== this.tab ? "" + this.model.url() + "/render/" + submission.id :"" + this.model.url() + "/render/" + submission.id + "?authkey=" + this.testmodel.get("authkey"), 
renIframe && this.renderIframe(), this.codeTime = "At " + submission.timespan, this.$(".js-design-code"), 
code_tab = this.$(".js-code-tab").empty(), code_content = "pdf" !== this.tab ? this.$(".js-code-content").empty() :this.$(".js-code-pdf").empty(), 
...
active = "", "pdf" !== that.tab ? (that.lastView === ans.language && (active = "active"), 
code_tab.append("<li class='" + active + "'><a href='#" + tpl_id + "' data-lang='" + ans.language + "' data-toggle='tab'>" + l + "</a></li>"), 
