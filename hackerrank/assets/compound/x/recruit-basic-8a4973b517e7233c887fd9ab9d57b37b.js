...
answer:this.view.answer()
}, a.answer ? (this.$(e.currentTarget).html("Submitting.."), data = {
...
error:function(_this) {
return function(xhr) {
return _this.$(e.currentTarget).html("Submit answer & continue"), data = JSON.parse(xhr.responseText), 
data.error ? _this.showError(data.error) :_this.showError();
};
}(this)
