...
var track_data;
return e.preventDefault(), track_data = {}, (e.target.id = "wizard-modal-link") ? HR.util.track("Launched Test Wizard - New", track_data) :HR.util.track("Launched Test Wizard - Welcome", track_data), 
