...
("runalltestcases" === e || "checked" === $("#js-runall-cases").attr("checked") || question.has_samples) && (HR.candidate.ctmodel.setAllCases(!0), 
e = "runalltestcases"), HR.candidate.ctview = new HR.RecruitCandidateCompileTestView(), 
...
_this.$("#js-runall-cases").attr("checked", "checked")) :HR.candidate.ctview.setStatus("Compiled successfully. All test cases passed!", "green");
}
