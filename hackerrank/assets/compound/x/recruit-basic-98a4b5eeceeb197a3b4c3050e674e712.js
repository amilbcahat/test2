...
return e && e.preventDefault(), this.$(".answer-player-wrapper").attr("style", ""), 
...
return e && e.preventDefault(), this.$(".answer-player-wrapper").attr("style", "z-index:10"), 
...
return e && e.preventDefault(), this.player && clearInterval(this.player), this.playing = !1, 
this.$(".js-auto-pause i").addClass("icon-play").removeClass("icon-pause"), this.$(".js-auto-pause").addClass("js-auto-play").removeClass("js-auto-pause");
...
return this.showOpVersion(ui.value), this.pause_autoPlayCode();
...
return function() {
var answer_before, elem, height, height_before, lines_before, path, rel_top;
return _this.playing && _this.recording.get("ops")[i] && _this.recording.get("ops")[i].op && _this.recording.get("ops")[i].op.length > 0 ? (path = _this.recording.get("ops")[i].op[0].p, 
answer_before = answer.slice(0, path - 1), lines_before = answer_before.split("\n").length, 
elem = _this.$(".line-no > div:contains(" + lines_before + ")"), _this.fullScreenOpened ? (height = (_this.$("pre.outbox").height() - 50) / 2, 
_this.$("pre.outbox").stop(!0, !0).animate({
scrollTop:elem.position().top - height
}, 50, "linear")) :(height_before = $(".interview-feedback > div").height(), _.each(_this.$(".interview-question-recording").parent().prevAll(), function(ques) {
