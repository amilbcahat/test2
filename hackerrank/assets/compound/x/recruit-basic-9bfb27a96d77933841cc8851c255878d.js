...
return this.parent = options.parent, this.page = options.page, this.updateFiltersFromPath(options.filters), 
this.filter_groups = {
...
created_at:"date"
}, HR.search.tests.setGroups(this.filter_groups), HR.search.tests.setDataTypes(this.dataTypes), 
_.values(this.filters).length > 0 ? this.updateResults() :void 0;
...
return e && e.preventDefault(), this.filters = {}, this.clearDate();
}, TestAdvancedSearchView.prototype.clearDate = function() {
return $(".js-daterange").val(""), this.date_filters = {}, $(".js-dateclear").hide(), 
this.advancedSearch();
...
return this.filters = {}, this.date_filters = {}, _.each(filter_string.split(","), function(_this) {
return function(filter) {
return "" !== filter && (filter = filter.split("|"), filter[1]) ? _this.filters[filter[0]] = filter[1].split("+")[0] :void 0;
};
}(this));
...
var filter_url;
return filter_url = _.map(this.filters, function() {
return function(value, key) {
return "" + key + "|" + value;
};
}(this)).join(","), "/tests/search/" + filter_url;
...
return Backbone.history.navigate(this.searchPath()), this.parent.collection.setTids(this.getTids().join(",")), 
...
}), $(this.el).html(content), this.$(".js-daterange").daterangepicker({
latestDate:"today",
separator:" to ",
format:"YYYY-MM-DD",
ranges:{
...
}(this)), this.filters["test-created_at"] && ($(".js-daterange").val(this.filters["test-created_at"].replace("..", " to ")), 
$(".js-dateclear").show()), this;
...
var answer, options, question, save_data, track_data;
...
HR.util.track("Added question", track_data)), Backbone.history.navigate("tests/" + that.testmodel.get("id") + "/questions/" + that.model.get("id") + "/edit", !0);
},
error:function() {
...
return _.isEmpty(track_data) || (HR.util.track("Added new other question", track_data), 
track_data = {}, track_data.question_id = model.get("id"), track_data.test_id = _this.testmodel.get("id"), 
HR.util.track("Added question", track_data)), Backbone.history.navigate("tests/" + _this.testmodel.get("id") + "/questions/" + model.get("id") + "/edit", !0);
};
}(this)
...
tid = this.testmodel.get("id"), 0 === this.testcases.models.length ? this.openTestCaseAlertModal("no_test_cases") :-1 === _.indexOf(_.map(this.testcases.models, function(testcase) {
return testcase.get("sample");
}), !0) ? this.openTestCaseAlertModal("no_sample_test_case") :"approx" === this.model.get("type") ? HR.router.navigate("/tests/" + tid + "/questions/" + qid + "/edit/step4", !0) :HR.router.navigate("/tests/" + tid + "/questions", !0)) :setTimeout(that.saveQuestion(e), 600);
}, QuestionCodeEditStep3View.prototype.openTestCaseAlertModal = function(condition) {
var view;
return view = new TestcaseAlertModalView({
model:this.model,
qid:this.model.get("id"),
tid:this.testmodel.get("id"),
"case":condition
...
return loc = "localhost" === (_ref = window.location.hostname) || "localhost.com" === _ref || "127.0.0.1" === _ref ? window.location.hostname :"www.interviewstreet.com", 
...
return e.preventDefault(), this.test_name = this.$("#test-search-input").val(), 
...
return e && e.preventDefault(), $("#advanced-search").slideUp(), $(".hideAdvanceSearch").fadeOut(function() {
return $("#basic-search").fadeIn(), $(".showAdvanceSearch").fadeIn();
}), this.advanced_search_open = !1;
}, TestsView.prototype.showAdvanceSearch = function(e) {
return e && e.preventDefault(), $("#advanced-search").slideDown(), $("#basic-search").fadeOut(function() {
return $(".hideAdvanceSearch").fadeIn(), $(".showAdvanceSearch").fadeOut();
...
search_test_name:this.advacned_search ? this.advacned_search.getFilter("test_name") :"",
...
this.renderTests(), this.renderAdvancedSearch(), this;
}, TestsView.prototype.renderAdvancedSearch = function() {
return this.advacned_search ? this.advacned_search.setElement($(this.el).find("#advanced-search")).render() :HR.search.tests.fetch({
success:function(_this) {
return function() {
return _this.advacned_search || (_this.advacned_search = new HR.TestAdvancedSearchView({
parent:_this,
filters:_this.filters,
page:_this.page
})), _this.advacned_search.setElement($(_this.el).find("#advanced-search")).render();
};
}(this)
});
...
var url;
return url = this.tids || "" === this.tids ? "/xrest/tests/?tids=" + this.tids :"/xrest/tests/?", 
...
success:function() {
return function(m) {
return HR.candidate.candidateTestModel.set(m), HR.router.navigate("" + m.get("unique_id") + "/feedback", {
trigger:!0,
replace:!0
});
};
...
return new HR.util.ShowConfirmationDialog({
body:"You will not be able access this section again.\n\nAre you sure you want to move to the next section now?",
...
return function(xhr) {
var next_url;
return xhr.error ? _this.showError(xhr.error) :(next_url = _this.model.get("nextqid") ? "" + _this.tid + "/questions/" + _this.model.get("nextqid") :"" + _this.tid + "/questions", 
...
return null == error && (error = "Unable to save your answer. Redirecting you to listing page."), 
...
}(this)), this.renderedDialog = !0, new HR.util.ShowConfirmationDialog({
title:"Switch to full screen mode",
body:"Please switch to full screen mode to proceed to test",
closebutton:!1,
buttons:[ {
name:"Switch now",
"class":"btn-primary",
...
pushState:!1,
root:"/tests"
}), screenfull.request(), dialog.destroy()) :void 0;
}
} ]
}).render()) :void 0;
...
var timeLeft;
return timeLeft = this.getTimeLeft(), $("#countdown-timer").countdown("destroy").countdown({
until:timeLeft,
...
}(this))), HR.candidate.pingTimer && clearInterval(HR.candidate.pingTimer), HR.candidate.candidateAttemptModel.get("attempt_done") ? HR.appView.setTopbarView() :(qdone = _.keys(HR.candidate.candidateAttemptModel.get("solve_mapping") || {}).length, 
...
}), this.updateTimer(), LONG_PING_TIME = 6e4, QUICK_PING_TIME = 1e4, interval = this.getTimeLeft() < 100 ? QUICK_PING_TIME :LONG_PING_TIME, 
...
success:function(model) {
return HR.candidate.candidateAttemptModel = model, saving && HR.candidate.questionView.view.$("#editor").codeshell("setStatusText", "Draft saved " + moment().format("hh:mm a")), 
...
r.status ? HR.router.navigate("" + uniqid + "/questions", {
trigger:!0,
replace:!0
