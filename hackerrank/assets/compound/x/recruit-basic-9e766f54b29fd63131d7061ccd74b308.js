...
RecruitInfoView.prototype.className = "ins-tabs", RecruitInfoView.prototype.events = {
...
ele.parent().parent().find("li").removeClass("active"), this.$("li#" + tabid).addClass("active"), 
this.$(".js-content").addClass("hidden"), this.$(".js-content-" + tabid).removeClass("hidden");
