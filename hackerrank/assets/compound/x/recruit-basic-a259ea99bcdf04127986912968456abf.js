...
}, AddUserTeamView.prototype.disableForm = function() {
return this.$("button[type=submit]").attr("disabled", !0).addClass("disabled");
}, AddUserTeamView.prototype.enableForm = function() {
...
if (e.preventDefault(), this.disableForm(), $(".alert-error").addClass("hidden"), 
newUserLabel = $("input[name=new-user-label]").val(), role = $("select[name=new-user-role]").val(), 
name = $("input[name=new-user-name]").val(), email = $("input[name=new-user-email]").val(), 
team_id = $("input[name=new-user-team-id]").val(), tests_permission = $("input[name=new-user-tests-permission]").attr("checked") ? 2 :1, 
...
}, newUserLabel && this.users[newUserLabel]) user_data.user_id = this.users[newUserLabel].get("user_id"); else {
if (_.isEmpty(firstname)) return $("input[name=new-user-name]").addClass("error"), 
this.enableForm(), void 0;
if (_.isEmpty(email)) return $("input[name=new-user-email]").addClass("error"), 
this.enableForm(), void 0;
if ("developer" !== role && "trial" === this.currentUser.get("company").striple_plan && this.userLabels.length >= 30) return this.enableForm(), 
alert("You can add only upto 30 users in the trial period"), null;
}
...
return function() {
return $("button.close").click(), _this.enableForm(), _this.collection.fetch();
};
}(this),
...
var DeleteQuestionModalView, HR, _ref, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
this.constructor = child;
}
for (var key in parent) __hasProp.call(parent, key) && (child[key] = parent[key]);
...
jQuery(function() {}), DeleteQuestionModalView = function(_super) {
function DeleteQuestionModalView() {
return DeleteQuestionModalView.__super__.constructor.apply(this, arguments);
}
return __extends(DeleteQuestionModalView, _super), DeleteQuestionModalView.prototype.template = "x/delete-question-modal", 
DeleteQuestionModalView.prototype.className = "delete-question-modal", DeleteQuestionModalView.prototype.initialize = function(options) {
return this.parent = options.parent, this.qid = options.qid, this.index = options.index, 
DeleteQuestionModalView.__super__.initialize.call(this, options);
}, DeleteQuestionModalView.prototype._render = function() {
var content;
return content = HR.appController.template(this.template, this)({
model:this.model.toJSON()
}), $(this.el).html(content), this.$("#delete-question-modal").modal(), this;
}, DeleteQuestionModalView.prototype.events = function() {
return {
"click a.js-delete-question":"deleteQuestion"
};
}, DeleteQuestionModalView.prototype.deleteQuestion = function(e) {
var that;
...
}, HR.util.track("Deleted question", track_data), that.parent.showUndoMessage(that.qid, this.index), 
setTimeout(function() {
...
}, DeleteQuestionModalView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.DeleteQuestionModalView = DeleteQuestionModalView;
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
this.constructor = child;
...
return this.$("input[name=resume]").val() ? (submitUrl = "/xrest/users/upload_codepair_resume", 
...
type:"QuickPad",
step:"Finish"
}, HR.util.track("Created Interview", track_data), Backbone.history.navigate("interviews/" + model.get("id"), !0);
};
}(this),
error:function() {
return function() {};
...
type:"Schedule",
step:"Finish"
}, HR.util.track("Created Interview", track_data), Backbone.history.navigate("interviews", !0);
};
}(this),
error:function(_this) {
return function(model, xhr) {
...
var editor_lang;
return this.$(".code-response-container").addClass("hidden"), this.recording ? (this.question.language ? (editor_lang = this.question.language, 
...
return function() {
return _this.showCodeEditor(_this.recording.gotoPosition(i), lang_mime_mapping[editor_lang]);
};
}(this)) :HR.appController.loadCodeMirror(function(_this) {
return function() {
return _this.showCodeEditor(_this.recording.gotoPosition(i), lang_mime_mapping[editor_lang]);
};
}(this)) :this.showCodeEditor(this.recording.gotoPosition(i), lang_mime_mapping[editor_lang])) :void 0;
...
return this.showOpVersion(ui.value);
...
return node = this.$("pre.outbox-temp"), node.empty(), $(node).append('<table><tr><td class="line-no" width="5%"></td><td class="code"></td></tr></table>'), 
...
}), this.$("pre.outbox").html(node.html());
...
jQuery(function() {
var HR, LanguageChangeAlertModal, LibraryQuestionEditView, MCQChoiceView, QuestionCodeEditStep1View, QuestionCodeEditStep2View, QuestionCodeEditStep3View, QuestionCodeEditStep4View, QuestionCodeEditView, QuestionCompleteEditView, QuestionMCQEditView, QuestionSubjectiveEditView, TestcaseAlertModalView, TestcaseDeleteModalView, TestcaseEditModalView, TestcaseView, TestcasesUploadModalView, _ref;
return LibraryQuestionEditView = function(_super) {
function LibraryQuestionEditView() {
return this.createQuestion = __bind(this.createQuestion, this), LibraryQuestionEditView.__super__.constructor.apply(this, arguments);
}
return __extends(LibraryQuestionEditView, _super), LibraryQuestionEditView.prototype.className = "library-question-edit", 
LibraryQuestionEditView.prototype.initialize = function(options) {
return this._subviews = [], this.qid = options.qid, this.type = options.type, this.step = options.step, 
this.qid ? (this.model = new HR.QuestionModel({
id:this.qid,
type:this.type
}), this.listenTo(this.model, "change", this.render), this.model.fetch()) :(this.model = new HR.QuestionModel({
type:this.type
}), this.listenTo(this.model, "change", this.render));
}, LibraryQuestionEditView.prototype.events = function() {}, LibraryQuestionEditView.prototype.render = function() {
var question_view;
switch (_.each(this._subviews, function() {
return function(view) {
return view.destroy();
};
}(this)), $(".js-create-question").off().on("click", this.createQuestion), this.model.get("type")) {
case "code":
case "approx":
...
return this;
}, LibraryQuestionEditView.prototype.createQuestion = function(e) {
...
QuestionMCQEditView.prototype.className = "question-mcq", QuestionMCQEditView.prototype.initialize = function() {
return this._subviews = [], this._choices_views = [], window.HR.appView.dirty = !1, 
this.listenTo(window.HR.Vent, "view:dirty", this.openDirtyModal);
...
_results.push(i++);
return _results;
}, QuestionMCQEditView.prototype.processKey = function(e) {
...
tagHtml += "</span>&nbsp;";
}), window.HR.appView.dirty = !0, this.$(".tag-names-container").html(tagHtml);
}, QuestionMCQEditView.prototype.removeTag = function(e) {
var that;
return e.preventDefault(), this.$(e.currentTarget).parent().remove(), this.tags = [], 
that = this, window.HR.appView.dirty = !0, this.$("span.q-tags").each(function() {
...
}, track_data = this.model.get("id") ? {} :{
type:this.model.get("type"),
step:"Finish"
}, saveModel = function(_this) {
return function() {
return _this.model.save(save_data, {
success:function(model) {
return _.isEmpty(track_data) || (HR.util.track("Added new other question", track_data), 
track_data = {}, track_data.question_id = model.get("id"), HR.util.track("Added question", track_data)), 
window.HR.appView.dirty = !1, add_another ? (setTimeout(function() {
return HR.util.ajaxmsg("Question saved", !1, !0, 5);
}, 300), setTimeout(function() {
return Backbone.history.navigate("library/questions/new/" + model.get("type"), !0), 
HR.router.createLibraryQuestion(model.get("type"));
}, 1e3)) :Backbone.history.navigate("library/questions/" + model.get("id") + "/edit", !0);
},
...
QuestionCompleteEditView.prototype.initialize = function() {
return this._subviews = [], this.eventsSet = !1;
...
skin:"moono",
filebrowserUploadUrl:"/xrest/editor_uploads",
toolbar:[ [ "Bold", "Italic", "Underline", "Strike", "Subscript", "Superscript", "-", "NumberedList", "BulletedList", "-", "Indent", "Outdent", "-", "Link", "Unlink" ], [ "Styles", "Format", "Font", "FontSize", "TextColor" ], [ "Cut", "Copy", "Paste", "PasteText", "PasteFromWord", "-", "Undo", "Redo", "Table" ], [ "Source" ] ],
toolbarCanCollapse:!1,
autoGrow_onStartup:!0,
width:this.$("textarea[name=problem-description]").width() || 780,
removePlugins:"elementspath,liststyle",
...
answer:options
}, that = this, track_data = this.model.get("id") ? {} :{
type:this.model.get("type"),
step:"Finish"
...
return _.isEmpty(track_data) || (HR.util.track("Added new other question", track_data), 
track_data = {}, track_data.question_id = model.get("id"), HR.util.track("Added question", track_data)), 
add_another ? (setTimeout(function() {
return function() {
return HR.util.ajaxmsg("Question saved", !1, !0, 5);
};
}(this), 300), setTimeout(function() {
return function() {
return Backbone.history.navigate("library/questions/new/" + that.model.get("type"), !0), 
HR.router.createLibraryQuestion(that.model.get("type"));
};
}(this), 1e3)) :Backbone.history.navigate("library/questions/" + that.model.get("id") + "/edit", !0);
},
error:function() {
...
QuestionSubjectiveEditView.prototype.className = "question-subjective", QuestionSubjectiveEditView.prototype.initialize = function() {
...
return this._subviews = [], this.step = options.step;
...
QuestionCodeEditStep1View.prototype.className = "question-coding-step1", QuestionCodeEditStep1View.prototype.initialize = function() {
return this.edit = this.model.get("id") ? !0 :!1;
...
track_data = {}, track_data.question_id = model.get("id"), HR.util.track("Added question", track_data)), 
Backbone.history.navigate("library/questions/" + model.get("id") + "/edit/step2", !0);
};
}(this)
}));
...
}, QuestionCodeEditStep2View.prototype.initialize = function() {
return this._subviews = [];
...
next_parameter_id = parseInt(last_parameter_id) + 1, parameter_block = "<div class='block js-brahma-parameter'> <input type='hidden' id='brahma-parameter-select2-" + next_parameter_id + "' class=' js-parameter-type' value='INTEGER' data-id='" + next_parameter_id + "' name='functionParameterType'> <input style='width:70px; margin:10px;' type='text' name='functionParameterName' value=''></input> <a href='#' class='txt-alt-grey psA js-remove-parameter'><i class='icon2-delete'></i></a> </div>", 
...
return lang.value;
}).toArray().join(",")), this.model.save(null, {
silent:!0,
success:function(_this) {
return function(model) {
var id, lang;
...
var view;
return view = new LanguageChangeAlertModal({
model:this.model,
qid:this.model.get("id"),
languages:languageList
}), this._subviews.push(view), this.$("#language-change-modal-container").html(view.render().el);
...
success:function() {
return function(model) {
return Backbone.history.navigate("library/questions/" + model.get("id") + "/edit/step3", !0);
};
}(this)
}));
...
}(window.HR.GenericView), LanguageChangeAlertModal = function(_super) {
function LanguageChangeAlertModal() {
return LanguageChangeAlertModal.__super__.constructor.apply(this, arguments);
}
return __extends(LanguageChangeAlertModal, _super), LanguageChangeAlertModal.prototype.template = "x/language-change-alert-modal", 
LanguageChangeAlertModal.prototype.className = "language-change-alert-modal", LanguageChangeAlertModal.prototype.initialize = function(options) {
return this.qid = options.qid, this.languages = options.languages;
}, LanguageChangeAlertModal.prototype._render = function() {
var content;
return content = HR.appController.template(this.template, this)({
languages:this.languages
}), $(this.el).html(content), this.$("#language-change-alert-modal").modal(), this;
}, LanguageChangeAlertModal;
...
QuestionCodeEditStep3View.prototype.className = "question-coding-step3", QuestionCodeEditStep3View.prototype.initialize = function() {
return this._subviews = [], this.testcases = new HR.TestCasesCollection(), this.listenTo(this.testcases, "add", this.render), 
this.listenTo(this.testcases, "remove", this.render), this.testCasesFetched = !1, 
this.fetchTestcases();
}, QuestionCodeEditStep3View.prototype.fetchTestcases = function() {
var that;
return that = this, this.testcases.reset(), this.testcases.setQid(this.model.get("id")), 
...
var testcase_view;
return model.set("qid", _this.model.get("id")), testcase_view = new TestcaseView({
model:model,
index:index,
parent:_this
...
this.testCasesFetched ? (qid = this.model.get("id"), 0 === this.testcases.models.length ? this.openTestCaseAlertModal("no_test_cases", add_another) :-1 === _.indexOf(_.map(this.testcases.models, function(testcase) {
return testcase.get("sample");
}), !0) ? this.openTestCaseAlertModal("no_sample_test_case") :"approx" === this.model.get("type") ? HR.router.navigate("library/questions/" + qid + "/edit/step4", !0) :add_another ? (setTimeout(function() {
return function() {
return HR.util.ajaxmsg("Question saved", !1, !0, 5);
};
}(this), 300), setTimeout(function(_this) {
return function() {
return Backbone.history.navigate("library/questions/new/" + _this.model.get("type"), !0), 
HR.router.createLibraryQuestion(model.get("type"));
};
}(this), 1e3)) :HR.router.navigate("library/personal/mine", !0)) :setTimeout(that.saveQuestion(e), 600);
...
return this.qid = options.qid, this["case"] = options["case"], this.add_another = options.add_another;
...
return e.preventDefault(), this.$(".close").click(), "approx" === this.model.get("type") ? HR.router.navigate("/library/questions/" + this.qid + "/edit/step4", !0) :(this.add_another && (setTimeout(function() {
return function() {
return HR.util.ajaxmsg("Question saved", !1, !0, 5);
};
}(this), 300), setTimeout(function(_this) {
return function() {
return Backbone.history.navigate("library/questions/new/" + _this.model.get("type"), !0), 
HR.router.createLibraryQuestion(_this.model.get("type"));
};
}(this), 1e3)), HR.router.navigate("/library/personal", !0));
...
var request_params;
return e.preventDefault(), this.$(".alert").addClass("hidden"), this.$(".loading").show(), 
request_params = {
...
success:function(_this) {
return function(xhr) {
return "Success" === xhr.message ? (_this.$(".close").click(), _this.collection.fetch(), 
_this.$(".loading").hide()) :(_this.$(".alert").html(xhr.message), _this.$(".alert").removeClass("hidden"));
};
}(this),
error:function() {
return function() {
...
javascript:"text/javascript",
objectivec:"text/x-csrc"
}, QuestionCodeEditStep4View.prototype.initialize = function() {
...
return Backbone.history.navigate("library/questions/new/" + model.get("type"), !0), 
HR.router.createLibraryQuestion(model.get("type"));
}, 1e3)) :Backbone.history.navigate("library/personal", !0);
};
}(this)
});
}, QuestionCodeEditStep4View;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.LibraryQuestionEditView = LibraryQuestionEditView;
});
}.call(this), function() {
...
submitUrl = "/xrest/users/upload_logo", $form = this.$("#logo-upload-form"), file = $form.find(":file"), 
paramTwo = function() {
var returnValue;
return returnValue = {
files:$form.find(":file"),
...
}), _.isUndefined(found) ? (userLabel = user.get("firstname") + " " + user.get("lastname") + " - " + user.get("email"), 
...
}(this)), backend ? urlstring.join(",") :"?" + urlstring.join("&");
...
url:"/xrest/tests/" + that.model.get("id") + "/link",
data:attrs,
type:"POST",
success:function(_this) {
return function(data) {
...
url:"/xrest/tests/" + that.model.get("id") + "/invite",
data:attrs,
type:"POST",
success:function(_this) {
return function(data) {
...
jQuery(function() {
var HR, LanguageChangeAlertModal, MCQChoiceView, QuestionCodeEditStep1View, QuestionCodeEditStep2View, QuestionCodeEditStep3View, QuestionCodeEditStep4View, QuestionCodeEditView, QuestionCompleteEditView, QuestionDesignEditStep1View, QuestionDesignEditStep2View, QuestionDesignEditView, QuestionMCQEditView, QuestionSubjectiveEditView, TestQuestionEditView, TestcaseAlertModalView, TestcaseDeleteModalView, TestcaseEditModalView, TestcaseView, TestcasesUploadModalView, _ref;
...
window.HR.appView.dirty = !1, this.listenTo(window.HR.Vent, "view:dirty", this.openDirtyModal);
}, QuestionMCQEditView.prototype.events = function() {
return {
"click .js-toggle-richtext":"toggleRichtext",
"submit form[name=mcq-question-form]":"saveQuestion",
...
success:function(model) {
return _.isEmpty(track_data) || (HR.util.track("Added new other question", track_data), 
track_data = {}, track_data.question_id = model.get("id"), track_data.test_id = _this.testmodel.get("id"), 
HR.util.track("Added question", track_data)), window.HR.appView.dirty = !1, add_another ? (setTimeout(function() {
return HR.util.ajaxmsg("Question saved", !1, !0, 5);
}, 300), setTimeout(function() {
return Backbone.history.navigate("tests/" + _this.testmodel.get("id") + "/questions/new/" + model.get("type"), !0), 
HR.router.createQuestion(_this.testmodel.get("id"), model.get("type"));
}, 1e3)) :Backbone.history.navigate("tests/" + _this.testmodel.get("id") + "/questions/" + model.get("id") + "/edit", !0);
},
error:function(model, response) {
return response = JSON.parse(response.responseText), this.$(".text-error").html(response.message), 
this.$("#error-container").show();
...
success:function(model) {
return _.isEmpty(track_data) || (HR.util.track("Added new other question", track_data), 
track_data = {}, track_data.question_id = model.get("id"), track_data.test_id = that.testmodel.get("id"), 
...
return function() {
return Backbone.history.navigate("tests/" + that.testmodel.get("id") + "/questions/new/" + that.model.get("type"), !0), 
HR.router.createQuestion(that.testmodel.get("id"), that.model.get("type"));
};
}(this), 1e3)) :Backbone.history.navigate("tests/" + that.testmodel.get("id") + "/questions/" + that.model.get("id") + "/edit", !0);
},
error:function() {
return responseBox.addClass("error").removeClass("hidden").html("Could not create question, Try again after some time.");
}
...
track_data = {}, track_data.question_id = model.get("id"), track_data.test_id = _this.testmodel.get("id"), 
HR.util.track("Added question", track_data)), Backbone.history.navigate("tests/" + _this.testmodel.get("id") + "/questions/" + model.get("id") + "/edit/step2", !0);
};
}(this)
})) :(this.$("#score").addClass("error"), HR.util.ajaxmsg("Invalid score.", !1, !0, 2), 
void 0);
...
return QuestionDesignEditStep2View.__super__.constructor.apply(this, arguments);
}
...
return this._subviews = [], this.testmodel = options.testmodel, this.language = "html";
...
}, QuestionDesignEditStep2View.prototype.saveQuestion = function(e) {
var lang;
return e.preventDefault(), lang = this.$(".js-code-section-tabs-list li.active").find(".js-code-section-tab").data("lang"), 
this.model.get("" + lang + "_template") !== this.tbody_editor.getValue() && this.model.set("" + lang + "_template", this.tbody_editor.getValue(), {
silent:!0
}), this.model.save(null, {
silent:!0,
...
return this._subviews = [], this.testmodel = options.testmodel;
}, QuestionCodeEditStep2View.prototype.events = function() {
return {
"submit form[name=coding-question-step2-form]":"saveQuestion",
"click label.hr-checkbox":"toggleCheckbox",
...
var last_parameter_container, last_parameter_id, next_parameter_id, parameter_block;
return e.preventDefault(), this.validateParameter() ? (last_parameter_container = _.last(this.$("#brahma-parameters-container .js-brahma-parameter")), 
...
var parent;
return e.preventDefault(), (parent = this.$(e.currentTarget).parent()).remove(), 
parent.siblings().length < 1 ? this.$("button.btn.js-add-parameter").html('<i class="icon-plus"></i>Add Parameter') :void 0;
}, QuestionCodeEditStep2View.prototype.generateTemplates = function(e) {
var empty_param, functionName, functionParams, functionReturn, last_parameter_name, that;
...
}(this)), empty_param > 0 ? void 0 :(functionParams = functionParams.join(","), 
this.model.set("functionParams", functionParams, {
silent:!0
}), this.model.set("functionReturn", functionReturn, {
silent:!0
}), this.model.set("functionName", functionName, {
...
}))) :(this.$("#js-brahma-parameter-error").removeClass("hidden").children("ul").append("<li>Function Name cannot be empty.</li>"), 
void 0);
}, QuestionCodeEditStep2View.prototype.openLanguageChangeModal = function(languageList) {
var view;
return view = new LanguageChangeAlertModal({
...
return __extends(LanguageChangeAlertModal, _super), LanguageChangeAlertModal.prototype.template = "x/language-change-alert-modal", 
LanguageChangeAlertModal.prototype.className = "language-change-alert-modal", LanguageChangeAlertModal.prototype.initialize = function(options) {
return this.tid = options.tid, this.qid = options.qid, this.languages = options.languages;
}, LanguageChangeAlertModal.prototype._render = function() {
var content;
return content = HR.appController.template(this.template, this)({
languages:this.languages
...
var that;
return that = this, this.testcases.reset(), this.testcases.setTid(this.testmodel.get("id")), 
...
var qid, that, tid;
return null == add_another && (add_another = !1), e.preventDefault(), that = this, 
this.testCasesFetched ? (qid = this.model.get("id"), tid = this.testmodel.get("id"), 
...
return testcase.get("sample");
}), !0) ? this.openTestCaseAlertModal("no_sample_test_case") :"approx" === this.model.get("type") ? HR.router.navigate("/tests/" + tid + "/questions/" + qid + "/edit/step4", !0) :(add_another && (setTimeout(function() {
return function() {
return HR.util.ajaxmsg("Question saved", !1, !0, 5);
};
}(this), 300), setTimeout(function(_this) {
return function() {
return Backbone.history.navigate("tests/" + tid + "/questions/new/" + _this.model.get("type"), !0), 
HR.router.createQuestion(tid, model.get("type"));
};
}(this), 1e3)), HR.router.navigate("/tests/" + tid + "/questions", !0))) :setTimeout(that.saveQuestion(e), 600);
}, QuestionCodeEditStep3View.prototype.openTestCaseAlertModal = function(condition, add_another) {
var view;
return null == add_another && (add_another = !1), view = new TestcaseAlertModalView({
model:this.model,
...
return __extends(TestcaseAlertModalView, _super), TestcaseAlertModalView.prototype.template = "x/testcase-alert-modal", 
TestcaseAlertModalView.prototype.className = "testcase-alert", TestcaseAlertModalView.prototype.initialize = function(options) {
return this.tid = options.tid, this.qid = options.qid, this["case"] = options["case"], 
this.add_another = options.add_another;
}, TestcaseAlertModalView.prototype.events = function() {
return {
"click .continue-navigation":"continueNavigation"
};
...
return e.preventDefault(), this.$(".close").click(), "approx" === this.model.get("type") ? HR.router.navigate("/tests/" + this.tid + "/questions/" + this.qid + "/edit/step4", !0) :(this.add_another && (setTimeout(function() {
return function() {
return HR.util.ajaxmsg("Question saved", !1, !0, 5);
};
}(this), 300), setTimeout(function(_this) {
return function() {
return Backbone.history.navigate("tests/" + _this.tid + "/questions/new/" + _this.model.get("type"), !0), 
HR.router.createQuestion(_this.tid, _this.model.get("type"));
};
}(this), 1e3)), HR.router.navigate("/tests/" + this.tid + "/questions", !0));
}, TestcaseAlertModalView;
}(window.HR.GenericView), TestcaseView = function(_super) {
function TestcaseView() {
return TestcaseView.__super__.constructor.apply(this, arguments);
...
return Backbone.history.navigate("tests/" + _this.testmodel.get("id") + "/questions/new/" + model.get("type"), !0), 
HR.router.createQuestion(_this.testmodel.get("id"), model.get("type"));
}, 1e3)) :Backbone.history.navigate("tests/" + _this.testmodel.get("id") + "/questions", !0);
};
}(this)
});
}, QuestionCodeEditStep4View;
...
action:this.action
}), $(this.el).html(content), this.$(".tip").tooltip()), "download" === this.action && this.downloadQuestions(), 
...
}, TestQuestionsView.prototype.downloadQuestions = function() {
var download_questions, ques, question_index, view, _i, _len, _ref, _results;
for (download_questions = this.$("#questions-download"), question_index = 1, _ref = this.model.get("questions_data"), 
_results = [], _i = 0, _len = _ref.length; _len > _i; _i++) ques = _ref[_i], ques.question_index = question_index++, 
...
return e.preventDefault(), HR.util.ajaxmsg("Generating question list as PDF... please wait.", !1, !1), 
$.fileDownload("tests/" + this.model.get("id") + "/download?authkey=" + this.model.get("authkey"), {
httpMethod:"GET",
timeout:3e3,
...
var delete_question_modal, index, qid;
return e.preventDefault(), qid = $(e.currentTarget).data("question-id"), index = parseInt($(e.currentTarget).data("index"), 10), 
delete_question_modal = new HR.DeleteQuestionModalView({
model:this.model,
parent:this,
qid:qid,
index:index
}), this.$("#modal-container").html(delete_question_modal.render().el);
...
jQuery(function() {
var HR, ReportDetailedCodeView, ReportDetailedCorrectErrorsView, ReportDetailedDesignView, ReportDetailedDrawView, ReportDetailedMCQView, ReportDetailedQuestionView, ReportDetailedRewriteCompleteView, ReportDetailedTextAnsView, ReportDetailedView, ReportSummaryView, ReportTimelineView, TestReportView, _ref;
...
var duration, top;
return top = $("#report-q-" + qid).position().top, duration = parseInt(top, 10) / 2, 
$("#report-tab").animate({
scrollTop:top
}, duration);
}, ReportDetailedView;
...
return function() {
var col, currentCodeLine, currentLineNumber, lineNumber, node, tabSize;
return node = _this.$("pre.outbox"), node.empty(), $(node).append('<table><tr><td class="line-no" width="5%"></td><td class="code"></td></tr></table>'), 
currentCodeLine = $("<div></div>"), currentLineNumber = $("<div>1</div>"), $(node).find(".code").append(currentCodeLine), 
$(node).find(".line-no").append(currentLineNumber), col = 0, tabSize = CodeMirror.defaults.tabSize || 4, 
...
return this.renderIframe = __bind(this.renderIframe, this), this.showLoading = __bind(this.showLoading, this), 
this.hideLoading = __bind(this.hideLoading, this), ReportDetailedDesignView.__super__.constructor.apply(this, arguments);
}
...
return this.question = options.question, this.test = options.test, this.tab = options.tab, 
this.subUrl = null, this.lastView = "html";
...
return this.showLoading(), this.$(".js-rendered-data").attr("src", this.suburl);
}, ReportDetailedDesignView.prototype._render = function() {
var content, total_submissions;
return window.CIPHER = this.hideLoading, total_submissions = this.question.submissions.length, 
content = HR.appController.template(this.template, this)({
question:this.question,
anysubmissions:this.question.submissions && total_submissions > 0
}), $(this.el).html(content), this.$(".js-rendered-data").load(this.hideLoading), 
$(".js-btn-render-" + this.question.id).off().click(this.renderIframe), this.question.submissions && ("undefined" == typeof CodeMirror ? HR.appController.loadCodeMirror(function(_this) {
return function() {
return _this.viewCode(_this.question.submissions, total_submissions - 1, !0);
};
}(this)) :this.viewCode(this.question.submissions, total_submissions - 1, !0)), 
this.$(".slider").slider({
min:1,
...
var code_content, code_tab, submission, that;
if (null == renIframe && (renIframe = !1), submissions) {
if (that = this, submission = submissions[i], !submission) return;
return this.suburl = this.model.url() + "/render/" + submission.id, renIframe && this.renderIframe(), 
this.codeTime = "At " + submission.timespan, this.$(".js-design-code"), code_tab = this.$(".js-code-tab").empty(), 
code_content = this.$(".js-code-content").empty(), that = this, "string" == typeof submission.answer && (submission.answer = $.parseJSON(submission.answer)), 
_.each(submission.answer, function(ans) {
var active, l, node, node_html, tpl_id;
return tpl_id = "sub-" + submission.id + "-" + ans.language, l = lang_display_mapping[ans.language], 
active = "", that.lastView === ans.language && (active = "active"), code_tab.append("<li class='" + active + "'><a href='#" + tpl_id + "' data-lang='" + ans.language + "' data-toggle='tab'>" + l + "</a></li>"), 
...
return that.loadAnswer(ans, node.find("pre.outbox"), 500);
});
});
}
...
var a, all_ids, checked, id_array, loc, _i, _len, _ref;
if (checked = this.datatable_view.getCheckedIds(), 0 === checked.length) for (all_ids = this.datatable_view.all_ids, 
checked = [], id_array = _.values(all_ids), _i = 0, _len = id_array.length; _len > _i; _i++) a = id_array[_i], 
checked = checked.concat(a);
return loc = "localhost" === (_ref = window.location.hostname) || "localhost.com" === _ref || "127.0.0.1" === _ref ? window.location.hostname :"istreetapi.hackerrank.com", 
window.open("http://" + loc + "/recruit2/report/downloadcsvreport/" + this.testmodel.get("id") + "/?authkey=" + this.testmodel.get("authkey") + "&attempt_id=" + checked.join(","), "_blank");
...
str_addtime = _this.testmodel.get("time_slots") ? "" :"<input placeholder='(min)' class='span1 no-margin fnt-sz-mid' type='text' aid='" + aid + "' name='add_" + aid + "''><a style='position:relative; top:1px; padding: 7px 7px 6px 7px;' class='btn js-addtime' aid='" + aid + "'>Add</a>", 
...
$.post("/xrest/tests/" + this.testmodel.get("id") + "/share", {
type:"team",
team_id:team_id
}, function(_this) {
return function(data) {
...
return this.advacned_search ? this.advacned_search.searchPath() + "&page=" :"" !== this.filters ? "/tests/search/" + this.filters + "&page=" :"tests/page/";
...
return track_data = {
step:"Finish"
}, HR.util.track("Created test", track_data), Backbone.history.navigate("tests/" + model.id + "/questions", !0);
},
error:function() {
...
step:"Start"
}, HR.util.track("Created test", track_data), this.$("#create-new-test-pointer").addClass("hidden"), 
...
var root;
return this.tid = this.get("tid"), root = this.tid ? "/xrest/tests/" + this.tid + "/questions" :"/xrest/questions";
}, QuestionModel;
...
var root;
return this.tid = this.get("tid"), this.qid = this.get("qid"), root = this.tid ? "/xrest/tests/" + this.tid + "/questions/" + this.qid + "/testcases" :"/xrest/questions/" + this.qid + "/testcases";
}, TestCaseModel.prototype.downloadURL = function() {
return this.get("tid") ? "/xrest/tests/" + this.get("tid") + "/questions/" + this.get("qid") + "/testcases/" + this.get("id") + "/download" :"/xrest/questions/" + this.get("qid") + "/testcases/" + this.get("id") + "/download";
}, TestCaseModel;
...
return this.tid ? "/xrest/tests/" + this.tid + "/questions/" + this.qid + "/testcases" :"/xrest/questions/" + this.qid + "/testcases";
}, TestCasesCollection;
...
var url;
return url = this.filterString ? "/xrest/tests/search?type=advanced&filters=" + this.filterString :this.tids || "" === this.tids ? "/xrest/tests/?tids=" + this.tids :"/xrest/tests/?", 
...
return null == err && (err = "Unable to save your answer. Redirecting you to listing page."), 
HR.util.alert({
title:"Server error",
message:err,
callback:function(_this) {
return function() {
return HR.router.navigate("" + _this.tid + "/redirect", {
trigger:!0,
replace:!0
});
};
...
error:function() {
return function() {
return HR.candidate.ctmodel = null, HR.candidate.ctview.setStatus("Unable to fetch compile information from server.");
};
}(this)
})) :void 0;
...
"codeshellcompile #editor":"renderAnswer"
...
}(this)), $("#runstatus").load(this.hideLoading), this;
...
lang_template:this.getLangDefaults(),
showNonEditableHeadTail:this.show_template,
compile_button_text:"Render & Test",
submit_button_text:"Submit code & Continue",
showSubmit:!0,
autoSave:1e3,
...
"testing" === this.aid && (opts.showSubmit = !1, opts.showCompileTest = !1), opts.showCompileTest !== !1 && (opts.showCompileTest = !0), 
this.$("#editor").codeshell(opts), this.$("#select-lang").addClass("hidden"), this.$("#select-lang-tabs").remove(), 
tabs = "<div class='pull-left btn-group' id='select-lang-tabs'>", this.question.languages.forEach(function(v) {
return tabs += "<a class='cursor btn btn-white " + (v === opts.language ? "active" :void 0) + "' data-lang='" + v + "'>" + lang_display_mapping[v] + "</a>";
}), tabs += "</div>", tabs = $(tabs), tabs.find("a").on({
click:function(_this) {
return function(e) {
return e.preventDefault(), tabs.find("a").removeClass("active"), _this.$("#editor").codeshell("changeLanguage", _this.$(e.currentTarget).addClass("active").data("lang"));
};
}(this)
}), this.$("#editor > div.grey-header").prepend(tabs), this.$("#editor").codeshell("refresh"), 
this.set_answer(), setTimeout(function(_this) {
return function() {
return _this.setDefaultText = !0;
};
}(this), 3e3);
...
return this.setStatus("Document prepared successfully.", "green"), this.$("#runstatus-load").addClass("hidden"), 
this.$("#runstatus").removeClass("hidden");
...
HR.candidate.ctmodel = new HR.CandidateDesignTestModel(), HR.candidate.ctmodel.setAid(this.aid), 
HR.candidate.ctmodel.setQid(this.question.unique_id), this.$("#runstatus").addClass("hidden"), 
this.$("#runstatus-load").removeClass("hidden"), data = this.answer(), this.setStatus("Preparing the document..."), 
HR.candidate.ctmodel.save(data, {
success:function(_this) {
return function(m) {
return _this.setStatus("Loading document.."), _this.$("#runstatus").attr("src", m.url()), 
$(".bb-compile").removeClass("disabled"), HR.util.scrollToBottom(1e3);
};
}(this),
error:function(_this) {
return function() {
return HR.candidate.ctmodel = null, _this.setStatus("There was an issue with rendering this code.", "red");
};
}(this)
})) :void 0;
...
this.autoSaveNamespace = "" + this.aid + "-" + this.question.unique_id) :(this.aid = "testing", 
...
sectional = HR.candidate.candidateTestModel.get("sectional"), sectional && (outerSection = HR.candidate.candidateAttemptModel.get("section")), 
...
act = active ? "active" :"", btnclass = disabled ? "" :"backbone", href = disabled ? "" :"href='" + link + "'", 
...
HR.RecruitCandidateFileUploadView = RecruitCandidateFileUploadView, HR.RecruitCandidateTopBarView = new RecruitCandidateTopBarView(), 
HR.RecruitCandidateFooterView = new RecruitCandidateFooterView(), HR.RecruitCandidateSideBarView = new RecruitCandidateSideBarView(), 
...
that.setError(r.message.title, r.message.body, r.message.alertclass, r.message.field_name);
};
}(this)
}, $(":file").length > 0 && (request_params.iframe = !0, request_params.processData = !1, 
...
return console.log(this.message), this.model = options.model, this.message = options.message;
