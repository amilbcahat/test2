...
testAdmins = $("input[name=test-admins]").removeClass("error").val(), testAdmins ? (this.model.set("test_admins", testAdmins, {
silent:!0
}), this.model.save(null, {
success:function() {
return function() {
...
var public_url, that;
return e.preventDefault(), that = this, public_url = $("input[name=public-test-url]").removeClass("error").val(), 
...
silent:!0,
success:function() {
return that.showSuccess = !0, that.formName = "public-test-url-form", that.render();
}
}) :void 0;
};
...
var short_url, that;
return e.preventDefault(), that = this, short_url = $("input[name=short-test-url]").removeClass("error").val(), 
...
return function(data) {
var button;
return button = HR.loadingButton, HR.util.inlineLoadingEnd(data), "Success" === data.message ? _this.model.fetch({
silent:!0,
success:function() {
return that.showSuccess = !0, that.formName = "short-test-url-form", that.render();
}
}) :void 0;
};
...
})) :$("input[name=test-cutoff]").addClass("error");
}, TestCutoffScoreView;
...
})) :$("input[name=master-password]").addClass("error");
