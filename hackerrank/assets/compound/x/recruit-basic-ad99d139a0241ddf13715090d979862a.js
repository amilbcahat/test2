...
var company_changed, country, data;
return e.preventDefault(), company_changed = !1, data = {}, data.user = {}, data.user.firstname = this.$("#usr-fname").val(), 
...
this.$("#usr-cname").val() !== this.model.get("company").name && (data.user.company = this.model.get("company"), 
data.user.company.name = this.$("#usr-cname").val(), data.user.company.email_from = this.$("#usr-cemailfrom").val(), 
company_changed = !0), this.model.set("timezone_local", !1), this.model.save(data.user, {
success:function(model) {
return company_changed ? model.fetch() :void 0;
},
