...
return new HR.util.ShowConfirmationDialog({
body:"You will not be able access this section again.<br><br>Are you sure?",
...
compact:!0
}), $("#countdown-timer").countdown("option", "onExpiry", this.testTimeUp);
...
window.onfocus = function() {
return function() {
return HR.candidate.windowBlurred = !1, HR.candidate.attemptRefreshNeeded && new HR.util.ShowConfirmationDialog({
closebutton:!1,
keyboard:!1,
title:"Refresh needed",
body:"The test state changed while you were away, and will be refreshed shortly.",
buttons:[ {
name:"Proceed with refresh",
"class":"btn-primary",
callback:function(dialog) {
var uid;
uid = HR.candidate.candidateTestModel.get("unique_id"), dialog.destroy(), HR.router.navigate("" + uid + "/redirect", {
trigger:!0,
replace:!0
});
}
...
HR.candidate.windowBlurred && (sectional && model.get("section") !== outerSection || model.get("attempt_done")) ? HR.candidate.attemptRefreshNeeded = !0 :_this.updateTimer();
},
fail:function() {
...
$("#countdown-timer").countdown("destroy").html("Section done."), new HR.util.ShowConfirmationDialog({
closebutton:!1,
keyboard:!1,
title:"Section closed",
body:"You have exceeded the time limit set for this section.<br><br>All answers you submitted before the time limit have been saved. You will automatically be moved to the next section shortly.",
buttons:[ {
name:"Proceed to next section",
"class":"btn-primary",
callback:function(dialog) {
var uid;
uid = HR.candidate.candidateTestModel.get("unique_id"), HR.candidate.attemptRefreshNeeded = !0, 
dialog.destroy(), HR.router.navigate("" + uid + "/redirect", {
trigger:!0,
replace:!0
});
}
...
$("#countdown-timer").countdown("destroy").html("Test done."), new HR.util.ShowConfirmationDialog({
closebutton:!1,
keyboard:!1,
title:"Test finished",
body:"Thank you for taking this test. You have exceeded the time limit set for this test.<br><br>All answers you submitted before the time limit have been saved.<br><br>You will shortly be redirected to the feedback page.",
timeoutButton:0,
timeout:60,
buttons:[ {
