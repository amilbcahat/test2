...
var message, options, prefs_link, prefs_time, subject, tid;
return message = this.$("textarea[name=email-content]").ckeditorGet().getData(), 
options = {}, prefs_time = this.$("input[name=prefs-time]:checked").val(), options.time = "0" === prefs_time ? !1 :!0, 
prefs_link = this.$("input[name=prefs-link]:checked").val(), options.link = "0" === prefs_link ? !1 :!0, 
subject = this.$("input[name=subject]").val(), tid = this.model.get("id"), $.post("/xrest/tests/" + tid + "/preview_invite", {
message:message,
options:options,
subject:subject
}, function(data) {
