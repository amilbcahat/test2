...
}), $(this.el).html(content), this.setupTimezoneSelect(), this.model.get("quickpad") && (this.$("#copy-access-code").popover({
...
data.user.old_password ? data.user.new_password ? data.user.new_password !== data.user.confirm_password ? (message = "Passwords do not match", 
