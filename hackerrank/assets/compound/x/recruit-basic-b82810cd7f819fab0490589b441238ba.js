...
owner:"" + HR.INTERVIEWS_DOMAIN + "/api/interviews/owners?api_key=" + HR.currentUser.get("apiKey") + "&quickpad=" + this.quickpad,
candidate:"" + HR.INTERVIEWS_DOMAIN + "/api/candidates?api_key=" + HR.currentUser.get("apiKey"),
interviewer:"" + HR.INTERVIEWS_DOMAIN + "/api/interviewers?api_key=" + HR.currentUser.get("apiKey")
}, data_store = {
owner:[],
candidate:[],
interviewer:[]
...
var question, save_data, score, track_data;
return e.preventDefault(), question = this.$("textarea[name=problem-description]").removeClass("error").ckeditorGet().getData(), 
score = this.$("#score").val(), this.$("#score").removeClass("error"), this.$("textarea[name=problem-description]").removeClass("error"), 
