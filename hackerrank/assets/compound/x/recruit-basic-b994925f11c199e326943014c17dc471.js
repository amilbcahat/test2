...
console.log("setting to " + m.status.parallel_slots)), _this.$(".js-pdfprogress").html("Processing.."), 
_this.processingLoop();
};
}(this),
error:function(_this) {
return function() {
...
})), can_download && slot_free && (aid = this._getNotDoneAid(), console.log("prcessiubg " + aid), 
this.parallel_slots = this.parallel_slots - 1, dataobj = {
aids:[ aid ],
cmd:"status",
usecache:!0
}, $.ajax({
...
sel_ids = this.getCheckedIds(), this.testmodel.setAction("set_attempts_ats"), act = "qualify" === action ? 2 :"fail" === action ? 3 :parseInt(this.$(e.currentTarget).attr("data-attribute-ats")), 
this.testmodel.save({
aids:sel_ids,
set_ats:act
}, {
...
return viewfound ? (this.$(".js-questiontext").html(this.question.question), this.$(".js-tryview").html(this.view.render().el)) :(this.$(".js-tryview").html("<center>This question type is not available to try at this time.</center>"), 
