...
success:function(model) {
var track_data;
return this.$(".welcome-modal").addClass("hidden"), HR.util.ajaxmsg("Successfully created test...", !1, !0, 1e3), 
HR.currentUser.fetch({
success:function() {
return 1 === parseInt(HR.currentUser.get("created_tests_count"), 10) ? this.$(".first-test-modal").removeClass("hidden") :(HR.util.ajaxmsg("Taking you to the test...", !1, !0, 1e3), 
Backbone.history.navigate("tests/" + model.id + "/questions", !0));
}
}), track_data = {
step:"Finish"
