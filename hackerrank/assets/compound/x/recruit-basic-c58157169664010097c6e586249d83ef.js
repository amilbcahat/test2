...
var me;
return e.preventDefault(), me = this.$(e.currentTarget), HR.candidate.ongoingQuestionNavigation ? void 0 :(HR.candidate.redirectBackTo = me.attr("href"), 
HR.router.navigate("" + HR.candidate.candidateTestModel.get("unique_id") + "/redirect", {
trigger:!0,
replace:!0
}), HR.candidate.ongoingQuestionNavigation = !0, setTimeout(function() {
...
me.removeClass("disabled"), HR.candidate.redirectBackTo = myhref, HR.router.navigate("" + HR.candidate.candidateTestModel.get("unique_id") + "/redirect", {
trigger:!0,
replace:!0
}), HR.candidate.ongoingQuestionNavigation = !0, setTimeout(function() {
return HR.candidate.ongoingQuestionNavigation = !1;
