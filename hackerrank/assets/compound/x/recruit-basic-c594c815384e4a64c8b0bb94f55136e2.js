...
candidate_section = this.$(".js-candidate-section").val(), console.log(mins_left, candidate_section, ids), 
$.ajax({
type:"put",
...
error:function() {
return console.log("There was an issue trying to set sectional time.");
}
});
