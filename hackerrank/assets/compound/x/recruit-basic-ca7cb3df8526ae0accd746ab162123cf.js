...
"click .nav-link":"handleNav"
}, RecruitCandidateSideBarView.prototype.render = function() {
var url;
return HR.candidate.navLinksShouldWork = !0, url = Backbone.history.fragment, $(this.el).html(HR.appController.template(this.template, this)), 
...
return e.preventDefault(), HR.candidate.navLinksShouldWork ? (HR.candidate.navLinksShouldWork = !1, 
...
html += '<li class="' + cls + '"><a href="' + HR.candidate.candidateTestModel.get("unique_id") + '/questions" class="nav-link"><i class="nav-icon icon-list-bullet-large"></i></a></li>', 
cls = "", (url.endsWith("instructions") || url.endsWith("instructions/")) && (cls = "active"), 
html += '<li class="' + cls + '"><a href="' + HR.candidate.candidateTestModel.get("unique_id") + '/instructions" class="nav-link"><i class="nav-icon icon-help-circled"></i></a></li>';
