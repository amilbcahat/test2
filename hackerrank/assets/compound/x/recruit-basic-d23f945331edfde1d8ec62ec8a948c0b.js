...
success:function() {
return function() {
return HR.NotificationModel.push("new interview"), Backbone.history.navigate("interviews", !0);
};
}(this),
error:function() {
return function() {};
...
"undefined" == typeof CodeMirror ? editor_lang !== code ? HR.appController.loadCodeMirrorMode(editor_lang, function(_this) {
return function() {
...
var errorFields;
return response = JSON.parse(response.responseText), errorFields = response.error_fields, 
...
success:function(_this) {
return function(data) {
return HR.util.inlineLoadingEnd(data), data.model.not_invited.length > 0 ? (that.$(".js-erroralert").removeClass("hidden"), 
...
}), $(this.el).html(content), this.question.submissions && ("undefined" == typeof CodeMirror ? this.question.my_lang ? HR.appController.loadCodeMirrorMode(this.question.my_lang, function(_this) {
return function() {
...
var col, currentCodeLine, currentLineNumber, ix, l, language, lineNumber, node, submission, tabSize, that;
if (submissions) {
if (that = this, submission = submissions[i], ix = i, !submission) return;
return this.codeTime = "At " + submission.timespan, l = submission.lang || lang || "code", 
"code" === l && (l = lang || "code"), language = lang_mime_mapping[l], this.$(".langused").html(l.toUpperCase()), 
node = this.$("pre.outbox"), node.empty(), $(node).append('<table><tr><td class="line-no" width="5%"></td><td class="code"></td></tr></table>'), 
currentCodeLine = $("<div></div>"), currentLineNumber = $("<div>1</div>"), $(node).find(".code").append(currentCodeLine), 
$(node).find(".line-no").append(currentLineNumber), col = 0, tabSize = CodeMirror.defaults.tabSize || 4, 
...
this.$(".js-tryalert").removeClass("hide");
if ("textAns" === this.question.type) return this.$(".js-trymsg").html("This answer is subjective, and evaluated later."), 
this.$(".js-tryalert").removeClass("hide");
