...
return e.preventDefault(), this.clearAllValidationErrors(), functionName = this.$("input[name=functionName]").val(), 
functionReturn = this.$("input[name=functionReturn]").val(), empty_param = 0, last_parameter_name = null, 
functionParams = [], that = this, _.each($(".js-brahma-parameter"), function(_this) {
...
this.$("#editor").codeshell("refresh"), this.$("#editor").codeshell("onChange", function(_this) {
