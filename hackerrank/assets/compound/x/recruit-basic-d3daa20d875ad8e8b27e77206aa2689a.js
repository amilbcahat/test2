...
var hreftmp, me;
return console.log("ere"), me = this.$(e.currentTarget), me.hasClass("disabled") ? (e.preventDefault(), 
...
act = active ? "active" :"", btnclass = disabled ? "" :"backbone js-navlink", href = disabled ? "" :"href='" + link + "'", 
