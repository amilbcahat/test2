...
return more_details = [], this.model.get("test") && (HR.currentUser.get("company").developers_see_candidate_details && "True" === HR.currentUser.get("company").developers_see_candidate_details && "developer" === HR.currentUser.get("role") || _.each(this.model.get("candidate_details"), function(detail) {
...
HR.currentUser.get("company").developers_see_candidate_details && "True" === HR.currentUser.get("company").developers_see_candidate_details && "developer" === HR.currentUser.get("role") && (row.email = "candidate " + ix, 
row.full_name && (row.full_name = "Candidate " + ix)), _this.mapColumns(row, ix);
};
}(this))), result;
