...
var data;
return _.isEmpty(object) ? void 0 :(data = _this.users[object.id], _this.$("span.js-user-email").html(data.email), 
_this.$("span.js-user-name").html(data.firstname + " " + data.lastname), "admin" === data.role ? (_this.$("span.js-user-profile").html("Recruitment"), 
_this.$("span.js-user-admin").html("Yes")) :"recruiter" === data.role ? (_this.$("span.js-user-profile").html("Recruitment"), 
