...
var that;
return that = this, this.type = "blank", this.filters = options.filters, this.page = options.page, 
this.advanced_search_open = options.advanced_search_open, this._subviews = [], this.listenTo(this.collection, "change", this.render), 
...
return {
"click .launch-wizard":"showCreateTestPopup",
"click .open-test":"openTest",
"click a#new-test-popup-link":"showCreateTestPopup",
"click a#create-test":"showCreateTestPopup",
...
"click a#csharp-test":"setTestType",
"click a#java-test":"setTestType",
"click a#frontend-test":"setTestType",
"click a#blank-test":"setTestType",
...
return "create-test" === e.target.id || "launch-wizard" === e.target.id || "new-test-popup-link" === e.target.id || "icon2-createtest" === e.target.className || $(e.target).closest(".wizard-modal").length ? void 0 :that.closeCreateTestPopup();
});
}), HR.currentUser.isLocked() && this.$(".account-locked").removeClass("hidden"), 
...
1 === parseInt(HR.currentUser.get("created_tests_count"), 10) && (this.$("a#invite-test").attr("href", "tests/" + this.collection.first().id + "/invite"), 
this.$("a#test-report").attr("href", "tests/" + this.collection.first().id + "/candidates/all"), 
this.$('button[name="open-test"]').attr("value", "tests/" + this.collection.first().id + "/questions"), 
this.$(".first-test-modal").removeClass("hidden")), this;
...
attributes = {}, "blank" === this.type || null === this.type ? attributes = {
name:this.$("#new-test-name").val(),
duration:this.$("#new-test-duration").val()
} :"frontend" === this.type ? attributes = {
name:this.$("#new-test-name").val(),
tid:24975
} :"java" === this.type ? attributes = {
name:this.$("#new-test-name").val(),
tid:24974
} :"csharp" === this.type && (attributes = {
name:this.$("#new-test-name").val(),
tid:28764
...
success:function() {
var track_data;
return this.$(".welcome-modal").addClass("hidden"), HR.currentUser.fetch(), track_data = {
step:"Finish"
...
this.$(".first-test-modal").addClass("hidden"), this.$(".wizard-modal").removeClass("hidden");
}, TestsView.prototype.closeCreateTestPopup = function(e) {
return e && e.preventDefault(), {
name:this.$("#new-test-name").val(""),
duration:this.$("#new-test-duration").val("")
}, this.$(".wizard-modal").addClass("hidden");
}, TestsView.prototype.setTestType = function(e) {
return e.preventDefault(), this.$("li").removeClass("active"), $(e.currentTarget).parent().addClass("active"), 
"frontend-test" === e.currentTarget.id ? (this.type = "frontend", this.$("#new-test-duration").addClass("disabled")) :"java-test" === e.currentTarget.id ? (this.type = "java", 
this.$("#new-test-duration").addClass("disabled")) :"csharp-test" === e.currentTarget.id ? (this.type = "csharp", 
this.$("#new-test-duration").addClass("disabled")) :(this.type = "blank", this.$("#new-test-duration").removeClass("disabled"));
