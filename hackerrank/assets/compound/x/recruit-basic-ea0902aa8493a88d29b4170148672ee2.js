...
return "undefined" == typeof CodeMirror ? (HR.appController.loadCodeMirrorMode(language, function(_this) {
return function() {
return _this.showCodeEditor(answer, language);
};
}(this)), void 0) :(node = this.$("pre.outbox"), node.empty(), $(node).append('<table><tr><td class="line-no" width="5%"></td><td class="code"></td></tr></table>'), 
...
"undefined" == typeof CodeMirror ? (HR.appController.loadCodeMirrorMode(l, function(_this) {
return function() {
return _this.viewCode(submissions, lang, i);
};
}(this)), void 0) :(language = lang_mime_mapping[l], this.$(".langused").html(l.toUpperCase()), 
