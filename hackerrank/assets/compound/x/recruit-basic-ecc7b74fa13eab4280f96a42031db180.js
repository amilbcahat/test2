...
var ans, answers, correct, expected_ans, fillinblank, i, _i, _len, _ref;
if (e.preventDefault(), "mcq" === this.question.type) return parseInt(this.view.answer()) !== this.question.answer ? this.$(".js-trymsg").html("Incorrect. The correct answer is option " + this.question.answer) :this.$(".js-trymsg").html("Correct answer."), 
