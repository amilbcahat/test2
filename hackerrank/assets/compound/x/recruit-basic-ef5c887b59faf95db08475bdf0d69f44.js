...
return this.saveModel = __bind(this.saveModel, this), this.toggleFileTree = __bind(this.toggleFileTree, this), 
QuestionDesignEditStep2View.__super__.constructor.apply(this, arguments);
}
...
return this.saveQuestion(e, !0);
}, QuestionDesignEditStep2View.prototype.saveModel = function() {}, QuestionDesignEditStep2View.prototype.saveQuestion = function(e, add_another) {
...
return console.log(i, v), that.mime_lang_mapping[i] = v;
}) :void 0;
...
return this.multipleFiles ? {} :this.$("#editor").codeshell("value", !0);
