...
this.$(".js-rendered-data").ready(this.hideLoading), this.$(".js-rendered-data").attr("src", "" + window.location.protocol + "//design." + window.location.host + this.suburl + "?renderkey=" + this.testmodel.get("authkey") + "&showAlert=" + this.showAlert + this.include_aid);
...
success:function(_this) {
return function(m) {
return _this.setStatus("Loading document.."), _this.$("#runstatus").attr("src", "" + window.location.protocol + "//design." + window.location.host + m.url()), 
