...
}, InterviewsQuickPadDataTableView.prototype.datatableEl = "#datatable-upcoming", 
InterviewsQuickPadDataTableView.prototype.params = function() {
var base;
return base = InterviewsQuickPadDataTableView.__super__.params.call(this), base.id_suffix = "-upcoming", 
base;
...
resp.paperurl + "?b=" + HR.util.Base64.encode(JSON.stringify(data), !1)) :resp.paperurl + "?b=" + HR.util.Base64.encode(JSON.stringify(this), !1);
