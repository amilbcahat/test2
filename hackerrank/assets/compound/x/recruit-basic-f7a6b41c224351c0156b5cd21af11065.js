...
message_name.length > 32 ? (setTimeout(function() {
return HR.util.inlineLoadingEnd({
message:""
});
}), this.$(".error-msg").removeClass("hidden").html("Title cannot be more than 32 characters.")) :message_name ? (saved_messages = null != (_ref = this.model.get("saved_messages")) ? _ref :{}, 
