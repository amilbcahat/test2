...
return function(model, xhr) {
var response;
return (void 0 === _this.disableThrobber || _this.disableThrobber !== !0) && (HR.util && HR.util.ajaxmsg && HR.util.ajaxmsg("", !1, !0, 0), 
HR.loadingButton && xhr.responseText) ? (response = JSON.parse(xhr.responseText), 
HR.util.inlineLoadingEnd(response)) :void 0;
};
