...
var content, _model;
return _model = this.model.toJSON(), console.log(_model), content = HR.appController.template(this.template, this)({
current_user:_model
...
$err.hide();
}, RecruitCandidateLoginView.prototype.setError = function(title, message, alertclass) {
var $err;
return null == alertclass && (alertclass = null), $err = this.$("#error-message"), 
$err.find("header").html(title), $err.find("p").html(message), alertclass && this.$("#error-message").addClass(alertclass), 
$err.show();
...
trigger:!0,
replace:!0
}), void 0) :(_this.enableButton("test-submit"), that.setError(r.message.title, r.message.body));
};
}(this),
error:function(_this) {
return function(xhr) {
...
that.setError(r.message.title, r.message.body, r.message.alertclass);
};
}(this)
}, $(":file").length > 0 && (request_params.iframe = !0, request_params.processData = !1, 
