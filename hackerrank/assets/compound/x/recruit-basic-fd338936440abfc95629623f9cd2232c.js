...
var url;
return HR.candidate.ongoingSidebarNavigation = !1, url = Backbone.history.fragment, 
...
var me, myhref;
return e.preventDefault(), me = this.$(e.currentTarget), me.hasClass("disabled") || HR.candidate.ongoingSidebarNavigation ? void 0 :(myhref = me.attr("href"), 
...
trigger:!0,
replace:!0
}), HR.candidate.ongoingSidebarNavigation = !0);
