...
jQuery(function() {
var ALLOWED_EXTENDED_ATTRIBUTES, Base64, HR, ajaxmsg, bindFormEvents, candidatemsg, closeSuccessStatus, confirmDialog, countdownTimer, date_get12hour_hour, date_get12hour_offset, date_getMon, date_getMonth, downloadURL, error_html, formData, formatTimeInUserTz, genFormHTML, genModContainer, getDateFromEpoch, getEpochTimeStampFromDateTime, getErrorList, getFileAnchor, getRemainingTime, hralert, hrconfirm, htmlDecode, htmlEncode, initializeTimers, inlineLoadingEnd, inlineLoadingStart, isAvailable, mp_ping, numberSuffix, padZeros, pagination, removeAllInlineThrobbers, renderBreadCrumbs, scrollToBottom, scrollToTop, semiFix, setTab, showInlineSuccess, showLoginError, slugify, sortNumbers, splitDate, successStatus, timezone_abbr, trim, uploadDialog, validate_date, validate_time, _addExtendedAttributes, _encType, _ref;
...
HR.util.candidatemsg = candidatemsg, HR.util.formatTimeInUserTz = formatTimeInUserTz, 
