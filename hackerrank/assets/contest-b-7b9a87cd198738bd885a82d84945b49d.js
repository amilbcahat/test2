...
jQuery(function() {
var ALLOWED_EXTENDED_ATTRIBUTES, Base64, HR, ajaxmsg, bindFormEvents, closeSuccessStatus, confirmDialog, convert_tilde, countdownTimer, date_get12hour_hour, date_get12hour_offset, date_getMon, date_getMonth, downloadURL, error_html, formData, genFormHTML, genModContainer, getDateFromEpoch, getEpochTimeStampFromDateTime, getErrorList, getFileAnchor, getRemainingTime, getlanguage, htmlDecode, htmlEncode, initializeTimers, inlineLoadingEnd, inlineLoadingStart, mp_ping, numberSuffix, padZeros, pagination, removeAllInlineThrobbers, renderBreadCrumbs, scrollToBottom, scrollToTop, semiFix, setTab, showInlineSuccess, showLoginError, slugify, sortNumbers, splitDate, startswith, successStatus, timezone_abbr, trim, uploadDialog, validate_date, validate_time, _addExtendedAttributes, _encType, _ref;
...
return line && "```" !== line && startswith(line, "```") ? $.trim(line.substring(3, line.length)) :null;
...
HR.util.convert_tilde = convert_tilde, window.HR || (window.HR = HR);
