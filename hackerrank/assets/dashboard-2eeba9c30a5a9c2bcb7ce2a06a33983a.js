...
var HR, contest, profile, _makeTopLevel;
...
me:!0
})), contest.cacheSet(HR.PREFETCH_DATA.contest), void 0 === profile.get("id") || profile.get("tour_done") || console.log("tour"), 
HR.router = new HR.DashboardRouter(), Backbone.history.start({
pushState:!0
});
});
}).call(this);