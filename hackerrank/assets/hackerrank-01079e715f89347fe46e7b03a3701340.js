...
return console.log(this.el), alert("called"), $(this.el).modal("hide"), Modal.__super__.remove.apply(this, arguments);
}, Modal;
...
return HR.tourbus && (HR.tourbus.destroy(), HR.tourbus = void 0), ChallengesView.__super__.destroy.apply(this, arguments);
...
return this.$("#onboarding-tour").length > 0 && this.$("#ob-challenge").length > 0 && this.$("#ob-track-card").length > 0 ? (HR.tourbus || (HR.tourbus = $.tourbus("#onboarding-tour", {
onStop:function() {
...
return 2 === frame_to ? HR.router.navigate(track_url_map[$("input[type='radio'][name='favorite']:checked").val()] + "?action=onboarding", !0, !0) :void 0;
...
}), this.tour.render(), mixpanel.push([ "track", "Onboarding Steps", {
Step:0
} ]), this.delegateEvents(), this;
