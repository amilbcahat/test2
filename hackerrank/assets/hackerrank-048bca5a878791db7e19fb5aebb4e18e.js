...
this.filterKinds = [ "school", "company", "country" ], this.challenge && this.filterKinds.push("language"), 
"master" !== this.contest.get("slug") || this.challenge || this.archived ? void 0 :this.template = "leaderboard-overall";
...
"master" !== this.contest.slug || this.challenge || this.archived ? void 0 :this.template = "leaderboard-overall-list";
