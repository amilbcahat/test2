...
return null == contest_slug && (contest_slug = null), null == category && (category = null), 
category || (category = contest_slug, contest_slug = "master"), _contest = new HR.ContestModel({
slug:contest_slug
...
var challenge_map, track_slug, view;
...
return this.e404();
}, DashboardRouter.prototype.onboardingmodal = function() {
var view;
return view = new HR.OnboardingModalView({
body:"TEXT GOES HERE",
header:"HEADER TEXT",
footer:"FOOTER????"
}), HR.appView.setContentView(view);
...
return HR.tourbus && (HR.tourbus.destroy(), $(".ob-overlay").hide()), ChallengesView.__super__.destroy.apply(this, arguments);
...
return this.$("#onboarding-tour").length > 0 && this.$("#ob-challenge").length > 0 && this.$("#ob-track-card").length > 0 && this.$(".ob-overlay").length > 0 ? (this.$(".ob-overlay").click(function() {
...
this.trigger("render"), this.renderOnboarding(), this;
}, ChallengesView;
...
image = $('<img src="/assets/spinner.gif">');
...
}, OnboardingTutorialView.prototype.remove = function() {
return $(this.el).modal("hide"), OnboardingTutorialView.__super__.remove.apply(this, arguments);
...
that.submitLock = !1, response.status ? (model.set("kind", that.model.get("kind"), {
silent:!0
}), that.set) :($btn.setActive(), $btn.setFailedMsg(response.message));
},
error:function() {
...
this.footer = options.footer || "", this.width = options.width || 600;
...
return $(this.el).modal("hide"), OnboardingModalView.__super__.remove.apply(this, arguments);
}, OnboardingModalView;
