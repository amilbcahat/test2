...
return "" + HR.util.getWordpressBaseUrl() + "/?json=get_category_posts&slug=guest-post&page=" + this.page;
...
})), this.renderSubviews(), this.renderPendingForReview();
...
return html += "<li class='lg-block_head'><a href='" + post.url + "'>" + post.title + "</a></li>";
