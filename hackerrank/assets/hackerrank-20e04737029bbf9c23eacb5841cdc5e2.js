...
TrackLeaderboardCollection.__super__.initialize.call(this, options);
}, TrackLeaderboardCollection.prototype.validFilters = [ "network", "school", "company", "country", "language" ], 
TrackLeaderboardCollection.prototype.showLoader = !1, TrackLeaderboardCollection.prototype.metaKeys = [ "current_hacker", "total", "available" ], 
...
var query;
return query = TrackLeaderboardCollection.__super__.queryParams.call(this), "" + query + "&type=" + this.type + "&level=" + this.level;
}, TrackLeaderboardCollection.prototype.restURL = function() {
return "rest/contests/master/tracks/" + this.track + "/leaderboard";
}, TrackLeaderboardCollection.prototype.pageURL = function() {
return "/leaderboard/" + this.track + "/" + this.type + "/level/" + this.level + "/page";
...
}, DashboardRouter.prototype.trackLeaderboard = function(track, type, level, page) {
return null == track && (track = "algorithms"), null == type && (type = "contest"), 
null == level && (level = 1), null == page && (page = 1), HR.requires("compound/extra-views", function() {
var collection, view;
...
collection.cached(), view = new HR.LeaderboardMainView({
collection:collection
}), HR.util.setTab("leaderboard"), HR.appController.setTitle("Leaderboard"), HR.appView.setContentView(view);
});
