...
that = this, resp && resp.id && 0 !== resp.status_code && 3 !== resp.status_code && (resp.game_played === resp.game_total || resp.testcase_message && resp.testcase_message.length > 0) && (1 === resp.score_processed || 3 === resp.score_processed) && HR.QUEUED_SUBMISSIONS && HR.QUEUED_SUBMISSIONS[resp.id] && (HR.QUEUED_SUBMISSIONS[resp.id] = void 0, 
...
url:url,
type:"unlock"
}), social_share.render())), resp && (0 === resp.status_code || 3 === resp.status_code || that.games_queued(resp) || null !== resp.testcase_message && void 0 !== resp.testcase_message && 0 === resp.testcase_message.length || 1 !== resp.score_processed && 3 !== resp.score_processed) && (fetchThrottle || (fetchThrottle = {}), 
