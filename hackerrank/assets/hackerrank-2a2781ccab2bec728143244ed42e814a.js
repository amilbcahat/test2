...
return this.get("challenge_slug") ? "" + this.ns() + "challenges/" + this.get("challenge_slug") + "/submissions/" + this.get("kind") + "/" + this.get("id") :"" + this.ns() + "challenges/" + this.get("challenge").slug + "/submissions/" + this.get("kind") + "/" + this.get("id");
...
return this.filter = "all", this.limit = 5;
...
return this.filter ? this.filter :(this.setFilter("all"), this.filter);
}, GameSetCollection.prototype.url = function() {
return this.contest_slug ? "/rest/contests/" + this.contest_slug + "/submissions/" + this.sid + "/gamesets/?offset=" + (this.page - 1) * this.limit + "&filter=" + this.filter :"/rest/contests/" + HR.appController.get_current_contest_slug() + "/submissions/" + this.sid + "/gamesets/?offset=" + (this.page - 1) * this.limit + "&filter=" + this.filter;
}, GameSetCollection;
...
"challenges/:challenge_slug/submissions/:kind/:submissions_id":"challengeSubmission",
"contests/:contest_slug/challenges/:challenge_slug/submissions/:kind/:submissions_id":"challengeSubmission",
"challenges/:challenge_slug/submissions/:kind/:submissions_id/:_filter":"challengeSubmission",
"contests/:contest_slug/challenges/:challenge_slug/submissions/:kind/:submissions_id/:_filter":"challengeSubmission",
"challenges/:challenge_slug/submissions/:kind/:submissions_id/:element/:element_id":"challengeSubmission",
"contests/:contest_slug/challenges/:challenge_slug/submissions/:kind/:submissions_id/:element/:element_id":"challengeSubmission",
"challenges/:challenge_slug/submissions/:kind/:submissions_id/:_filter/:element/:element_id":"challengeSubmission",
"contests/:contest_slug/challenges/:challenge_slug/submissions/:kind/:submissions_id/:_filter/:element/:element_id":"challengeSubmission",
...
window.mixpanel_data.contest = contest_slug, window.mixpanel_data.challenge = challenge_slug;
}, DashboardRouter.prototype.challengeSubmission = function() {
var challenge_model, fragment, game_id, options, patterns;
return fragment = Backbone.history.fragment, patterns = [ "challenges/:challenge_slug/submissions/:kind/:submissions_id", "contests/:contest_slug/challenges/:challenge_slug/submissions/:kind/:submissions_id", "challenges/:challenge_slug/submissions/:kind/:submissions_id/:_filter", "contests/:contest_slug/challenges/:challenge_slug/submissions/:kind/:submissions_id/:_filter", "challenges/:challenge_slug/submissions/:kind/:submissions_id/:element/:element_id", "contests/:contest_slug/challenges/:challenge_slug/submissions/:kind/:submissions_id/:element/:element_id", "challenges/:challenge_slug/submissions/:kind/:submissions_id/:_filter/:element/:element_id", "contests/:contest_slug/challenges/:challenge_slug/submissions/:kind/:submissions_id/:_filter/:element/:element_id" ], 
options = HR.util.parseURL(patterns, fragment, arguments), HR.appController.setTitle("Submission Details"), 
HR.util.setTab("submissions"), options.submissions_id && options.kind ? (challenge_model = HR.model("challenge", {
slug:options.challenge_slug
}).cached(), HR.requires([ "compound/challenge-views" ], function() {
var challenge_view;
return challenge_view = new HR.ChallengeView({
model:challenge_model,
activeTab:"submissions",
submissionId:options.submissions_id,
submissionOptions:options
}), HR.appView.setContentView(challenge_view);
})) :"play" === options.element && (game_id = options.element_id, (HR.game && HR.game.get("id") !== game_id || !HR.game) && (HR.game = new HR.GameModel({
id:game_id
}), HR.game.fetch(), HR.requires([ "compound/game-views" ], function() {
return HR.game_view = new HR.GameView({
model:HR.game
});
})), HR.appView.setContentView(HR.game_view), HR.game_view.render()), null === options.contest_slug && (options.contest_slug = "master"), 
window.mixpanel_data.landing = !1, window.mixpanel_data.contest = options.contest_slug;
}, DashboardRouter.prototype.submission = function(contest_slug, kind, submission_id, _filter, element, element_id) {
var fragment, fragments, submission_model, that;
return null == contest_slug && (contest_slug = null), null == kind && (kind = null), 
...
contest_slug && HR.appController.set_contest_namespace(contest_slug), submission_id && kind ? (submission_model = HR.model("submission", {
id:submission_id,
filter:_filter,
contest_slug:contest_slug
}), that = this, submission_model.fetch({
success:function() {
return that.navigate(submission_model.pageURL(), {
trigger:!0,
replace:!0
});
}
