...
}, CommonController.prototype.requires = function(deps, success_callback, error_callback) {
var postCallbacks, preCallbacks, staticFiles, _callback;
return preCallbacks = [], postCallbacks = [], staticFiles = _.map(deps, function() {
...
}), "https://hrcdn.net/MathJax/MathJax.js?config=TeX-AMS-MML_HTMLorMML") :HR.appController.staticPath("" + path + ".js");
};
...
}, require(staticFiles, _callback, error_callback);
}, CommonController;
...
"tracks/:track_slug/contests":"trackContests",
careers:"careers",
...
}, DashboardRouter.prototype.trackContests = function(contest_slug, page) {
...
slug:contest_slug
}).cached()), contests_view = new HR.TrackDashboardView({
...
DashboardHeaderView.prototype.className = "dashboard-header", DashboardHeaderView.prototype.initialize = function(options) {
return null == options && (options = {}), this.profile = HR.profile(), this.profile.fetchScores(), 
this.parent = options.parent, this.listenTo(this.profile, "reset", this.render);
}, DashboardHeaderView.prototype.renderScore = function() {
var scores;
return scores = this.profile.get("scores"), _.isObject(scores) && _.isObject(scores[this.parent.current_track_slug]) ? ($(".js-hacker-rank").html(scores[this.parent.current_track_slug].contest.rank), 
$(".js-hacker-score").html(parseInt(scores[this.parent.current_track_slug].contest.score)), 
...
this.profile = HR.profile(), this.collection = options.collection, this.page = options.page, 
...
}, TrackContestsView.prototype.renderView = function() {
...
this.headerView = new HR.DashboardHeaderView({
parent:this
...
this.challenges.sync_status ? ("master" === this.contest.get("slug") && $(".js-categories-challenges").html("<li>" + this.challenges.current_track.categories_count + " categories</li> <li>" + this.challenges.current_track.challenges_count + " challenges</li>"), 
challengesContainer = $(), this._subviews = [], this.challenges.models.length > 0 ? (index = 0, 
_.each(this.challenges.models, function(challenge) {
var _view;
