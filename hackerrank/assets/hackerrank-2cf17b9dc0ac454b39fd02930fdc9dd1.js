...
}, this.languageTemplates())), $(this.el).find("#codeshell-wrapper").codeshell("onChange", this.deleteMarkersOnSource);
}, OnboardingTutorialView.prototype.compileTest = function(e, data) {
var $btn, compile_test, response_view;
if (0 !== _.size(data) && (response_view = this.responseView, this.deleteMarkersOnSource(), 
$btn = $(e.currentTarget).find("button.bb-compile"), "disabled" !== $btn.attr("btn-disabled") && !_.isEmpty($("#codeshell-wrapper").codeshell("getOptions").language))) return $btn.attr("btn-disabled", "disabled"), 
...
editor = $(this.el).find("#codeshell-wrapper").codeshell("getEditor");
...
var error;
return status > 0 && (this.compileButton.html("<i class='icon-play'></i> Run Again"), 
$(this.el).find("#codeshell-wrapper").codeshell("enableCompileBtn"), error = model.get("error")) ? this.responseView :void 0;
...
body:"Your submission is being processed. Stay with us."
...
return e.preventDefault(), e.stopPropagation(), HR.util.confirm({
message:"It will replace your current code. Are you sure you want to do this?",
okCallback:function(_this) {
return function() {
var language, solution;
return language = $(_this.el).find("#codeshell-wrapper").codeshell("getOptions").language, 
solution = _this.model.get("_data").onboarding[language].solution, $(_this.el).find("#codeshell-wrapper").codeshell("setValue", {
code:solution,
language:language
});
};
