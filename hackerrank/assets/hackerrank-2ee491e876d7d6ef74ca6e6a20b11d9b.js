...
jQuery(function() {
var CollegeContestsCollection, HR, _ref;
return CollegeContestsCollection = function(_super) {
function CollegeContestsCollection() {
return CollegeContestsCollection.__super__.constructor.apply(this, arguments);
}
return __extends(CollegeContestsCollection, _super), CollegeContestsCollection.prototype.model = window.HR.ContestModel, 
CollegeContestsCollection.prototype.metaKeys = [ "total", "page" ], CollegeContestsCollection.prototype.initialize = function(options) {
return this.limit = 50, this.page = parseInt(options.page) || 1;
}, CollegeContestsCollection.prototype.baseURL = function() {
return "rest/contests/college";
}, CollegeContestsCollection.prototype.restURL = function() {
return "" + this.baseURL();
}, CollegeContestsCollection.prototype.parse = function(resp, xhr) {
return this.total = resp.total, CollegeContestsCollection.__super__.parse.call(this, resp, xhr);
}, CollegeContestsCollection.prototype.setTotal = function(total) {
this.total = total;
}, CollegeContestsCollection.prototype.getTotal = function() {
return this.total;
}, CollegeContestsCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.CollegeContestsCollection = CollegeContestsCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
contest_slug:contest_slug,
page:page
}), contest = null, contest_slug && "archived" !== contest_slug && "college" !== contest_slug && (contest = new HR.ContestModel({
slug:contest_slug
...
collection:collection
}), this.archivedView.setElement(this.$(".archived-contests")).render()) :"college" === this.contest_slug && (collection = HR.collection("college-contests", {
page:this.page
}).cached({
cacheSiblings:!0
}), this.collegeView = new HR.CollegeContestsView({
collection:collection
}), this.collegeView.setElement(this.$(".college-contests")).render()), this.contest && this.contest.sync_status ? this.contest.get("archived") || this.contest.get("college") || this.contest.get("started") && this.contest.get("signed_up") ? this.challenges && (this.challenges.sync_status || this.challenges.length > 0) ? (challengesContainer = $(), 
_.each(this.challenges.models, function(challenge) {
var _view;
return _view = new HR.ChallengesListView({
contest:this.contest,
...
jQuery(function() {
var CollegeContestsView, HR, _ref;
return CollegeContestsView = function(_super) {
function CollegeContestsView() {
return CollegeContestsView.__super__.constructor.apply(this, arguments);
}
return __extends(CollegeContestsView, _super), CollegeContestsView.prototype.template = "dashboard/college-contests", 
CollegeContestsView.prototype.className = "college-contests-view", CollegeContestsView.prototype.initialize = function(options) {
return this.collection = options.collection, this.listenTo(this.collection, "reset", this.render);
}, CollegeContestsView.prototype.render = function() {
var count;
return this.collection.sync_status ? ($(this.el).html(HR.appController.template(this.template, this)({
contests:this.collection
})), HR.util.pagination(this.$(".pagination-wrapper"), this.collection.total, "/contests/college/", this.collection.page, null, count = this.collection.limit)) :$(this.el).html(HR.appController.viewLoader(64));
}, CollegeContestsView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.CollegeContestsView = CollegeContestsView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
