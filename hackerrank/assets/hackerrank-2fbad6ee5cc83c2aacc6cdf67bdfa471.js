...
}, AppController.prototype.facebook_permission = function(e, callback) {
var data, h, left, top, w;
if (null == e && (e = null), null == callback && (callback = function() {}), e) {
if (e.preventDefault(), data = e.data, "disabled" === $(e.currentTarget).attr("disabled")) return;
} else data = {};
...
}, window.open("/hackers/auth/facebook?display=popup&scope=publish_actions", "facebook_login", "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=" + w + ", height=" + h + ", top=" + top + ", left=" + left);
...
jQuery(function() {
var HR, OpengraphPreferencesModel;
return OpengraphPreferencesModel = function(_super) {
function OpengraphPreferencesModel() {
return OpengraphPreferencesModel.__super__.constructor.apply(this, arguments);
}
return __extends(OpengraphPreferencesModel, _super), OpengraphPreferencesModel.prototype.url = function() {
var username;
return username = this.username || this.get("username"), username ? "/rest/hackers/" + username + "/opengraph_preferences" :void 0;
}, OpengraphPreferencesModel.prototype.setUsername = function(username) {
this.username = username;
}, OpengraphPreferencesModel.prototype.metaKeys = [ "metadata", "status" ], OpengraphPreferencesModel;
}(window.HR.GenericModel), HR = window.HR, HR.OpengraphPreferencesModel = OpengraphPreferencesModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
