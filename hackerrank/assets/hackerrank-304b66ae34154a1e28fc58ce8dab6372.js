...
colors = [ "#2bc56d", "#32a1de", "#f65039", "#805ec9", "#c2c7d0" ], html = 'Level: <span style="color:' + colors[event.level] + '">' + level_in_words[event.level] + "</span><br/>Score: " + event.rating;
}
}
...
var current_rating;
return current_rating = this.model.get("current_rating"), _.isObject(current_rating) && _.isObject(current_rating[track_val]) ? (current_rating[track_val].rating ? this.$("#hacker-rating").html(current_rating[track_val].rating) :this.$("#hacker-rating").html("N/A"), 
current_rating[track_val].rank ? this.$("#hacker-rank").html(current_rating[track_val].rank) :this.$("#hacker-rank").html("N/A"), 
current_rating[track_val].title ? this.$("#hacker-title").html(current_rating[track_val].title) :this.$("#hacker-title").html("N/A")) :(this.$("#hacker-rating").html("N/A"), 
