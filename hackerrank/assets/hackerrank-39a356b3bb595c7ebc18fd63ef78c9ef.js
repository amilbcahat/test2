...
return this.collection.sync_status && "archived" !== this.contest_slug && (!this.contest_slug || this.contest && this.contest.sync_status && this.contest.get("public")) ? (this.contest_slug || (_.each(this.collection.grouped()[0].contests, function(_this) {
return function(model) {
...
this.challenges.setPage(this.page), this.challenges.cached(), this.listenTo(this.challenges, "reset", this.render)), 
!0) :void 0;
