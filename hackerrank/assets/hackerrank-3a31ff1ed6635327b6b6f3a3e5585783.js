...
}, throttled_update_notifs = _.throttle(update_notifs, 14950), update_notifs(), 
this.notifications = function(_this) {
return function(throttled) {
var notifications_url;
return null == throttled && (throttled = !1), HR.development ? void 0 :(notifications_url = that.profile.get("notifications_url")) ? ("http:" === location.protocol && (notifications_url = notifications_url.replace("https:", "http:")), 
$.ajax({
url:notifications_url,
success:function(data) {
return data ? (that.log("Fetching notifications"), update_notifs(), that.notifications()) :that.throttledNotifications(throttled = !0);
},
error:function() {
