...
var path;
return path = "codemirror/mode/" + lang + "/" + lang, "html" === lang ? HR.requires("codemirror/mode/xml/xml", "codemirror/mode/css/css", "codemirror/mode/javascript/javascript", "codemirror/mode/htmlmixed/htmlmixed", function() {
return function() {
return callback();
};
}(this), function() {
...
}(this)) :(lang_mode_location_unconventional_mapping[lang] && (path = lang_mode_location_unconventional_mapping[lang]), 
HR.requires(path, function() {
return function() {
return callback();
};
}(this), function() {
