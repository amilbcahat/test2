...
var args;
return args = [], lang_mode_location_unconventional_mapping[lang] ? args.push([ lang_mode_location_unconventional_mapping[lang] ]) :args.push([ "codemirror/mode/" + lang + "/" + lang ]), 
args.push(function() {
return function() {
return callback();
};
...
options.activeCategory && (this.activeCategory = options.activeCategory), this.contest = options.contest, 
this.challenges = options.challenges, this.category_slugs = options.category_slugs, 
this.profile = HR.profile(), this.is_track_view = options.is_track_view, this.getRecommendedChallenge(), 
this.listenTo(this.profile, "reset", this.loggedIn), this.listenTo(this.profile, "reset", this.renderScore), 
this.listenTo(this.challenges, "reset", this.render), this.getRecentHackers();
...
var scores;
return scores = this.profile.get("scores"), _.isObject(scores) && _.isObject(scores[this.activeCategory]) ? ($(".js-hacker-rank").html(scores[this.activeCategory].contest.rank), 
$(".js-hacker-score").html(parseInt(scores[this.activeCategory].contest.score)), 
$(".js-hacker-rating").removeClass("rg_1 rg_2 rg_3 rg_4 rg_5"), $(".js-hacker-rating").html(HR.util.ratingLevelToTitle(scores[this.activeCategory].contest.level)).addClass("rg_" + scores[this.activeCategory].contest.level)) :void 0;
...
this.trigger("render"), this.renderOnboarding(), this.renderScore(), this;
}, ChallengesView;
