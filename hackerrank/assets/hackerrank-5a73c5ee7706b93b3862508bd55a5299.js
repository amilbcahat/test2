...
var acceptedEvents, defaultOptions, event, menu1, prev, that, _i, _len, _ref;
...
}, options = _.extend(defaultOptions, options), menu1 = {
id:"menu1",
title:"Hello World",
contents:[ {
name:"Item 1"
...
}, that = this, HR.requires("compound/highcharts", function(_this) {
return function() {
