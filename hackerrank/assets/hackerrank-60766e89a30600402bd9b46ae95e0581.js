...
}, html = "" + event.contest_name + '<br/>Rating: <span style="color:' + colors[event.level] + '">' + level_in_words[event.level] + "</span><br/>Score: " + event.rating + "<br/>Contest Rank: " + event.contest_rank + "<br/>" + date_string(event.date);
}
}
