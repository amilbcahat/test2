...
null == view_loader && (view_loader = !0), logical_template_path = this.logicalTemplatePath(template_name), 
...
_i = 0, _len = _ref.length; _len > _i; _i++) each_inline_template = _ref[_i], HR.templates = HR.templates || {}, 
...
logical_template_path = this.logicalTemplatePath(template_name), null === obj && (obj = this), 
obj && obj.cid) {
...
_i = 0, _len = _ref.length; _len > _i; _i++) each_inline_template = _ref[_i], HR.templates = HR.templates || {}, 
_ltp = this.logicalTemplatePath($(each_inline_template).attr("id")), HR.templates[_ltp] || (HR.templates[_ltp] = _.template($(each_inline_template).html()));
