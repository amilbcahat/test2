...
return value = parseInt($("#track-selector").val()), lastYear = new Date(), now = new Date(), 
...
rating:rating,
data:this.data
})), $("#track-selector").select2(), this.renderChart(this.data.models[0]), this.renderScore(tracks[0].text);
}
return this;
}, RatingHistoryView;
