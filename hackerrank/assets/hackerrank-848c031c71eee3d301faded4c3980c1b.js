...
null == page && (page = null), null == filterString && (filterString = null), args = null === challenge_slug ? this.parseLeaderboardArgs(arguments, 3) :this.parseLeaderboardArgs(arguments, 2), 
options = {
slug:args[1],
contest_slug:args[0]
}, model = HR.model("challenge", options).cached(), HR.requires("compound/challenge-views", function() {
