...
challenges.cached(), null !== category_slugs && category_slugs.length > 1 && (activeCategory = category_slugs[0]), 
...
$.cookie("hr_categories-" + contest_slug, _.compact(category_slugs)), this.challengesList(page, null, contest_slug, !1, category_slugs, filter, sort_by, sort_dir);
...
var that;
return null == options && (options = {}), this.rendered = !1, that = this, this.scoreFetched = !1, 
this.fetchScore(), this.listenTo(this.model, "reset", this.render), this.listenTo(this.model, "change", this.render), 
$.ajax({
async:!1,
...
var score;
if (this.scoreFetched) return _.isObject(this.scores) && _.filter(this.scores, function(x) {
return x.name === track_val;
}).length > 0 ? (score = _.filter(this.scores, function(x) {
return x.name === track_val;
})[0], score.contest.score ? this.$("#hacker-contest-rating").html(parseInt(score.contest.score)) :this.$("#hacker-contest-rating").html("N/A"), 
...
this.$("#hacker-title").removeClass("color-green color-blue color-orange color-purple color-navy"), 
this.$("#hacker-title").addClass(this.color(score.contest.level))) :this.$("#hacker-title").html("N/A")) :(this.$("#hacker-rating").html("N/A"), 
this.$("#hacker-rank").html("N/A"), this.$("#hacker-title").html("N/A"));
}, RatingHistoryView.prototype.color = function(level) {
return 1 === level ? "color-green" :2 === level ? "color-blue" :3 === level ? "color-orange" :4 === level ? "color-purple" :"color-navy";
}, RatingHistoryView.prototype.fetchScore = function() {
var that;
return that = this, $.ajax({
url:"/rest/hackers/" + this.model.get("username") + "/scores",
success:function(data) {
return that.scores = data, that.scoreFetched = !0, that.render();
}
});
