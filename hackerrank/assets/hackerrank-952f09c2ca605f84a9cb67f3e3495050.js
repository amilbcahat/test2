...
var background_image, button, challengesContainer, challenges_div, contest_button, contest_time, endtime_sting, enter_button, message, signup_button, starttime_sting, tabsContainer, timeanddateurl;
...
starttime_sting = HR.util.formatDateTime(HR.util.getDateFromEpoch(this.contest.get("epoch_starttime"))), 
endtime_sting = HR.util.formatDateTime(HR.util.getDateFromEpoch(this.contest.get("epoch_endtime"))), 
contest_time = "<p class='mjT'>Starts: " + starttime_sting + "</p><p class='mmT msB'>Ends: " + endtime_sting + "</p>", 
timeanddateurl = HR.util.timeanddateurl("[HackerRank] " + this.contest.get("name"), this.contest.get("epoch_starttime")), 
...
challenges_div.html('<div>\n  <div class="contests_pane">\n      <h3 class="alpha contests_pane-title">' + this.contest.get("name") + "</h3>\n      <p>" + this.contest.get("description") + "</p>\n      " + contest_time + '\n      <a class="btn btn-small msB" href=\'' + timeanddateurl + '\'>Add to Calendar<i class="icon--single icon-calendar psL"></i></a>\n      ' + message + "\n      " + button + "\n  </div>\n</div>"))), 
...
var background_image, button, challengesContainer, challenges_div, collection, contest_button, contest_time, endtime_sting, enter_button, message, signup_button, starttime_sting, timeanddateurl;
...
contest_time = "<p class='mjT'>Starts: " + starttime_sting + "</p><p class='mmT msB'>Ends: " + endtime_sting + "</p>", 
timeanddateurl = HR.util.timeanddateurl("[HackerRank] " + this.contest.get("name"), this.contest.get("epoch_starttime")), 
console.log(timeanddateurl), !this.contest.get("started") && this.contest.get("signed_up") ? (message = "<p class='aside contests_pane-message'>You have registered for the contest.</p>", 
button = contest_button) :this.contest.get("started") && !this.contest.get("signed_up") ? (message = "<p class='aside contests_pane-message'>You have not registered for the contest. The contest is in progress. Please register to start solving challenges.</p>", 
button = signup_button) :this.contest.get("started") || this.contest.get("signed_up") ? this.contest.get("started") && this.contest.get("signed_up") && (message = "<p class='aside contests_pane-message'>Contest has started.</p>", 
button = enter_button) :(message = "<p class='aside contests_pane-message'>You have not registered for the contest. Please register to participate.</p>", 
button = signup_button), background_image = this.contest.get("homepage_background_image") || "/assets/hackergames/hacker-games-mountains.jpg", 
