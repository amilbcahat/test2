...
"contests/:contest_slug":"redirectToChallenges",
...
}, DashboardRouter.prototype.redirectToChallenges = function(contest_slug) {
return console.log("Here"), this.navigate("/contests/" + contest_slug + "/challenges", {
trigger:!0,
replace:!0
});
...
return this.template || (this.template = $(_.template("<a target='_new' href='http://www.hackerrank.com/' class='HackerRankLogo page_header-logo'><svg width='42' height='46'><image xlink:href='/assets/brand/h_mark_sm.svg' src='/assets/brand/h_mark_sm.png' width='42' height='46' /> </svg></a>")())), 
