...
var that;
return null == options && (options = {}), this.rendered = !1, this.profile = HR.profile(), 
this.profile.fetchScores(), that = this, this.listenTo(this.model, "reset", this.render), 
this.listenTo(this.model, "change", this.render), this.listenTo(this.profile, "reset", this.render), 
this.listenTo(this.profile, "change", this.render), $.ajax({
async:!1,
...
var score;
return _.isObject(this.profile.get("scores")) && _.isObject(this.profile.get("scores")[track_val]) ? (score = this.profile.get("scores")[track_val], 
