...
var body, data, footer, header, score, that, view;
return HR.onboarding_tutorial_challenge_stats ? (data = HR.onboarding_tutorial_challenge_stats, 
score = (data.score * data.weight).round(2), header = "<h2 class='color-green mlB'>Congratulations, Elou!</h2>", 
footer = "<div class='faux-leaderboard'> <img src='/assets/onboarding/faux_leaderboard.jpg'> <p class='btn-wrap'><a href='" + data.leaderboard + "' class='btn btn-primary' target='_blank'>See your standing here</a> </div> <p class='plT plB'><a href='' class='js-next'>Almost done! Final step<i class='icon--right icon-right-open'></i></a></p>", 
