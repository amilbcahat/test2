...
}(this)), challenges_div = this.$("div.challenges-list"), this.contest ? this.contest.get("archived") || this.contest.get("started") && this.contest.get("signed_up") ? this.challenges && (this.challenges.sync_status || this.challenges.length > 0) ? (challengesContainer = $(), 
...
var dialog;
return e.preventDefault(), console.log($(e.currentTarget).attr("data-username")), 
...
var that;
return that = this, that.recommended_challenge = {}, $.ajax({
url:"/rest/challenges/recommended?tag=" + this.activeCategory,
success:function(data) {
return that.recommended_challenge = data, that.render();
}
});
}, ChallengesView.prototype.render = function() {
var challengesContainer, listView, select2filters, tags, url;
if (this.contest.sync_status === !0) return this.filter ? (tags = this.filter.split("+"), 
