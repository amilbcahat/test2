...
jQuery(function() {
var ConversationModel, HR;
return ConversationModel = function(_super) {
function ConversationModel() {
return ConversationModel.__super__.constructor.apply(this, arguments);
}
return __extends(ConversationModel, _super), ConversationModel;
}(window.HR.GenericModel), HR = window.HR, HR.ConversationModel = ConversationModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var ConversationsCollection, HR, _ref;
return ConversationsCollection = function(_super) {
function ConversationsCollection() {
return ConversationsCollection.__super__.constructor.apply(this, arguments);
}
return __extends(ConversationsCollection, _super), ConversationsCollection.prototype.model = window.HR.ConversationModel, 
ConversationsCollection.prototype.url = function() {
return "" + HR.util.getWordpressBaseUrl() + "/?json=get_category_posts&slug=guest-post&post_status=publish&page=" + this.page;
}, ConversationsCollection.prototype.getTotal = function() {
return this.total;
}, ConversationsCollection.prototype.setPage = function(page) {
this.page = page;
}, ConversationsCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.ConversationsCollection = ConversationsCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
}, DashboardRouter.prototype.writeblog = function(id) {
return null == id && (id = 0), HR.requires([ "compound/extra-views" ], function() {
var blog_view;
...
}, DashboardRouter.prototype.conversations = function(page) {
var collection, view;
return null == page && (page = 1), HR.util.setTab("conversation"), HR.appController.setTitle("Conversations"), 
collection = HR.collection("conversations"), collection.setPage(page), collection.cached(), 
view = new HR.TrackDashboardView({
activeTab:"conversation",
page:page,
conversations:collection
}), HR.appView.setContentView(view), window.mixpanel_data.landing = !1;
}, DashboardRouter;
...
jQuery(function() {
var ConversationsListView, HR, _ref;
return ConversationsListView = function(_super) {
function ConversationsListView() {
return ConversationsListView.__super__.constructor.apply(this, arguments);
}
return __extends(ConversationsListView, _super), ConversationsListView.prototype.template = "dashboard/conversationslist", 
ConversationsListView.prototype.className = "conversations-list", ConversationsListView.prototype.initialize = function(options) {
return this.page = options.page, this.conversations = options.conversations, this.listenTo(this.conversations, "reset", this.render);
}, ConversationsListView.prototype.render = function() {
var that;
return this.conversations.sync_status ? ($(this.el).html(HR.appController.template(this.template, this)({
posts:this.conversations.models
})), HR.util.pagination(this.$(".pagination-wrapper"), this.conversations.getTotal(), "/conversations/", this.page)) :$(this.el).html(HR.appController.viewLoader(64)), 
that = this;
}, ConversationsListView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.ConversationsListView = ConversationsListView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var ConversationsView, HR, _ref;
return ConversationsView = function(_super) {
function ConversationsView() {
return ConversationsView.__super__.constructor.apply(this, arguments);
}
return __extends(ConversationsView, _super), ConversationsView.prototype.template = "dashboard/conversations", 
ConversationsView.prototype.className = "conversations", ConversationsView.prototype.initialize = function(options) {
return this.profile = HR.profile(), this.page = options.page, this.conversations = options.conversations, 
this.conversationsList = new HR.ConversationsListView({
page:options.page,
conversations:options.conversations
});
}, ConversationsView.prototype.render = function() {
return $(this.el).html(HR.appController.template(this.template, this)({
hacker:this.profile.toJSON()
})), this.renderSubviews(), this.renderPendingForReview(), this.renderDrafts();
}, ConversationsView.prototype.renderPendingForReview = function() {
return $.ajax({
url:HR.util.getWordpressBaseUrl() + "/",
type:"GET",
data:{
json:"get_author_posts",
slug:this.profile.get("username"),
post_status:"guest-pending"
},
success:function() {
return function(resp) {
var html;
return resp.error || 0 === resp.models.length ? $(".pending-review").html("<li class='lg-block_head'>No post pending for review</li>") :(html = "", 
$.each(resp.models, function(index, post) {
return html += "<li class='lg-block_head'><a href='" + post.url + "' target='_blank' >" + post.title + "</a></li>";
}), $(".pending-review").html(html));
};
}(this)
});
}, ConversationsView.prototype.renderDrafts = function() {
return $.ajax({
url:HR.util.getWordpressBaseUrl() + "/",
type:"GET",
data:{
json:"get_author_posts",
slug:this.profile.get("username"),
post_status:"guest-draft"
},
success:function() {
return function(resp) {
var html;
return resp.error || 0 === resp.models.length ? $(".guest-draft").html("<li class='lg-block_head'>No Drafts.</li>") :(html = "", 
$.each(resp.models, function(index, post) {
return html += "<li class='lg-block_head'><a href='/blog/edit/" + post.id + "' class='backbone'>" + post.title + "</a></li>";
}), $(".guest-draft").html(html));
};
}(this)
});
}, ConversationsView.prototype.renderSubviews = function() {
var that;
return that = this, this.conversationsList.setElement(this.$(".conversation-list")).render();
}, ConversationsView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.ConversationsView = ConversationsView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return null == options && (options = {}), this.current_track_slug = options.current_track_slug || "algorithms", 
...
parent:this
})), this.bodyView = "challenge" === this.activeTab ? new HR.ChallengesView(options) :"conversation" === this.activeTab ? new HR.ConversationsView(options) :new HR.TrackContestsView(options);
