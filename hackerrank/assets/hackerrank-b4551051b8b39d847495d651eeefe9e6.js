...
async:!1
}), contest.get("has_tracks") && null === category_slugs ? (this.categoriesRedirect(contest_slug), 
...
return category_slugs = $.cookie("hr_categories-" + contest_slug) || model.categories().first().get("slug"), 
