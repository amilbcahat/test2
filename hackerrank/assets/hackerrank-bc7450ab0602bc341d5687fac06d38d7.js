...
var current_hacker;
return this.challenge ? this.challenge.get("public_solutions") ? 1 !== this.contest.get("id") ? this.contest.get("ended") || "weekly" === this.contest.get("kind") && this.challenge.get("has_ended") ? !0 :!1 :(current_hacker = this.collection.current_hacker, 
