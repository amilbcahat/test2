...
return null == options && (options = {}), this.limit = $.cookie("pagination_per_page_limit") || 10, 
this.trackSlug = options.trackSlug || "algorithms", this.page = 1, this.type = options.type || "contest", 
...
TrackLeaderboardCollection.prototype.showLoader = !1, TrackLeaderboardCollection.prototype.url = function() {
return "practice" === this.type ? "rest/contests/master/tracks/" + this.trackSlug + "/leaderboard/" + this.type :void 0;
...
"leaderboard/track/:track/type/:type":"trackLeaderboard",
...
}, DashboardRouter.prototype.trackLeaderboard = function(trackSlug, type, page) {
return null == trackSlug && (trackSlug = "algorithms"), null == type && (type = "contest"), 
null == page && (page = 1), HR.requires("compound/extra-views", function() {
var collection, view;
return collection = HR.collection("leaderboard"), collection.setPage(page), collection.setTrack(trackSlug), 
collection.cached(), view = new HR.TrackLeaderboardView({
collection:collection
}), HR.util.setTab("leaderboard"), HR.appController.setTitle("Leaderboard"), HR.appView.setContentView(view);
});
