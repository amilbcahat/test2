...
return CommonController = function(_super) {
function CommonController() {
return CommonController.__super__.constructor.apply(this, arguments);
}
return __extends(CommonController, _super), CommonController.prototype.log = Backbone.log, 
...
return HR.templates[logical_path] = template, number_paths = arguments.length - 1, 
callback = _.last(arguments), errorCallback = null, "function" == typeof arguments[arguments.length - 2] && (number_paths = arguments.length - 2, 
callback = arguments[arguments.length - 2], errorCallback = _.last(arguments)), 
preCallbacks = [], postCallbacks = [];
...
return null == options && (options = {}), preCallbacks = [], postCallbacks = [], 
staticFiles = _.map(deps, function() {
return function(path) {
var inject_mathjax_config;
return "MathJax/MathJax" === path ? (0 === $("#mathjax-config").length && (inject_mathjax_config = "<script id=\"mathjax-config\" type=\"text/x-mathjax-config\">\n  MathJax.Hub.Config({\n    tex2jax: {\n        inlineMath: [['$','$']],\n        processEscapes: true\n      }\n  });\n</script>", 
$("html").append(inject_mathjax_config)), postCallbacks.push(function() {
return "undefined" != typeof MathJax ? MathJax.Hub.Queue([ "Typeset", MathJax.Hub ]) :void 0;
}), "https://hrcdn.net/MathJax/MathJax.js?config=TeX-AMS-MML_HTMLorMML") :options.ignore_prefix ? "/" + path + ".js" :HR.appController.staticPath("" + path + ".js");
};
}(this)), _success_callback = function() {
return _.each(preCallbacks, function(callback) {
return callback();
}), success_callback(), _.each(postCallbacks, function(callback) {
return callback();
});
}, _error_callback = function(error) {
return _errs.push(error), _.isFunction(error_callback) ? error_callback(error) :void 0;
}, require(staticFiles, _success_callback, _error_callback);
}, CommonController.prototype.loadCodeMirror = function(success_callback, error_callback) {
return null == error_callback && (error_callback = function() {}), HR.requires([ "codemirror_basic" ], function() {
return function() {
...
var args, mode_s;
return args = [], lang_mode_location_unconventional_mapping[lang] ? (mode_s = lang_mode_location_unconventional_mapping[lang], 
_.isArray(mode_s) || (mode_s = [ mode_s ]), args.push(mode_s)) :args.push([ "codemirror/mode/" + lang + "/" + lang ]), 
args.push(function() {
return function() {
return callback();
};
...
}(this)), HR.development && args.push({
ignore_prefix:!0
}), HR.requires.apply(this, args);
});
}, CommonController;
}(Backbone.Model), HR = null != (_ref = window.HR) ? _ref :{}, HR.CommonController = CommonController;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
HR.appView.countdownTimerView && HR.appView.countdownTimerView.setContest(HR.contest().cached())), 
HR.contest().unSetContestBroadcast(), HR.contest().setContestBroadcast();
...
var that;
return that = this, _.each(arguments, function(argument) {
...
"Template `" + that.templatePath("" + template_name + ".js") + "` Not Found";
},
...
}(window.HR.CommonController), HR = null != (_ref = window.HR) ? _ref :{}, HR.AppController = AppController;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return BroadcastModel = function(_super) {
function BroadcastModel() {
return BroadcastModel.__super__.constructor.apply(this, arguments);
}
return __extends(BroadcastModel, _super), BroadcastModel.prototype.restURL = function() {
var path;
return path = _.isNumber(this.id) ? "rest/administration/broadcasts/" + this.id :"rest/administration/broadcasts/";
}, BroadcastModel;
}(window.HR.GenericModel), HR = window.HR, HR.BroadcastModel = BroadcastModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
}, ChallengeModel.prototype.showLoader = !1, ChallengeModel.prototype.custom_messages = {
...
}, ChallengeModel.prototype.onTimer = function() {
var time_left;
...
return __extends(ContestModel, _super), ContestModel.prototype.custom_messages = {}, 
...
return this.get("contest_message") ? ($("#contestwide-broadcast").html(this.get("contest_message")), 
$("#contestwide-broadcast").addClass("banner")) :void 0;
}, ContestModel.prototype.unSetContestBroadcast = function() {
return $("#contestwide-broadcast").html(""), $("#contestwide-broadcast").removeClass("banner");
}, ContestModel;
...
return EditorialModel = function(_super) {
function EditorialModel() {
return EditorialModel.__super__.constructor.apply(this, arguments);
}
return __extends(EditorialModel, _super), EditorialModel.prototype.baseURL = function() {
return "challenges/" + this.get("challenge_slug") + "/editorial";
}, EditorialModel;
}(window.HR.GenericModel), HR = window.HR, HR.EditorialModel = EditorialModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return HackerHackosModel = function(_super) {
function HackerHackosModel() {
return HackerHackosModel.__super__.constructor.apply(this, arguments);
}
return __extends(HackerHackosModel, _super), HackerHackosModel.prototype.showLoader = !0, 
HackerHackosModel;
}(window.HR.GenericModel), HR = window.HR || {}, HR.HackerHackosModel = HackerHackosModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
var that;
return that = this, that.set("scores", {}), $.ajax({
url:"/rest/hackers/" + this.get("username") + "/scores",
success:function(data) {
var obj;
return obj = {}, _.each(data, function(x) {
return obj[x.name] = x, obj[x.slug] = x;
}), that.set("scores", obj), that.trigger("reset");
}
});
}, HackerProfileModel;
...
return MailTemplateModel = function(_super) {
function MailTemplateModel() {
return MailTemplateModel.__super__.constructor.apply(this, arguments);
}
return __extends(MailTemplateModel, _super), MailTemplateModel.prototype.initialize = function(options) {
return this.sample = options.sample, this.contest_id = options.contest_id, this.hacker_id = options.hacker_id;
}, MailTemplateModel.prototype.queryParams = function() {
var queryString;
return queryString = "", _.isNumber(this.contest_id) && this.contest_id >= 1 && (queryString += "contest_id=" + this.contest_id, 
_.isNumber(this.hacker_id) && this.hacker_id >= 1 && (queryString += "&")), _.isNumber(this.hacker_id) && this.hacker_id >= 1 && (queryString += "hacker_id=" + this.hacker_id), 
queryString;
}, MailTemplateModel.prototype.restURL = function() {
var path;
return path = this.id ? "rest/administration/mails/templates/" + this.id :"rest/administration/mails/templates/1", 
this.sample === !0 ? path += "/sample" :void 0;
}, MailTemplateModel;
}(window.HR.GenericModel), HR = null != (_ref = window.HR) ? _ref :{}, HR.MailTemplateModel = MailTemplateModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
var that;
if (this.isLoggedIn()) return that = this, that.set("scores", {}), $.ajax({
url:"/rest/hackers/" + this.get("username") + "/scores",
success:function(data) {
var obj;
return obj = {}, _.each(data, function(x) {
...
$panel = $("#submission-success-messages").find("#submission-model-" + resp.id)), 
HR.SubmissionSuccessView && (this.submission_success_view || (this.submission_success_view = new HR.SubmissionSuccessView({
model:resp
...
return this.get("status_code") ? this.get("score_processed") ? 0 === this.get("status_code") || 3 === this.get("status_code") ? !1 :0 === this.get("score_processed") || 2 === this.get("score_processed") ? !1 :!0 :!1 :!1;
...
return BroadcastCollection = function(_super) {
function BroadcastCollection() {
return BroadcastCollection.__super__.constructor.apply(this, arguments);
}
return __extends(BroadcastCollection, _super), BroadcastCollection.prototype.model = window.HR.BroadcastModel, 
BroadcastCollection.prototype.initialize = function(options) {
return this.contest_id = options.contest_id, this.category = options.category;
...
var count;
return this.query = "", count = 0, this.contest_id && _.isNumber(this.contest_id) && (this.query = "" + this.query + "contest_id=" + this.contest_id, 
count++), this.category && (count > 0 && (this.query = "" + this.query + "&"), this.query = "" + this.query + "category=" + this.category), 
this.query;
...
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.BroadcastCollection = BroadcastCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
ChallengesCollection.prototype.metaKeys = [ "current_track", "total" ], ChallengesCollection.prototype.parse = function(resp, xhr) {
...
this.key = options.key, this.track_slug = options.track_slug, this.contest_slug = options.contest_slug;
...
this.track_slug && (query += "&track_slug=" + this.track_slug), query;
...
return GenericLeaderboardCollection = function(_super) {
function GenericLeaderboardCollection() {
return GenericLeaderboardCollection.__super__.constructor.apply(this, arguments);
}
return __extends(GenericLeaderboardCollection, _super), GenericLeaderboardCollection.prototype.model = window.HR.LeaderboardModel, 
GenericLeaderboardCollection.prototype.initialize = function(options) {
return this.limit = $.cookie("pagination_per_page_limit") || 10, GenericLeaderboardCollection.__super__.initialize.call(this, options);
}, GenericLeaderboardCollection.prototype.validFilters = [ "school", "company", "country", "language" ], 
GenericLeaderboardCollection.prototype.showLoader = !1, GenericLeaderboardCollection.prototype.applicableFilters = function() {
...
}, GenericLeaderboardCollection.prototype.filters = {}, GenericLeaderboardCollection.prototype.queryParams = function() {
var query;
return query = GenericLeaderboardCollection.__super__.queryParams.call(this), this.filtered() && this.hasFilters() && (query += "&" + this.getFilterString() + "&filter_kinds=" + this.filterKinds()), 
query;
...
}, GenericLeaderboardCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.GenericLeaderboardCollection = GenericLeaderboardCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return HackerHackosCollection = function(_super) {
function HackerHackosCollection() {
return HackerHackosCollection.__super__.constructor.apply(this, arguments);
}
return __extends(HackerHackosCollection, _super), HackerHackosCollection.prototype.model = window.HR.HackerHackosModel, 
HackerHackosCollection.prototype.initialize = function(options) {
return this.id = options.id, this.offset = 0, options.page ? (this.offset = this.limit * (options.page - 1), 
this.page = options.page) :void 0;
...
}, HackerHackosCollection.prototype.limit = 10, HackerHackosCollection.prototype.cacheTimeout = 10, 
HackerHackosCollection.prototype.showLoader = !0, HackerHackosCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.HackerHackosCollection = HackerHackosCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
this.offset = null != offset ? offset :0;
...
return TrackLeaderboardCollection = function(_super) {
function TrackLeaderboardCollection() {
return TrackLeaderboardCollection.__super__.constructor.apply(this, arguments);
}
return __extends(TrackLeaderboardCollection, _super), TrackLeaderboardCollection.prototype.model = window.HR.LeaderboardModel, 
TrackLeaderboardCollection.prototype.initialize = function(options) {
return null == options && (options = {}), this.limit = 10, this.track = options.track || "algorithms", 
this.page = options.page || 1, this.type = options.type || "contest", this.level = options.level || 1, 
this.filters = options.filters || {}, TrackLeaderboardCollection.__super__.initialize.call(this, options);
}, TrackLeaderboardCollection.prototype.showLoader = !1, TrackLeaderboardCollection.prototype.metaKeys = [ "current_hacker", "total", "available", "filters" ], 
...
this.total = resp.total, TrackLeaderboardCollection.__super__.parse.call(this, resp, xhr);
}, TrackLeaderboardCollection.prototype.queryParams = function() {
var query;
return query = TrackLeaderboardCollection.__super__.queryParams.call(this), _.each(this.filters, function(key, val) {
return query += "&" + val + "=" + key;
}), "" + query + "&type=" + this.type + "&level=" + this.level;
}, TrackLeaderboardCollection.prototype.setFiltersFromString = function(string) {
var subStrings, that;
return that = this, subStrings = string.split("&"), this.filters = {}, _.each(subStrings, function(str) {
var split;
return split = str.split("="), split.length > 1 ? that.filters[split[0]] = split[1] :void 0;
}), this.filters;
}, TrackLeaderboardCollection.prototype.getFilterString = function() {
var subStrings;
return subStrings = [], _.each(this.filters, function(value, filter) {
return subStrings.push("" + filter + "=" + value);
}), subStrings.join("&");
}, TrackLeaderboardCollection.prototype.restURL = function() {
var url;
return url = "rest/contests/master/tracks/" + this.track + "/leaderboard", $.isEmptyObject(this.filters) ? "" + url :"" + url + "/filter";
}, TrackLeaderboardCollection.prototype.pageURL = function() {
var url;
return url = "/leaderboard/" + this.track + "/" + this.type + "/level/" + this.level, 
$.isEmptyObject(this.filters) ? "" + url + "/page" :"" + url + "/filter/" + this.getFilterString() + "/page";
...
return this.total;
}, TrackLeaderboardCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.TrackLeaderboardCollection = TrackLeaderboardCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return __extends(LeaderboardCollection, _super), LeaderboardCollection.prototype.initialize = function(options) {
var profile;
...
LeaderboardCollection.prototype.showLoader = !1, LeaderboardCollection.prototype.namespace = "", 
...
this.filtered() && this.hasFilters() && (url += "/filter"), query = this.queryParams(), 
this.archived && (query += "&archived=true"), this.includePractice && (query += "&include_practice=true"), 
this.level && (query += "&level=" + this.level), "" + url + "?" + query;
...
var that;
return that = this, this.current_hacker = resp.current_hacker, this.available = resp.available, 
this.contest_challenges = resp.contest_challenges, this.weekly_contest = resp.weekly_contest, 
LeaderboardCollection.__super__.parse.call(this, resp, xhr);
...
this.track && (url = url.replace("/tags/", "/tracks/")), this.level ? "/leaderboard/level/" + this.level + "/page" :this.filtered() ? "" + url + "/filter/" + this.getFilterString() :"" + url;
...
}(window.HR.GenericLeaderboardCollection), HR = null != (_ref = window.HR) ? _ref :{}, 
HR.LeaderboardCollection = LeaderboardCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
var fragment, title;
return that.log(arguments), mixpanel.push([ "track", "Navigation", {
username:HR.profile().get("username"),
url:window.location.pathname
} ]), HR.util.scrollToTop(), title = $("title").html(), fragment = document.location.pathname, 
...
return HR.requires([ "compound/extra-views" ], function() {
var blog_view;
return HR.appController.setTitle("Write Blog"), blog_view = new HR.WriteblogView(), 
HR.appView.setContentView(blog_view);
});
}, DashboardRouter.prototype.redirectBlog = function(path) {
return window.location = path ? "http://blog.hackerrank.com/" + path :"http://blog.hackerrank.com/";
...
return null == contest_slug && (contest_slug = null), collection = new HR.ContestsCollection({
key:"active",
track_slug:track_slug,
contest_slug:contest_slug
}), contest = null, contest_slug && "archived" !== contest_slug && (contest = new HR.ContestModel({
slug:contest_slug
}).cached()), view = new HR.TrackDashboardView({
collection:collection.cached(),
contest:contest,
contest_slug:contest_slug,
activeTab:"contest",
current_track_slug:track_slug
}), HR.appView.setContentView(view), HR.util.setTab("contests"), HR.appController.setTitle("Contests"), 
...
async:!1
}), HR.appController.set_contest_namespace(contest.get("slug")), contest.get("has_tracks") && null === category_slugs ? (this.categoriesRedirect(contest_slug), 
void 0) :(challenges = HR.collection("challenges"), challenges._filter = filter, 
filter && challenges.setFilters(filter.split("+")), challenges.setSortBy(sort_by), 
challenges.setSortDir(sort_dir), challenges.setContest(contest_slug), challenges.setPage(page), 
challenges.setCategories(category_slugs), challenges.setLoginTracking(!0), challenges.limit = contest.get("challenges_per_page"), 
challenges.cached(), null !== category_slugs && category_slugs.length > 1 && (current_track_slug = category_slugs[0]), 
null !== category_slugs && category_slugs.length > 1 && (current_chapter_slug = category_slugs[1]), 
viewClass = null, viewClass = "master" === contest_slug ? HR.TrackDashboardView :HR.ChallengesView, 
...
return null == contest_slug && (contest_slug = null), null == category && (category = null), 
null == track && (track = null), null == filter && (filter = null), null == sort_by && (sort_by = null), 
null == sort_dir && (sort_dir = null), null == page && (page = null), fragment = Backbone.history.fragment, 
fragments = fragment.split("categories"), "" === fragments[0] && (page = sort_dir, 
sort_dir = sort_by, sort_by = filter, filter = track, track = category, category = contest_slug, 
contest_slug = "master"), page || (page = 1), this.categoryChallengesList(contest_slug, category, track, page, filter, sort_by, sort_dir);
...
return null == contest_slug && (contest_slug = null), null == category && (category = null), 
null == track && (track = null), null == page && (page = null), null == filter && (filter = null), 
null == sort_by && (sort_by = null), null == sort_dir && (sort_dir = null), fragment = Backbone.history.fragment, 
fragments = fragment.split("categories"), "" === fragments[0] && (sort_dir = sort_by, 
sort_by = filter, filter = page, page = track, track = category, category = contest_slug, 
contest_slug = "master"), page || (page = 1), category_slugs = [ category, track ], 
$.cookie("hr_categories-" + contest_slug, _.compact(category_slugs), {
path:"/"
}), this.challengesList(page, null, contest_slug, !1, category_slugs, filter, sort_by, sort_dir);
...
return null == contest_slug && (contest_slug = null), null == category && (category = null), 
console.log("Hey"), category || (category = contest_slug, contest_slug = "master"), 
_contest = new HR.ContestModel({
slug:contest_slug
}), contest = _contest.cached(), category_slugs = [ category ], categories = contest.currentCategories(category_slugs, autoFillMissing = !0), 
this.navigate(categories.last().pageURL(), {
trigger:!0,
replace:!0
});
}, DashboardRouter.prototype.categoriesRedirect = function(contest_slug) {
var contest, that;
return null == contest_slug && (contest_slug = null), contest_slug || (contest_slug = "master"), 
that = this, contest = new HR.ContestModel({
slug:contest_slug
}), contest.cached({
success:function(model) {
var categories, category_slugs;
return HR.appController.set_contest_namespace(model.get("slug")), category_slugs = $.cookie("hr_categories-" + contest_slug) || model.categories().first().get("slug"), 
category_slugs && (category_slugs = category_slugs.split(",")), categories = model.currentCategories(category_slugs), 
HR.router.navigate(categories.last().pageURL(), {
trigger:!0,
replace:!0
});
}
...
})), HR.util.setTab("editorial"), options = {
challenge_slug:challenge_slug
}, options_challenge = {
slug:challenge_slug,
contest_slug:contest_slug
}, editorial = HR.model("editorial", options).cached(), challenge = HR.model("challenge", options_challenge).cached(), 
hacker = HR.profile(), HR.requires([ "compound/extra-views" ], function() {
var singlepost_view;
...
return null == level && (level = 1), null == page && (page = 1), HR.requires([ "compound/extra-views" ], function() {
var collection, view;
return collection = HR.collection("leaderboard"), collection.setPage(page), collection.setContestSlug("master"), 
collection.setLevel(level), collection.cached(), view = new HR.OverallLeaderboardView({
collection:collection,
level:level
}), HR.util.setTab("leaderboard"), HR.appController.setTitle("Leaderboard"), HR.appView.setContentView(view);
});
}, DashboardRouter.prototype.trackLeaderboard = function(track, type, level, page, filterString) {
return null == track && (track = "algorithms"), null == type && (type = "contest"), 
null == level && (level = 1), null == page && (page = 1), null == filterString && (filterString = ""), 
HR.requires([ "compound/extra-views" ], function() {
var collection, view;
return collection = HR.collection("track-leaderboard"), collection.setPage(page), 
collection.setLevel(level), collection.setTrack(track), collection.setType(type), 
filterString.length > 0 && collection.setFiltersFromString(filterString), collection.cached(), 
...
return null == track && (track = "algorithms"), null == type && (type = "contest"), 
null == level && (level = 1), null == filterString && (filterString = ""), null == page && (page = 1), 
this.trackLeaderboard(track, type, level, page, filterString);
}, DashboardRouter.prototype.overallLeaderboardRedirect = function(page) {
return null == page && (page = 1), HR.router.navigate("/leaderboard/level/1/page/" + page, !0);
...
var model;
if (null !== id) return model = HR.model("game", {
id:id
}).cached(), HR.requires([ "compound/gamedetail-view" ], function() {
var gameDetail_view;
return gameDetail_view = new HR.GameDetailView({
id:id,
model:model
}), HR.appView.setContentView(gameDetail_view), HR.appController.setTitle("Game details");
});
...
var _view;
return _view = new HR.HackerApplicationProfileUpdateView({
...
return hackos_collection = HR.collection("hackerhackos", {
id:hacker_slug,
page:page
}).cached(), hacker = HR.model("hacker-profile", {
username:hacker_slug
}).cached(), HR.requires([ "compound/hacker-hackos" ], function() {
var hacker_hackos_view;
return hacker_hackos_view = new HR.HackerHackosView({
collection:hackos_collection,
hacker:hacker,
page:page
}), HR.appController.setTitle("Hacker Hackos Transactions"), HR.appView.setContentView(hacker_hackos_view);
});
...
}, DashboardRouter.prototype.onboarding = function(page) {
var challenge_map, view;
if (null == page && (page = 1), HR.profile().isLoggedIn()) {
if ("1" === page) view = new HR.OnboardingTrackSelectionView(); else {
if ("2" !== page) return this.e404(), void 0;
HR.SELECTED_TRACK || (HR.SELECTED_TRACK = "algorithms"), challenge_map = {
algorithms:"solve-me-first",
shell:"bash-tutorials-lets-echo",
ai:"saveprincess",
fp:"fp-solve-me-first"
}, view = new HR.OnboardingTutorialView({
model:new HR.ChallengeModel({
slug:challenge_map[HR.SELECTED_TRACK]
}).cached()
});
}
...
return DashboardHeaderView = function(_super) {
function DashboardHeaderView() {
return DashboardHeaderView.__super__.constructor.apply(this, arguments);
}
return __extends(DashboardHeaderView, _super), DashboardHeaderView.prototype.template = "dashboard/dashboard-header", 
DashboardHeaderView.prototype.className = "dashboard-header", DashboardHeaderView.prototype.events = {
"click .js-change-track":"changeTrack"
}, DashboardHeaderView.prototype.initialize = function(options) {
return null == options && (options = {}), this.profile = HR.profile(), this.profile.fetchScores(), 
this.parent = options.parent, this.activeTab = options.activeTab, this.listenTo(this.profile, "reset", this.render);
}, DashboardHeaderView.prototype.changeTrack = function(e) {
var track_slug;
return track_slug = $(e.currentTarget).attr("data-value"), track_slug !== this.parent.current_track_slug ? this.parent.bodyView instanceof HR.TrackContestsView ? HR.router.navigate("categories/" + track_slug + "/contests", !0) :HR.router.navigate("categories/" + track_slug, !0) :void 0;
}, DashboardHeaderView.prototype.renderScore = function() {
var cat, scores;
return scores = this.profile.get("scores"), _.isObject(scores) && _.isObject(scores[this.parent.current_track_slug]) ? (cat = "contest" === this.activeTab ? "contest" :"practice", 
$(".js-hacker-rank").html(scores[this.parent.current_track_slug][cat].rank), $(".js-hacker-score").html(parseInt(scores[this.parent.current_track_slug][cat].score)), 
$(".js-hacker-rating").removeClass("rg_1 rg_2 rg_3 rg_4 rg_5"), $(".js-hacker-rating").html(HR.util.ratingLevelToTitle(scores[this.parent.current_track_slug].contest.level)).addClass("rg_" + scores[this.parent.current_track_slug].contest.level)) :void 0;
...
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.DashboardHeaderView = DashboardHeaderView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
var that;
return null == options && (options = {}), this.rendered = !1, that = this, this.model.fetchScores(), 
...
return $("#startDatePicker").datetimepicker({
pickTime:!1
}), $("#endDatePicker").datetimepicker({
pickTime:!1
}), $(".range-set").click(function() {
var endDate, startDate, value;
return startDate = Date.parse($("#startDateInput").val()), endDate = Date.parse($("#endDateInput").val()), 
value = parseInt($("#track-selector").val()), object.renderChart(object.data.models[value - 1], startDate, endDate), 
object.renderScore(object.data.models[value - 1].category);
});
}, RatingHistoryView.prototype.changeChartOverall = function() {
var value;
return value = parseInt($("#track-selector").val()), this.$(".last-year-chart").removeClass("is_active"), 
this.$(".overall-chart").addClass("is_active"), this.renderChart(this.data.models[value - 1]), 
...
return this.$(".last-year-chart").addClass("is_active"), this.$(".overall-chart").removeClass("is_active"), 
value = parseInt($("#track-selector").val()), lastYear = new Date(), now = new Date(), 
lastYear.setYear(now.getFullYear() - 1), this.renderChart(this.data.models[value - 1], lastYear), 
this.renderScore(this.data.models[value - 1].category);
}, RatingHistoryView.prototype.changeChart = function() {
var value;
return value = parseInt($("#track-selector").val()), this.renderChart(this.data.models[value - 1]), 
this.renderScore(this.data.models[value - 1].category);
...
for (null == startDate && (startDate = null), null == endDate && (endDate = null), 
null == options && (options = {}), prev = 1200, _ref = history.events, _i = 0, _len = _ref.length; _len > _i; _i++) event = _ref[_i], 
event.rating = Math.floor(event.rating), event.change = event.rating - prev, prev = event.rating;
return that = this, acceptedEvents = history.events.filter(function(event) {
var eventDate;
return eventDate = new Date(event.date), startDate && startDate > eventDate ? !1 :endDate && eventDate > endDate ? !1 :!0;
}), defaultOptions = {
chart:{
zoomType:"x",
backgroundColor:null,
...
return event = this.point.event, date = new Date(event.date), level_in_words = [ "O(1)", "O(1)", "O(log N)", "O(N)", "O(N^2)", "O(2^N)" ], 
colors = [ "#2bc56d", "#2bc56d", "#32a1de", "#f65039", "#805ec9", "#c2c7d0" ], date_string = function(date) {
var curr_date, curr_month, curr_year, d, m_names;
return d = new Date(date), m_names = new Array("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"), 
curr_date = d.getDate(), curr_month = m_names[d.getMonth()], curr_year = d.getFullYear(), 
"" + curr_date + " " + curr_month + " " + curr_year;
}, html = "" + event.contest_name + '<br/>Rating: <span style="color:' + colors[event.level] + '">' + level_in_words[event.level] + "</span><br/>Score: " + event.rating + "<br/>" + date_string(event.date);
}
}
}, options = _.extend(defaultOptions, options), that = this, HR.requires([ "compound/highcharts" ], function(_this) {
return function() {
return _this.$("#rating-graph-tab").highcharts(options), _this.$(".range-popover").clickover({
onShown:function() {
...
var score;
return _.isObject(this.model.get("scores")) && _.isObject(this.model.get("scores")[track_val]) ? (score = this.model.get("scores")[track_val], 
score.contest.score ? this.$("#hacker-contest-rating").html(parseInt(score.contest.score)) :this.$("#hacker-contest-rating").html("N/A"), 
score.contest.rank ? this.$("#hacker-contest-rank").html(score.contest.rank) :this.$("#hacker-contest-rank").html("N/A"), 
score.practice.score ? this.$("#hacker-practice-rating").html(parseInt(score.practice.score)) :this.$("#hacker-practice-rating").html("N/A"), 
score.practice.rank ? this.$("#hacker-practice-rank").html(score.practice.rank) :this.$("#hacker-practice-rank").html("N/A"), 
score.contest.level ? (this.$("#hacker-title").html(HR.util.ratingLevelToTitle(score.contest.level)), 
this.$("#hacker-title").removeClass("rg_1 rg_2 rg_3 rg_4 rg_5"), this.$("#hacker-title").addClass("rg_" + score.contest.level)) :this.$("#hacker-title").html("N/A")) :(this.$("#hacker-rating").html("N/A"), 
this.$("#hacker-rank").html("N/A"), this.$("#hacker-title").html("N/A"));
...
rating = this.model.get("current_rating"), $(this.el).html(HR.appController.template(this.template, this)({
model:tracks,
rating:rating,
data:this.data
})), $("#track-selector").select2(), this.$(".overall-chart").addClass("is_active"), 
this.renderChart(this.data.models[0]), this.renderScore(tracks[0].text);
}
return this;
}, RatingHistoryView;
...
return TrackContestsView = function(_super) {
function TrackContestsView() {
return TrackContestsView.__super__.constructor.apply(this, arguments);
}
return __extends(TrackContestsView, _super), TrackContestsView.prototype.template = "dashboard/track-contests", 
TrackContestsView.prototype.className = "track-contests", TrackContestsView.prototype.initialize = function(options) {
return this.current_track_slug = options.current_track_slug, this.contest_slug = options.contest_slug, 
this.contest = options.contest, this.profile = HR.profile(), this.collection = options.collection, 
this.listenTo(this.collection, "reset", this.render), this.contest && this.listenTo(this.contest, "reset", this.render), 
this.listenTo(this, "render", this.adjustChallengeListHeight), this.listenTo(this.profile, "sync", this.refreshCollection);
...
return e.preventDefault(), this.collection.total <= this.collection.page * this.collection.limit ? void 0 :(this.collection.contest_slug = null, 
this.collection.page += 1, this.collection.sync_status = !1, this.collection.cached(), 
this.render());
}, TrackContestsView.prototype.showPrev = function(e) {
return e.preventDefault(), 1 !== this.collection.page ? (this.collection.contest_slug = null, 
this.collection.page -= 1, this.collection.sync_status = !1, this.collection.cached(), 
this.render()) :void 0;
}, TrackContestsView.prototype.changeContest = function(e) {
return e.preventDefault(), e.stopPropagation(), this.page = 1, this.challenges = null, 
this.contest_slug = $(e.currentTarget).attr("data-slug"), this.contest = new HR.ContestModel({
slug:this.contest_slug
}), this.contest.cached(), this.listenTo(this.contest, "reset", this.render), HR.router.navigate("categories/" + this.current_track_slug + "/contests/" + this.contest_slug, !1), 
this.render(), !1;
}, TrackContestsView.prototype.setActive = function() {
return this.collection.sync_status && (!this.contest_slug || this.contest && this.contest.sync_status) ? (this.contest_slug || (!this.contest_slug && this.collection.grouped()[0].contests.length > 0 && (this.contest_slug = this.collection.grouped()[0].contests.first().get("slug")), 
...
return challengesList = this.$("div.challenges-list"), minHeight = Math.max(this.$(".inline-sidebar").height() || 1, challengesList.height() || 1), 
...
return this.setActive(), HR.appController.set_contest_namespace("master"), $(this.el).html(HR.appController.template(this.template, this)({
contests:this.collection,
profile:this.profile,
contest:this.contest,
contest_slug:this.contest_slug
})), this.collection.sync_status ? (tabsContainer = {}, _.each(this.collection.grouped(), function(_this) {
return function(group) {
return tabsContainer = $(), _.each(group.contests.models, function(model) {
var _view;
...
}, _this), _this.$("." + group.key + "_contests").html(tabsContainer);
};
}(this))) :(this.$(".active_contests").html(HR.appController.viewLoader(32)), this.$(".archived_contests").html(HR.appController.viewLoader(32))), 
challenges_div = this.$("div.challenges-list"), this.contest && this.contest.sync_status && (this.contest.get("archived") || this.contest.get("started") && this.contest.get("signed_up") ? this.challenges && (this.challenges.sync_status || this.challenges.length > 0) ? (challengesContainer = $(), 
...
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.TrackContestsView = TrackContestsView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return TrackDashboardView = function(_super) {
function TrackDashboardView() {
return TrackDashboardView.__super__.constructor.apply(this, arguments);
}
return __extends(TrackDashboardView, _super), TrackDashboardView.prototype.template = "dashboard/dashboard-track", 
TrackDashboardView.prototype.className = "dashboard-track", TrackDashboardView.prototype.initialize = function(options) {
return null == options && (options = {}), this.current_track_slug = options.current_track_slug, 
this.current_chapter_slug = options.current_chapter_slug, this.contest = options.contest, 
this.activeTab = options.activeTab || "challenge", this.headerView = new HR.DashboardHeaderView($.extend(options, {
parent:this
})), this.bodyView = "challenge" === this.activeTab ? new HR.ChallengesView(options) :new HR.TrackContestsView(options);
}, TrackDashboardView.prototype.render = function() {
return $(this.el).html(HR.appController.template(this.template, this)({
current_track:HR.PREFETCH_DATA.tracks[this.current_track_slug]
})), this.renderSubviews(), this;
}, TrackDashboardView.prototype.renderSubviews = function() {
return this.headerView.setElement(this.$(".view_header")).render(), this.bodyView.setElement(this.$(".view_body")).render();
}, TrackDashboardView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.TrackDashboardView = TrackDashboardView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return that.model.disableThrobber = !0, that.model.fetch({
success:function(model) {
return model.get("confirmed") === !1 ? (that.model.disableThrobber = !1, setTimeout(fetch_loop, 1500)) :void 0;
}
});
}, $.ajax({
...
var url;
if (!$(event).srcElement || "I" !== $(event).srcElement.tagName) return url = ui.item.url, 
...
success:function(data) {
return data ? that.notifications() :that.throttledNotifications(throttled = !0);
},
error:function() {
return that.throttledNotifications(throttled = !0);
}
...
}), view = HR.cachedMessageView || {}, isMessageView = void 0 !== HR.MessageThreadView && HR.appView.contentView instanceof HR.MessageThreadView, 
...
return this.collection.sync_status && "archived" !== this.contest_slug && (!this.contest_slug || this.contest && this.contest.sync_status) ? (this.contest_slug || (_.each(this.collection.grouped()[0].contests.models, function(_this) {
return function(model) {
...
return __extends(ContestsTabView, _super), ContestsTabView.prototype.template = "dashboard/contests-tab", 
ContestsTabView.prototype.className = "contests-list-view", ContestsTabView.prototype.initialize = function(options) {
return null == options && (options = {}), options.custom_template && (this.template = options.custom_template), 
this.listenTo(this.model, "change", this.render);
}, ContestsTabView.prototype.render = function() {
return $(this.el).html(HR.appController.template(this.template, this)({
model:this.model
})), $.timeago.settings.allowFuture = !0, this.$(".timeago").timeago(), this.delegateEvents(), 
this.model.active && (this.model.unSetContestBroadcast(), this.model.setContestBroadcast()), 
this;
}, ContestsTabView;
...
}(this), _clbk(), this.countdown_interval = setInterval(_clbk, 1e3)) :(this.$(".countdown").html($.timeago(new Date(0).setUTCSeconds(milestone_epoch))), 
...
})), $(_this.el).find(".modal").modal(!0).show(), _this.$el = $(_this.el), _this.trigger("doneRendering"), 
...
}, MultiFrameModal.prototype.stopTour = function() {
return 2 !== this.currentFrame ? HR.tour_going = !1 :void 0;
...
return this.hasTemplate ? this.renderView() :HR.appController.getTemplate(this.framesTemplate, function(_this) {
return function(frames) {
return _this.hasTemplate = !0, _this._template = frames, _this.renderView(), MultiFrameModal.__super__.render.apply(_this, arguments), 
_this.delegateEvents();
};
}(this)), this;
}, MultiFrameModal.prototype.renderView = function() {
var fdata, frame;
return fdata = document.createElement("div"), this.framesData.profile = HR.profile().toJSON(), 
$(fdata).append(this._template(this.framesData)), $(fdata).children("section"), 
...
}), frame = this.frames[this.currentFrame], this.body = frame.body, this.header = frame.header, 
this.footer = frame.footer;
}, MultiFrameModal;
...
return __extends(ChallengesView, _super), ChallengesView.prototype.template = "dashboard/challenges-master", 
...
return this.profile = HR.profile(), this.profile.fetchScores(), options.filter && (this.filter = options.filter), 
this.contest = options.contest, this.current_track_slug = options.current_track_slug, 
this.current_chapter_slug = options.current_chapter_slug, this.challenges = options.challenges, 
this.profile = HR.profile(), this.getRecommendedChallenge(), this.listenTo(this.profile, "reset", this.loggedIn), 
this.listenTo(this.profile, "reset", this.renderScore), this.listenTo(this.challenges, "reset", this.render), 
this.listenTo(this.challenges, "change", this.render), this.getRecentHackers(), 
this.onboardingScore(), this.showHiddenBars();
...
}, ChallengesView.prototype.showHiddenBars = function() {
return $(".page_footer").show(), $("div#side-navigation").show(), $(".nav-buttons").show(), 
$(".nav-login-patch").show();
...
return this.contest.get("has_tracks") ? this.contest.tracks() :[];
...
return $.cookie("hr_categories-" + this.contest.get("slug"), _.compact([ this.current_track_slug, this.current_chapter_slug ]), {
path:"/"
}), this.challenges.setCategories([ this.current_track_slug, this.current_chapter_slug ]), 
this.challenges.total = null, this.challenges.page = 1, this.challenges.sync_status = !1, 
HR.router.navigate(this.challenges.pageURL() + ("/challenges/page/" + this.challenges.page), !1), 
this.challenges.cached(), this.render();
}, ChallengesView.prototype.changeChapter = function(e) {
return e.preventDefault(), e.stopPropagation(), this.current_chapter_slug = $(e.currentTarget).attr("data-chapter"), 
this.navigate();
}, ChallengesView.prototype.renderOnboarding = function() {
var func;
if (HR.tour_going) return func = function() {
return this.$("#onboarding-tour").length > 0 && this.$("#ob-challenge").length > 0 && this.$(".ob-overlay").length > 0 ? (this.$(".ob-overlay").click(function() {
return HR.tour_going = !1, HR.tourbus ? ($(".ob-overlay").hide(), HR.tourbus.destroy(), 
HR.tourbus = void 0) :void 0;
}), HR.tourbus || (HR.tourbus = $.tourbus("#onboarding-tour", {
onStop:function() {
return $("#ob-challenge").click();
},
onLegStart:function(leg) {
return leg.rawData.highlight ? $(".ob-overlay").show() :void 0;
},
onLegEnd:function() {
return $(".ob-overlay").hide(), HR.advance_onboarding();
}
})), HR.tourbus.depart(), !0) :!1;
}, func() ? void 0 :setTimeout(this.renderOnboarding, 500);
}, ChallengesView.prototype.onboardingSocial = function() {
var view;
return view = new HR.OnboardingSocialView(), view.render();
}, ChallengesView.prototype.onboardingScore = function() {
var body, country, data, footer, header, mapped_country, score, that, view;
return HR.onboarding_tutorial_challenge_stats ? (data = HR.onboarding_tutorial_challenge_stats, 
score = (data.score * data.weight).round(2), country = HR.profile().get("country"), 
mapped_country = "", country && (mapped_country = window.countries_mapping[country]), 
header = "<h2 class='color-green mlB'>Congratulations, Elou!</h2>", footer = '<div class="faux-leaderboard"> <div class="faux-img"> <span class="faux-rank1 difficulty_mark d-three"></span> <span class="faux-rank2 difficulty_mark d-two"></span> <span class="faux-rank3  difficulty_mark d-four"></span> <div class="faux-leader"> <span class="faux-rank difficulty_mark d-one"></span> <img src="https://secure.gravatar.com/avatar/15cee81b086a3c0f6ff7ac28d0f3bbc9?d=https://d3rpyts3de3lx8.cloudfront.net/hackerrank/assets/gravatar.jpg&amp;s=200" height="40" width="40" class="avatar mmA" onerror="this.onerror=null; this.src=\'https://d3rpyts3de3lx8.cloudfront.net/hackerrank/assets/gravatar.jpg\';"> <span class="faux-name">' + HR.profile().get("username") + '</span> <span class="faux-flag"><img class="flag" rel="tooltip" src="/static/flags/' + mapped_country + '.png" alt="" onerror="this.onerror=null; this.src=\'/static/flags/_unknown.png\';" data-original-title="' + country + '"></span> </div> <img src="/assets/onboarding/faux_leaderboard.jpg"> </div> <p class="btn-wrap"><a href="' + data.leaderboard + '" class="btn btn-primary" target="_blank">See your standing here</a> </div> <p class="plT plB"><a href="" class="js-next">Almost done! Final step<i class="icon--right icon-right-open"></i></a></p>', 
that = this, body = score > 0 ? "<p class='mlB'>You\u2019re on the leaderboard, and you have been <strong>awarded " + score + " points and " + data.hacko + " <a href='/" + HR.profile().get("username") + "'>hackos</a> </strong> for completing the tutorial. If you get stuck, you can access all of these hints and more via the help tag in your admin menu (top right). </p>" :"<p class='mlB'>You have been <strong>awarded " + score + " points and " + data.hacko + " <a href='/" + HR.profile().get("username") + "'>hackos</a> </strong> for completing the tutorial. If you get stuck, you can access all of these hints and more via the help tag in your admin menu (top right). </p>", 
view = new HR.OnboardingModalView({
body:header + body + footer,
width:"540px"
}), HR.view = view, view.on("next", function() {
return that.onboardingSocial();
}), view.render(), HR.onboarding_tutorial_challenge_stats = void 0) :void 0;
...
this.template = "master" === this.contest.get("slug") ? "dashboard/challenges-master" :"dashboard/challenges-contest", 
...
this.challenges.sync_status ? (challengesContainer = $(), this._subviews = [], this.challenges.models.length > 0 ? (index = 0, 
_.each(this.challenges.models, function(challenge) {
var _view;
return index += 1, _view = new listView({
model:challenge,
id:parseInt(1e6 * Math.random()),
contest:this.contest,
is_ob_challenge:1 === index
}), challengesContainer.push(_view.render().el), this.add_subview(_view);
...
this.trigger("render"), HR.tour_going && this.renderOnboarding(), this;
}, ChallengesView;
...
var that;
return this.contest = options.contest, this.id = options.id, this.elapsed_time = 0, 
this.is_ob_challenge = options.is_ob_challenge, that = this;
...
width:"" + width_percent + "%"
}) :this.$(".progress").hide(), this.countdownTimerView = new HR.CountdownTimerView({
model:this.model,
template:"dashboard/countdowntimer_v2"
}), this.add_subview(this.countdownTimerView), this.countdownTimerView.setElement(this.$(".countdowntimer")).render(), 
this.delegateEvents(), _model.has_started && _model.has_ended || (this._interval && clearInterval(this._interval), 
this._interval = setInterval(function(_this) {
return function() {
return _this.update_time();
};
}(this), 1e3))), this.is_ob_challenge && this.$(".start").attr("id", "ob-challenge"), 
this;
...
return function() {
return _this.model.disableThrobber = !0, _this.model.fetch({
success:function() {
return _this.render();
}
});
...
jQuery(function() {
var HR, OnboardingTrackSelectionView, _ref;
return OnboardingTrackSelectionView = function(_super) {
function OnboardingTrackSelectionView() {
return OnboardingTrackSelectionView.__super__.constructor.apply(this, arguments);
}
return __extends(OnboardingTrackSelectionView, _super), OnboardingTrackSelectionView.prototype.template = "onboarding-track-selection", 
OnboardingTrackSelectionView.prototype["class"] = "onboarding-view", OnboardingTrackSelectionView.prototype.events = {
"click .onboarding_domain":"changeSelection"
}, OnboardingTrackSelectionView.prototype.initialize = function(options) {
return null == options && (options = {}), this.profile = HR.profile(), HR.SELECTED_TRACK = "algorithms";
}, OnboardingTrackSelectionView.prototype.render = function() {
...
}, OnboardingTrackSelectionView.prototype.renderView = function() {
return $(this.el).html(this._template({
activeTrack:HR.SELECTED_TRACK
})), this;
}, OnboardingTrackSelectionView.prototype.changeSelection = function(e) {
var slug;
return slug = $(e.currentTarget).attr("data-slug"), slug !== HR.SELECTED_TRACK ? (HR.SELECTED_TRACK = slug, 
$(".onboarding_domain").removeClass("is-selected"), $(".onboarding_domain[data-slug=" + HR.SELECTED_TRACK + "]").addClass("is-selected")) :void 0;
}, OnboardingTrackSelectionView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.OnboardingTrackSelectionView = OnboardingTrackSelectionView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var HR, OnboardingTutorialView, _ref;
return OnboardingTutorialView = function(_super) {
function OnboardingTutorialView() {
return OnboardingTutorialView.__super__.constructor.apply(this, arguments);
}
return __extends(OnboardingTutorialView, _super), OnboardingTutorialView.prototype.template = "onboarding-tutorial", 
OnboardingTutorialView.prototype.initialize = function(options) {
var image;
return null == options && (options = {}), this.listenTo(this.model, "reset", this.render), 
image = $('<img src="/assets/spinner.gif">'), OnboardingTutorialView.__super__.initialize.apply(this, arguments);
}, OnboardingTutorialView.prototype.events = {
"codeshellcompile #codeshell-wrapper":"compileTest",
"codeshellsubmit #codeshell-wrapper":"submitPopup",
"click a.btn-reveal":"revealSolution"
}, OnboardingTutorialView.prototype.render = function() {
return this.has_template ? this.renderView() :HR.appController.getTemplate(this.template, function(template) {
return this.has_template = !0, this._template = template, this.renderView();
}, this), this;
}, OnboardingTutorialView.prototype.renderView = function() {
return this.model && this.model.get("_data") ? ($(this.el).html(this._template({
model:this.model
})), HR.appController.loadCodeMirror(function(_this) {
return function() {
return _this.applyCodeshell();
};
}(this)), HR.requires([ "compound/challenge-views" ], function(_this) {
return function() {
return _this.responseView = new HR.ChallengeResponseView({
model:_this.model
}), _this.assign({
".response-view":_this.responseView
});
};
}(this))) :void 0;
}, OnboardingTutorialView.prototype.setCodeEditorToolTip = function() {
return $("#codeshell-wrapper div:first").addClass("onboarding_tip-hold"), $("#codeshell-wrapper div:first").prepend('<span class="onboarding_tip" id="tipLanguage" title="You can submit a challenge in as many languages as you want. Select the one that you want to use for this tutorial"></span>'), 
$("#codeshell-wrapper div:first").prepend('<span class="onboarding_tip" id="tipSettings" title="Customize the codeeditor to create your optimal experience"></span>'), 
$(".bb-compile").parent().addClass("onboarding_tip-hold"), $(".bb-compile").parent().prepend('<span class="onboarding_tip" id="tipCompile" title="Run your code to test it against the sample test codes as many times as you need"></span>');
}, OnboardingTutorialView.prototype.setOutputAreaToolTip = function() {
return $(".output-area-wrap").addClass("onboarding_tip-hold"), $(".output-area-wrap").prepend('<span class="onboarding_tip" id="tipTestcase" title="Run your code to test it against the sample test codes as many times as you need"></span>');
}, OnboardingTutorialView.prototype.applyCodeshell = function() {
var that;
return that = this, $(this.el).find("#codeshell-wrapper").codeshell($.extend({
showCustomInput:!1,
showCompileTest:!0,
showSubmit:!0,
showTheme:!0,
foldCode:!0,
compile_button_text:"<i class='icon-play'></i>Run Code",
...
return data.callback(), _this.setClipboard();
});
};
}(this)
}, this.languageTemplates())), this.setCodeEditorToolTip(), $(this.el).find("#codeshell-wrapper").codeshell("onChange", $.proxy(this.deleteMarkersOnSource, this)), 
$(this.el).find("button.bb-submit").hide(), $(this.el).find("button.bb-compile").removeClass("msR");
}, OnboardingTutorialView.prototype.compileTest = function(e, data) {
var $btn, compile_test, response_view;
if (0 !== _.size(data) && ($(this.el).find(".js-help").hide(), response_view = this.responseView, 
...
$btn.addClass("disabled"), $btn.html('<img src="/assets/spinner.gif"> Processing...'), 
this.compileButton = $btn, compile_test = new HR.CompileTestModel({
code:data.code,
...
}, OnboardingTutorialView.prototype.addMarkersOnSource = function(model, error_markers) {
var editor, error_message, i, line_number, line_offset, marker_node, markers, total_lines;
if (error_markers) {
window.error_marker_widgets || (window.error_marker_widgets = []), editor = $(this.el).find("#codeshell-wrapper").codeshell("getEditor"), 
...
}, OnboardingTutorialView.prototype.deleteMarkersOnSource = function() {
var editor, error, _i, _len, _ref;
if (window.error_marker_widgets && 0 !== window.error_marker_widgets.length) {
for (editor = $(this.el).find("#codeshell-wrapper").codeshell("getEditor"), _ref = window.error_marker_widgets, 
_i = 0, _len = _ref.length; _len > _i; _i++) error = _ref[_i], editor.removeLineWidget(error);
return editor.refresh(), window.error_marker_widgets = [];
}
}, OnboardingTutorialView.prototype.enableCompileTest = function(model, status) {
var error, s, score, _i, _len, _ref;
if (status > 0) {
for (score = 0, _ref = model.get("testcase_status"), _i = 0, _len = _ref.length; _len > _i; _i++) s = _ref[_i], 
score += s;
if (score === model.get("testcase_status").length && score > 0 ? $(this.el).find("button.bb-submit").click() :$(this.el).find(".js-help").show(), 
this.setOutputAreaToolTip(), this.compileButton.html("<i class='icon-play'></i> Run Again"), 
$(this.el).find("#codeshell-wrapper").codeshell("enableCompileBtn"), error = model.get("error")) return this.responseView;
}
}, OnboardingTutorialView.prototype.submitPopup = function(e, data) {
var $btn, current_text, error, submission, that;
if (that = this, $btn = $(e.currentTarget).find("button.bb-submit"), "disabled" !== $btn.attr("btn-disabled")) {
if ($btn.attr("btn-disabled", "disabled"), $btn.addClass("disabled"), current_text = $btn.html(), 
$.inArray(this.model.get("id"), HR.CHALLENGES_DISABLED) >= 0 || HR.CONTEST_DISABLED) return error = new HR.util.ShowSubmitDisabledDialog(), 
error.render(), void 0;
if (that.model && that.model.get && HR.profile() && mixpanel.push([ "track", "Submit Code", {
...
} ]), !that.submitLock || that.submitLock !== !0) return "" !== $("#codeshell-wrapper").codeshell("getOptions").language ? (that.submitLock = !0, 
$("#codeshell-wrapper").codeshell("deleteLangCode"), submission = HR.model("submission", {
code:data.code,
language:data.language,
...
that.submitLock = !1, response.status ? (view = new HR.OnboardingModalView({
body:"You passed all the sample test cases! Please wait as we quickly run through the official cases to compile your score."
}), view.render(), model.fetch(), that.listenTo(model, "sync", function() {
var hacko;
return model.is_processed() ? ($("#modal-wrap").remove(), $(".modal-backdrop").remove(), 
hacko = 5, 1 === model.get("score") && (hacko += 5), HR.onboarding_tutorial_challenge_stats = {
score:model.get("score"),
weight:that.model.get("factor"),
leaderboard:"/challenges/" + that.model.get("slug") + "/leaderboard",
hacko:hacko
}, HR.router.navigate("/categories/" + HR.SELECTED_TRACK, {
trigger:!0
})) :void 0;
})) :($btn.setActive(), $btn.setFailedMsg(response.message));
},
error:function() {
return that.submitLock = !1, $btn.setActive(), $btn.setFailedMsg("Internal server error occured. Please try again.");
}
})) :void 0;
}
}, OnboardingTutorialView.prototype.languageTemplates = function() {
var templates;
return templates = {
lang_template:{}
}, _.each(this.model.get("_data").onboarding, function(value, key) {
return templates.lang_template[key] = value.template;
}), templates;
}, OnboardingTutorialView.prototype.revealSolution = function(e) {
var language, solution, view;
return e.preventDefault(), e.stopPropagation(), language = $(this.el).find("#codeshell-wrapper").codeshell("getOptions").language, 
solution = this.model.get("_data").onboarding[language].solution, view = new HR.OnboardingModalView({
width:"600px",
body:"<pre style='text-align: left'>" + _.escape(solution) + "</pre> <a class='btn btn-green js-next'>Copy to editor</a>"
}), view.on("next", function(_this) {
return function() {
return $(_this.el).find("#codeshell-wrapper").codeshell("setValue", {
code:solution,
language:language
});
};
}(this)), view.render();
}, OnboardingTutorialView.prototype.setClipboard = function() {
var clipboardcopy, editor, that;
return this.codeshellwrapper = $(this.el).find("#codeshell-wrapper"), editor = $(this.el).find("#codeshell-wrapper").codeshell("getEditor"), 
that = this, HR.clipboard && this.codeshellwrapper && HR.forkable && editor ? (clipboardcopy = {}, 
clipboardcopy.language = HR.clipboard.language, clipboardcopy.code = HR.clipboard.code, 
that.codeshellwrapper.codeshell("setValueorFork", clipboardcopy), $("body").scrollTop($("#codeshell-wrapper").offset().top - 50), 
delete HR.clipboard) :void 0;
}, OnboardingTutorialView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.OnboardingTutorialView = OnboardingTutorialView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var HR, OnboardingModalView, _ref;
return OnboardingModalView = function(_super) {
function OnboardingModalView() {
return OnboardingModalView.__super__.constructor.apply(this, arguments);
}
return __extends(OnboardingModalView, _super), OnboardingModalView.prototype.template = "onboarding-modal", 
OnboardingModalView.prototype.events = {
"click .close":"remove"
}, OnboardingModalView.prototype.initialize = function(options) {
return null == options && (options = {}), this.body = options.body || "", this.header = options.header || "", 
this.footer = options.footer || "", this.width = options.width || 600, 0 === $("body").find("#modal-wrap").length && $("body").append('<div id="modal-wrap"></div>'), 
$("#modal-wrap").append("<div id='modal-" + this.cid + "'></div>"), this.el = $("body #modal-wrap #modal-" + this.cid);
}, OnboardingModalView.prototype.render = function() {
return this.has_template ? this.renderView() :HR.appController.getTemplate(this.template, function(template) {
return this.has_template = !0, this._template = template, this.renderView();
}, this), this;
}, OnboardingModalView.prototype.renderView = function() {
var that;
return $(this.el).html(this._template({
body:this.body,
header:this.header,
footer:this.footer,
width:this.width
})), that = this, $(".js-next").bind("click", function(e) {
return that.triggerNext(e);
}), $(this.el).find(".modal").modal(!0).show();
}, OnboardingModalView.prototype.triggerNext = function(e) {
return e.preventDefault(), e.stopPropagation(), this.remove(), this.trigger("next");
}, OnboardingModalView.prototype.remove = function() {
return $(this.el).find(".modal").modal("hide"), OnboardingModalView.__super__.remove.apply(this, arguments);
}, OnboardingModalView;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.OnboardingModalView = OnboardingModalView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
jQuery(function() {
var HR, OnboardingSocialView, _ref;
return OnboardingSocialView = function(_super) {
function OnboardingSocialView() {
return OnboardingSocialView.__super__.constructor.apply(this, arguments);
}
return __extends(OnboardingSocialView, _super), OnboardingSocialView.prototype.events = {
"click .btn-facebook":"facebookLogin"
}, OnboardingSocialView.prototype.initialize = function(options) {
return null == options && (options = {}), OnboardingSocialView.__super__.initialize.apply(this, arguments), 
this.width = 500, this.body = '<h5 class="mlB"><strong>Connect your networks</strong> to get challenge recommendations, direct help, or form teams to compete.</h5> <p class="mlB"><a class="btn btn-facebook btn-social btn-large" data-analytics="SignupFacebook"><i class="icon-facebook"></i><span class="text">Connect with Facebook</span></a></p> <label><input type="checkbox" id="email-preference" checked="checked"> Subscribe to emails</label> <form class="mlT mlB"> <label class="text-left block-center" style="width: 350px;">School</label> <input type="text" class="wide" id="onboarding_school"> <label class="text-left block-center" style="width: 350px;">Company</label> <input type="text" class="wide" id="onboarding_company"> </form> <p class="plT plB"><a href="" class="btn btn-primary finish js-next">Start Coding!</a></p>', 
this.email_preferences_model = HR.model("email-preferences", {
username:HR.profile().get("username")
}).cached();
}, OnboardingSocialView.prototype.render = function() {
return this.has_template ? this.renderView() :HR.appController.getTemplate(this.template, function(template) {
return this.has_template = !0, this._template = template, this.renderView();
}, this), this;
}, OnboardingSocialView.prototype.finish = function(e) {
var company, data, school;
return e.preventDefault(), e.stopPropagation(), school = $("#onboarding_school").select2("val"), 
company = $("#onboarding_company").val(), data = {
school:school,
company:company
}, $.ajax({
...
type:"PUT"
}), this.email_preferences_model.set("upcoming_contest", !0), this.email_preferences_model.save(), 
mixpanel.push([ "track", "SetUpcomingEmailPref", {
value:"true"
} ]), this.remove();
}, OnboardingSocialView.prototype.renderView = function() {
var that;
return $(this.el).html(this._template({
body:this.body,
header:this.header,
footer:this.footer,
width:this.width
})), $(this.el).find(".modal").modal(!0).show(), $(".finish").bind("click", $.proxy(this.finish, this)), 
$("#onboarding_school").select2(HR.util.school_select2_options), $("#onboarding_company").completer("company"), 
that = this, $("#onboarding_school").on("change", function(e) {
return that.school = e.val;
}), $("#onboarding_company").keyup(function(e) {
return that.company = $(e.currentTarget).val();
}), $(".btn-facebook").bind("click", $.proxy(this.facebookLogin, this));
}, OnboardingSocialView.prototype.remove = function() {
return $(this.el).find(".modal").modal("hide"), OnboardingSocialView.__super__.remove.apply(this, arguments);
}, OnboardingSocialView.prototype.facebookLogin = function(e) {
return HR.appController.facebook_login(e);
}, OnboardingSocialView;
}(window.HR.OnboardingModalView), HR = null != (_ref = window.HR) ? _ref :{}, HR.OnboardingSocialView = OnboardingSocialView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return OnboardingView = function(_super) {
function OnboardingView() {
return OnboardingView.__super__.constructor.apply(this, arguments);
}
return __extends(OnboardingView, _super), OnboardingView.prototype.templates = [ "onboarding_social" ], 
OnboardingView.prototype["class"] = "onboarding-view", OnboardingView.prototype.initialize = function(options) {
return null == options && (options = {}), this.currentFrame = 0, this.profile = HR.profile(), 
this.school = this.profile.get("school"), this.company = this.profile.get("company"), 
this.email_preferences_model = HR.model("email-preferences", {
...
return 2 === frame_to ? HR.tour_going = !0 :void 0;
}), this.tour.on("postFrameChange", function(frame_from, frame_to) {
return HR.advance_onboarding(), 2 === frame_to ? ($("#email-preference").is(":checked") && (that.email_preferences_model.set("upcoming_contest", !0), 
that.email_preferences_model.save(), mixpanel.push([ "track", "SetUpcomingEmailPref", {
value:"true"
} ])), HR.router.navigate(track_url_map[$("input[type='radio'][name='favorite']:checked").val()] + "?action=onboarding", !0, !0)) :void 0;
}), this.tour.on("doneRendering", function() {
return $(".js-fake-next").bind("click", $.proxy(that.loadNetwork, that)), $(".btn-facebook").bind("click", HR.appController.facebook_login), 
$("#onboarding_school").select2(HR.util.school_select2_options), $("#onboarding_company").completer("company", {
onselect:function(value) {
return that.company = value;
}
}), that.school && ($(this.el).find("#onboarding_school").val(that.school), $(this.el).find("#s2id_onboarding_school .select2-choice span").text(that.school)), 
$("#onboarding_school").on("change", function(e) {
return that.school = e.val;
}), $("#onboarding_company").keyup(function(e) {
return that.company = $(e.currentTarget).val();
});
}), this.tour.render(), HR.advance_onboarding = function() {
return HR.tour_step += 1, mixpanel.push([ "track", "Onboarding Steps", {
Step:HR.tour_step
} ]);
}, HR.tour_step = 0, HR.advance_onboarding(), this.delegateEvents(), this;
}, OnboardingView.prototype.loadNetwork = function(e) {
var that;
return $(e.currentTarget).attr("disabled", "disabled"), $(".modal-body .onboarding_modal").html("<div class='left'> <p>We are generating your network with the information you provided. It will take only few seconds.</p> " + HR.appController.viewLoader(64) + " </div>"), 
that = this, $.ajax({
url:"/rest/hackers/me/update_social_network",
data:{
school:this.school,
...
type:"PUT",
success:function(data) {
return that.tour.framesData.recommended_track = data.track, that.tour.render(), 
$(".js_next-frame").click();
}
});
...
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.OnboardingView = OnboardingView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
return ClientServerCompileTestView = function(_super) {
function ClientServerCompileTestView() {
return ClientServerCompileTestView.__super__.constructor.apply(this, arguments);
}
return __extends(ClientServerCompileTestView, _super), ClientServerCompileTestView.prototype.template = "client-server-compile-test", 
...
}(window.HR.GenericView), HR = window.HR || {}, HR.ClientServerCompileTestView = ClientServerCompileTestView;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
var current_hacker;
return this.challenge ? (current_hacker = this.collection.current_hacker, 1 === this.contest.get("id") && current_hacker && current_hacker.score === this.challenge.get("max_score") && this.challenge.get("can_solve") ? !0 :this.challenge.get("public_solutions") ? 1 !== this.contest.get("id") ? this.contest.get("ended") || "weekly" === this.contest.get("kind") && this.challenge.get("has_ended") ? !0 :!1 :!1 :!1) :!1;
