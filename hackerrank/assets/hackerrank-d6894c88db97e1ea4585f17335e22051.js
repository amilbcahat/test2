...
":hacker_slug/hackos/page/:page/":"hackerHackos",
onboardingtest1:"onboardingtest1",
onboardingtest2:"onboardingtest2",
":slug":"vanity",
":slug/":"vanity",
...
}, DashboardRouter.prototype.onboardingtest1 = function() {
var view;
return view = new HR.OnboardingView(), view.render();
}, DashboardRouter.prototype.onboardingtest2 = function() {
var view;
return view = new HR.OnboardingTutorialModal({
...
jQuery(function() {
var HR, OnboardingTutorialModal, _ref;
return OnboardingTutorialModal = function(_super) {
function OnboardingTutorialModal() {
return OnboardingTutorialModal.__super__.constructor.apply(this, arguments);
}
return __extends(OnboardingTutorialModal, _super), OnboardingTutorialModal.prototype.template = "tutorial-challenge-modal", 
OnboardingTutorialModal.prototype.className = "modal-view", OnboardingTutorialModal.prototype.localTemplate = "onboarding-tutorial", 
OnboardingTutorialModal.prototype.initialize = function(options) {
return null == options && (options = {}), this.listenTo(this.model, "reset", this.render), 
0 === $("body").find("#modal-wrap").length && $("body").append('<div id="modal-wrap"></div>'), 
$("#modal-wrap").append("<div id='modal-" + this.cid + "'></div>"), this.el = $("body #modal-wrap #modal-" + this.cid), 
this.$el = $("body #modal-wrap #modal-" + this.cid);
}, OnboardingTutorialModal.prototype.events = {
"codeshellcompile #codeshell-wrapper":"compileTest",
"codeshellsubmit #codeshell-wrapper":"submitPopup"
}, OnboardingTutorialModal.prototype.renderModal = function() {
return this.model.sync_status && this._template ? HR.appController.getTemplate(this.template, function(_this) {
return function(t) {
return $(_this.el).html(t({
body:_this._template(),
header:_this.header,
footer:_this.footer,
template:_this.template
})), _this.renderView(), $(_this.el).find(".modal").modal(!0).show(), _this.delegateEvents();
};
}(this)) :void 0;
}, OnboardingTutorialModal.prototype.render = function() {
return this.has_template ? this.renderModal() :HR.appController.getTemplate(this.localTemplate, function(template) {
return this.has_template = !0, this._template = template, this.renderModal();
}, this), this;
}, OnboardingTutorialModal.prototype.renderView = function() {
return HR.appController.loadCodeMirror(function(_this) {
return function() {
...
}, OnboardingTutorialModal.prototype.applyCodeshell = function() {
var that;
...
}, this.model.getLanguageTemplates())), $(this.el).find("#codeshell-wrapper").codeshell("onChange", this.deleteMarkersOnSource);
}, OnboardingTutorialModal.prototype.compileTest = function(e, data) {
...
}, OnboardingTutorialModal.prototype.addMarkersOnSource = function(model, error_markers) {
...
}, OnboardingTutorialModal.prototype.deleteMarkersOnSource = function() {
var editor, i;
...
}, OnboardingTutorialModal.prototype.enableCompileTest = function(model, status) {
var error;
return status > 0 && ($(this.el).find("#codeshell-wrapper").codeshell("enableCompileBtn"), 
error = model.get("error")) ? this.responseView :void 0;
}, OnboardingTutorialModal.prototype.remove = function() {
return $(this.el).modal("hide"), OnboardingTutorialModal.__super__.remove.apply(this, arguments);
}, OnboardingTutorialModal.prototype.submitPopup = function(e, data) {
...
silent:!0
}), HR.router.navigate("/categories/algorithms/warmup?ref=onboarding", !0), thar.remove()) :($btn.setActive(), 
$btn.setFailedMsg(response.message));
},
error:function() {
...
}, OnboardingTutorialModal.prototype.setClipboard = function() {
...
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.OnboardingTutorialModal = OnboardingTutorialModal;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
