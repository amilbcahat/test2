...
}, CommonController.prototype.loadGraphLibraries = function(callback, errcallback) {
return null == errcallback && (errcallback = null), HR.requires([ "recruit_graph" ], function() {
return function() {
return callback();
};
}(this));
