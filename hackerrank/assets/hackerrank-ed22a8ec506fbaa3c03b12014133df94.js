...
return "" + HR.util.getWordpressBaseUrl() + "/?json=1&page=" + this.page;
...
return function(resp) {
var html;
return resp.error || 0 === resp.posts.length ? $(".pending-review").html("<li class='lg-block_head'>No post pending for review</li>") :(html = "", 
