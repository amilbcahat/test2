...
return this.contest && this.contest.sync_status && this.contest.get("visible") && this.collection.sync_status && "archived" !== this.contest_slug ? (this.challenges || (this.challenges = HR.collection("challenges"), 
...
var tabsContainer;
return tabsContainer = $(), "archived" === group.key && _this.collection.page > 1 && tabsContainer.push($("<div class='up m' data-offset='10'><div><a class='btn btn-text'><i class='icon-up-open-mini'></i>Load previous 10</a></div></div>").get(0)), 
...
collection:collection
}), this.archivedView.setElement(this.$(".archived-contests")).render()), this.contest ? this.contest.get("archived") || this.contest.get("started") && this.contest.get("signed_up") ? this.challenges && (this.challenges.sync_status || this.challenges.length > 0) ? (challengesContainer = $(), 
...
this.collection.cached(), this.render();
