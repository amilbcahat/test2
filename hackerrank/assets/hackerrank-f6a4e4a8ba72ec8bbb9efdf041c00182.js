...
hackervshacker:HR.HackervshackerModel,
...
hackervshacker:HR.HackerVsHackerCollection,
...
}, AppController.prototype.log = Backbone.log, AppController.prototype.fetchManifest = function() {
return $.ajax({
url:"/misc/manifest/" + HR.MANIFEST_HASH,
dataType:"json",
cache:!0
});
}, AppController.prototype.manifest = function() {
var cachedManifest;
return _.isUndefined(this._manifest) && (cachedManifest = ($.jStorage.get("manifest") || {})[HR.MANIFEST_HASH], 
cachedManifest ? this._manifest = cachedManifest :this.fetchManifest().then(function(_this) {
return function(manifest) {
var cache;
return _this._manifest = manifest, cache = {}, cache[HR.MANIFEST_HASH] = _this._manifest, 
$.jStorage.set("manifest", cache);
};
}(this))), this._manifest;
}, AppController.prototype.staticPath = function(path, base_path) {
return null == base_path && (base_path = null), this.manifest() ? path = this.manifest()[path] || path :base_path = "/assets", 
...
}, ChallengeModel.prototype.save_code = function(language, code, success_callback) {
var data, url;
return url = "/rest/contests/" + this.get("contest_slug") + "/challenges/" + this.get("slug") + "/save_code", 
data = {
language:language,
code:code
}, $.ajax(url, {
...
jQuery(function() {
var HR, HackervshackerModel;
return HackervshackerModel = function(_super) {
function HackervshackerModel() {
return HackervshackerModel.__super__.constructor.apply(this, arguments);
}
return __extends(HackervshackerModel, _super), HackervshackerModel;
}(window.HR.GenericModel), HR = window.HR || {}, HR.HackervshackerModel = HackervshackerModel;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
var $panel, fetchThrottle, original_response, social_share, that, url, url_prefix, url_suffix, _base, _name;
...
that = this, resp && resp.id && 0 !== resp.status_code && 3 !== resp.status_code && (resp.game_played === resp.game_total || resp.testcase_message && resp.testcase_message.length > 0) && 1 === resp.score_processed && HR.QUEUED_SUBMISSIONS && HR.QUEUED_SUBMISSIONS[resp.id] && (HR.QUEUED_SUBMISSIONS[resp.id] = void 0, 
...
url:url,
type:"unlock"
}), social_share.render())), resp && (0 === resp.status_code || 3 === resp.status_code || that.games_queued(resp) || null !== resp.testcase_message && void 0 !== resp.testcase_message && 0 === resp.testcase_message.length || 1 !== resp.score_processed) && (fetchThrottle || (fetchThrottle = {}), 
fetchThrottle[resp.id] || (fetchThrottle[resp.id] = _.throttle(function() {
return that.fetch({
disableThrobber:!0
});
}, this.time - 50)), setTimeout(function() {
return fetchThrottle[resp.id]();
}, this.time)), SubmissionModel.__super__.parse.call(this, original_response, xhr));
}, SubmissionModel.prototype.games_queued = function(model) {
return "game" === model.kind ? model.game_total > model.game_played ? !0 :!1 :!1;
...
}), ChallengesCollection.__super__.parse.call(this, resp, xhr);
...
return __extends(ContestsCollection, _super), ContestsCollection.prototype.url = function() {
return "/rest/contests/upcoming";
}, ContestsCollection.prototype.cacheTimeout = 30, ContestsCollection.prototype.model = window.HR.ContestModel, 
...
return this.total = resp.total, this.weekly = resp.weekly, ContestsCollection.__super__.parse.call(this, resp, xhr);
...
jQuery(function() {
var HR, HackerVsHackerCollection, _ref;
return HackerVsHackerCollection = function(_super) {
function HackerVsHackerCollection() {
return HackerVsHackerCollection.__super__.constructor.apply(this, arguments);
}
return __extends(HackerVsHackerCollection, _super), HackerVsHackerCollection.prototype.initialize = function(options) {
return HackerVsHackerCollection.__super__.initialize.call(this, options);
}, HackerVsHackerCollection.prototype.url = function() {
var limit;
return limit = this.getLimit(), null !== this.filter_challenge && this.filter_challenge ? "/rest/contests/" + HR.appController.get_current_contest_slug() + "/hackers/" + this.hacker1_username + "/vs?hacker2=" + this.hacker2_username + "&challenge=" + this.filter_challenge + "&offset=" + (this.page - 1) * limit :"/rest/contests/" + HR.appController.get_current_contest_slug() + "/hackers/" + this.hacker1_username + "/vs?hacker2=" + this.hacker2_username + "&offset=" + (this.page - 1) * limit;
}, HackerVsHackerCollection.prototype.parse = function(resp) {
return this.hacker1 = resp.actors.hacker1, this.hacker2 = resp.actors.hacker2, this.total = resp.total, 
this.page = resp.page, resp.models;
}, HackerVsHackerCollection.prototype.setLimit = function(limit) {
return HR.appController.cleanCollectionCache("hackervshacker"), this.limit = limit;
}, HackerVsHackerCollection.prototype.pageURL = function() {
return null !== this.filter_challenge && this.filter_challenge ? "" + HR.appController.get_current_contest_namespace() + "/hackervshacker/" + this.hacker1_username + "/vs/" + this.hacker2_username + "/" + this.filter_challenge + "/" :"" + HR.appController.get_current_contest_namespace() + "/hackervshacker/" + this.hacker1_username + "/vs/" + this.hacker2_username + "/";
}, HackerVsHackerCollection.prototype.route = function() {
return HR.router.navigate(this.pageURL()), this.trigger("reset"), this.fetch();
}, HackerVsHackerCollection.prototype.setPage = function(page) {
return this.page = page;
}, HackerVsHackerCollection.prototype.setHacker1 = function(hacker1_username) {
this.hacker1_username = hacker1_username;
}, HackerVsHackerCollection.prototype.setHacker2 = function(hacker2_username) {
this.hacker2_username = hacker2_username;
}, HackerVsHackerCollection.prototype.setChallenge = function(filter_challenge) {
this.filter_challenge = filter_challenge;
}, HackerVsHackerCollection.prototype.getTotal = function() {
return this.total;
}, HackerVsHackerCollection.prototype.getCurrentPage = function() {
return this.page;
}, HackerVsHackerCollection.prototype.getLimit = function() {
return this.filter_challenge && null !== this.filter_challenge ? 10 :5;
}, HackerVsHackerCollection;
}(window.HR.GenericCollection), HR = null != (_ref = window.HR) ? _ref :{}, HR.HackerVsHackerCollection = HackerVsHackerCollection;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
...
"blog/:id/edit/":"edit_blog",
"hackervshacker/:hacker1/vs/:hacker2":"hackervshacker",
"hackervshacker/:hacker1/vs/:hacker2/":"hackervshacker",
"hackervshacker/:hacker1/vs/:hacker2/:page":"hackervshacker",
"hackervshacker/:hacker1/vs/:hacker2/:challenge":"hackervshacker",
"hackervshacker/:hacker1/vs/:hacker2/:challenge/":"hackervshacker",
"hackervshacker/:hacker1/vs/:hacker2/:challenge/:page":"hackervshacker",
dashboard:"dashboard",
...
"tracks/:track_slug/leaderboard":"trackLeaderboard",
"tracks/:track_slug/leaderboard/:page":"trackLeaderboard",
"tracks/:track_slug/leaderboard/filter/:filterString":"filterTrackLeaderboard",
"tracks/:track_slug/leaderboard/filter/:filterString/:page":"filterTrackLeaderboard",
"challenges/:challenge_slug/leaderboard":"challengeLeaderboard",
"challenges/:challenge_slug/leaderboard/:page":"challengeLeaderboard",
"challenges/:challenge_slug/leaderboard/filter/:filterString":"filterChallengeLeaderboard",
"challenges/:challenge_slug/leaderboard/filter/:filterString/:page":"filterChallengeLeaderboard",
...
tracks:"tracks",
"tracks/":"tracks",
"tracks/:track":"topTrackRedirect",
"tracks/:track/":"topTrackRedirect",
"tracks/:track/:chapter":"trackChallengesList",
"tracks/:track/:chapter/":"trackChallengesList",
"tracks/:track/:chapter/sort/:sort_by":"trackChallengesList",
"tracks/:track/:chapter/challenges(/filter/:filter)(/sort/:sort_by)(/dir/:direction)(/page/:page)":"filteredTrackChallengesList",
"tracks/:track/:chapter/challenges/page/:page":"trackChallengesList",
"tracks/:track/:chapter/challenges/sort/:sort_by/page/:page":"trackChallengesList",
careers:"careers",
...
return HR.appController.set_contest_namespace("master"), this.navigate("/tracks", {
trigger:!0,
replace:!0
});
...
}, DashboardRouter.prototype.hackervshacker = function(hacker1, hacker2, challenge, page) {
var cacheKey, hackervshacker;
return null == challenge && (challenge = null), null == page && (page = null), null !== page && "" !== page || null !== challenge ? null !== page && "" !== page || isNaN(challenge) ? !isNaN(challenge) || null !== page && "" !== page || (page = 1) :(page = challenge, 
challenge = null) :page = 1, cacheKey = "" + hacker1 + "-" + hacker2 + "-" + challenge + "-" + page, 
hackervshacker = HR.appController.getCollection("hackervshacker", cacheKey, function(collection) {
return collection.setPage(page), collection.setHacker1(hacker1), collection.setHacker2(hacker2), 
collection.setChallenge(challenge), collection.fetch();
}, !1, !1), HR.requires("compound/submission-views", "moment", function() {
var hvh_view;
return hvh_view = new HR.GroupedHackerVsHackerView({
collection:hackervshacker,
page:page
});
}), HR.appView.setContentView(hvh_view), window.mixpanel_data.landing = !1;
...
}, DashboardRouter.prototype.challengesList2 = function(page, track, contest_slug, as_track, category_slugs, filter, sort_by, sort_dir, is_track_view) {
var activeCategory, cat, challenges, challenges_view, chap, that;
return null == page && (page = 1), null == track && (track = null), null == contest_slug && (contest_slug = null), 
null == as_track && (as_track = !1), null == filter && (filter = null), null == sort_by && (sort_by = null), 
null == sort_dir && (sort_dir = null), null == is_track_view && (is_track_view = !1), 
that = this, contest_slug || (contest_slug = "master"), this.log(page, track, contest_slug, as_track, category_slugs, filter), 
"master" === contest_slug ? (cat = _.first(_.filter(HR.contest().get("categories"), function(_cat) {
return _cat.slug === category_slugs[0];
})), chap = _.first(_.filter(cat.children, function(_chap) {
return _chap.slug === category_slugs[1];
})), chap.name && cat.name ? HR.appController.setTitle(chap.name + " | " + cat.name) :HR.appController.setTitle("Challenges | " + HR.contest().get("name"))) :HR.appController.setTitle("Challenges | " + HR.contest().get("name")), 
challenges = HR.collection("challenges"), challenges._filter = filter, filter && challenges.setFilters(filter.split("+")), 
challenges.setSortBy(sort_by), challenges.setSortDir(sort_dir), challenges.setContest(contest_slug), 
challenges.setPage(page), challenges.setTrackSlug(category_slugs[0]), challenges.setChapterSlug(category_slugs[1]), 
challenges.setLoginTracking(!0), challenges.cached(), null !== category_slugs && category_slugs.length > 1 && (activeCategory = category_slugs[0]), 
challenges_view = new HR.ChallengesView({
challenges:challenges,
category_slugs:category_slugs,
activeCategory:activeCategory,
...
}, DashboardRouter.prototype.filteredTrackChallengesList = function(track, chapter, filter, sort_by, sort_dir, page) {
return null == filter && (filter = null), null == sort_by && (sort_by = null), null == sort_dir && (sort_dir = null), 
null == page && (page = 1), this.trackChallengesList(track, chapter, page, filter, sort_by, sort_dir);
}, DashboardRouter.prototype.trackChallengesList = function(track, chapter, page, filter, sort_by, sort_dir) {
var track_slugs;
return null == page && (page = 1), null == filter && (filter = null), null == sort_by && (sort_by = null), 
null == sort_dir && (sort_dir = null), track_slugs = [ track, chapter ], $.cookie("hr_tracks", _.compact(track_slugs)), 
this.challengesList2(page, null, null, !1, track_slugs, filter, sort_by, sort_dir, !0);
}, DashboardRouter.prototype.topTrackRedirect = function(track) {
var autoFillMissing, contest, track_slugs, tracks;
return contest = new HR.ContestModel().cached(), track_slugs = [ track ], tracks = contest.currentTracks(track_slugs, autoFillMissing = !0), 
this.navigate(tracks.last().pageURL(), {
trigger:!0,
replace:!0
});
}, DashboardRouter.prototype.trackRedirect = function(track_slug) {
return this.navigate("/categories/" + track_slug, {
trigger:!0,
replace:!0
});
}, DashboardRouter.prototype.tracks = function() {
var tracks_collection;
return HR.appController.setTitle("Tracks"), tracks_collection = HR.collection("track").cached(), 
HR.requires("compound/extra-views", function() {
var view;
return view = new HR.TracksView({
...
}, DashboardRouter.prototype.trackLeaderboard = function(contest_slug, track_slug, page) {
var args;
return null == contest_slug && (contest_slug = "master"), null == track_slug && (track_slug = null), 
null == page && (page = null), args = this.parseLeaderboardArgs(arguments, 3), this.leaderboard({
contest_slug:args[0],
track_slug:args[1],
page:_.last(args)
});
}, DashboardRouter.prototype.filterTrackLeaderboard = function(contest_slug, track_slug, filterString, page) {
var args;
return null == contest_slug && (contest_slug = "master"), null == track_slug && (track_slug = null), 
null == filterString && (filterString = null), null == page && (page = null), args = this.parseLeaderboardArgs(arguments, 4), 
this.leaderboard({
contest_slug:args[0],
track_slug:args[1] || contest_slug,
page:_.last(args),
filterString:args[2]
});
}, DashboardRouter.prototype.challengeLeaderboard = function(contest_slug, challenge_slug, page, filterString) {
var args, model, options;
return null == contest_slug && (contest_slug = "master"), null == challenge_slug && (challenge_slug = null), 
null == page && (page = null), null == filterString && (filterString = null), args = this.parseLeaderboardArgs(arguments, 3), 
options = {
slug:args[1],
contest_slug:args[0]
}, model = HR.model("challenge", options).cached(), HR.requires("compound/challenge-views", function() {
...
collection:HR.collection("contests").cached(),
profile:HR.profile(),
contest_slug:contest_slug,
page:page
...
var $form, btn;
return btn = this, $form = dialog.$form(), btn.unSetFailedMsg(), profile.save("username", dialog.$el().find("input[name=username]").val(), {
...
AppSearchView.prototype.className = "app-search-view", AppSearchView.prototype.render = function() {
var that;
...
$.ajax({
url:"/rest/contests/" + HR.appController.get_current_contest_slug() + "/challenges",
data:{
query:request.term
},
success:function(data) {
return that.$(".search-input i").addClass("icon-search"), that.$(".search-input img").remove(), 
response(_.map(data.models, function(babe) {
return {
label:babe.name,
value:babe.slug
};
...
var url;
return url = "" + HR.appController.get_current_contest_namespace() + "/challenges/" + ui.item.value, 
HR.router.navigate(url, !0);
}
}).data("autocomplete")._renderItem = function(ul, item) {
var ns;
return ns = "" + HR.appController.get_current_contest_namespace() + "/challenges/" + item.value, 
$("<li></li>").data("item.autocomplete", item).append($("<a></a>").append($("<div class='challenge-container search-row'> <div class='search-content pull-left'> <p class=''>" + item.label + "</p> </div> <span class='search-aside pull-right'> <ul class='inline inverse pull-right'> <li class=''> <a href='" + ns + "/forum/questions' class='backbone submit' data-analytics='ViewForum'><i class='icon-comment'></i></a> </li> <li class=''> <a href='" + ns + "/leaderboard' class='backbone submit' data-analytics='ChallengeLeaderboard'><i class='icon-trophy'></i></a> </li> <li class=''> <a href='" + ns + "/submissions' class='backbone'><i class='icon-list-bullet-small'></i></a> </li> </ul> </span> </div>"))).appendTo(ul);
}, this);
}, AppSearchView;
...
return this.contest_slug = options.contest_slug, this.profile = options.profile, 
this.collection = options.collection, this.page = options.page || 1, this.listenTo(this.collection, "reset", this.render), 
...
"click div.down":"showMore"
}, ContestsView.prototype.setActive = function() {
return this.collection.length > 0 ? (this.contest_slug || (this.contest_slug = _.first(this.collection.models).get("slug")), 
_.each(this.collection.models, function(_this) {
return function(model) {
var isActive;
return model.get("slug") === _this.contest_slug && (isActive = model), model.active = isActive, 
isActive ? _this.contest = model :void 0;
};
}(this)), this.contest && this.contest.get("slug") !== HR.CONTEST_NAMESPACE ? (this.challenges || (this.challenges = HR.collection("challenges"), 
this.challenges.setContest(this.contest_slug), this.challenges.setPage(this.page), 
this.challenges.cached(), this.listenTo(this.challenges, "reset", this.render)), 
!0) :(HR.appController.slugDetector(this.contest_slug, function(_this) {
return function(resp) {
return "contest" === resp.type ? setTimeout(function() {
return HR.router.navigate("contests/" + _this.contest_slug + "/challenges", {
trigger:!0,
replace:!0
});
}, 0) :void 0;
...
var background_image, button, challengesContainer, challenges_div, contest_button, enter_button, message, signup_button;
...
var tabsContainer;
return tabsContainer = $(), _.each(group.contests.slice(0, 10), function(model) {
var _view;
return _view = new HR.ContestsTabView({
model:model,
that:this
}), tabsContainer.push(_view.render().el), this.add_subview(_view);
}, _this), group.contests.length > 10 && tabsContainer.push($("<div class='down m' data-offset='10'><div><a class='btn btn-text'><i class='icon-down-open-mini'></i>Load 10 More</a></div></div>").get(0)), 
_this.$(".contests_list-" + group.key).html(tabsContainer);
};
}(this)), challenges_div = this.$("div.challenges-list"), this.contest ? this.contest.get("archived") ? this.challenges && (this.challenges.sync_status || this.challenges.length > 0) ? (challengesContainer = $(), 
...
var profile;
return mixpanel.track("Contest Signup", {
contest:_this.contest_slug,
username:HR.profile().get("username")
}), data.status ? (that.collection.cached({
fetch:!0
}), that.render()) :(profile = HR.profile(), profile.isLoggedIn() ? alert(data.message) :new HR.util.ShowLoginDialog({
show_sign_up_link:!0,
...
}, ContestsView.prototype.showMore = function(e) {
var group_name, offset;
return e.preventDefault(), group_name = $(e.currentTarget).parent().attr("class").split("contests_list-")[1], 
offset = parseInt($(e.currentTarget).attr("data-offset")), _.each(this.collection.grouped(), function(_this) {
return function(group) {
var new_offset;
return group.key === group_name ? (HR.list = group.contests, _.each(group.contests.slice(offset, offset + 10), function(model) {
var _view;
return _view = new HR.ContestsTabView({
model:model,
that:this
}), this.$(".contests_list-" + group_name).append(_view.render().el), this.add_subview(_view);
}, _this), new_offset = offset + 10, group.contests.length > new_offset && _this.$(".contests_list-" + group_name).append($("<div class='down m' data-offset='" + new_offset + "'><div><a class='btn btn-text'><i class='icon-down-open-mini'></i>Load 10 More</a></div></div>").get(0)), 
$(e.currentTarget).remove()) :void 0;
};
}(this));
}, ContestsView;
...
CountdownTimerView.prototype.className = "countdowntimer-view", CountdownTimerView.prototype.initialize = function() {
return this.listenTo(this.model, "reset", this.render), this.listenTo(this.model, "change", this.render);
...
return this.$(".modal-header .header-msg").html(this.frames[this.currentFrame].header), 
...
this.contest = HR.model("contest"), this.contest.set("slug", options.contest_slug), 
this.contest.cached(), this.challenges = options.challenges, this.category_slugs = options.category_slugs, 
this.profile = HR.profile(), this.is_track_view = options.is_track_view, this.listenTo(this.challenges, "reset", this.render);
...
return this.filter ? (tags = this.filter.split("+"), $.each([ "complete", "incomplete", "sponsored" ], function(index, elem) {
var elemindex;
return elemindex = $.inArray(elem, tags), elemindex >= 0 ? tags.splice(elemindex, 1) :void 0;
...
jQuery(function() {
var HR, Onboarding3View, _ref;
return Onboarding3View = function(_super) {
function Onboarding3View() {
return Onboarding3View.__super__.constructor.apply(this, arguments);
}
return __extends(Onboarding3View, _super), Onboarding3View.prototype.el = "#onboarding3-content", 
Onboarding3View.prototype.template = "onboarding3", Onboarding3View.prototype.initialize = function(options) {
return null == options && (options = {}), Onboarding3View.__super__.initialize.apply(this, arguments), 
this.mxpnl = {
hacker:HR.profile().get("username"),
variant:"onboardingv3"
};
}, Onboarding3View.prototype.events = {
'shown a[data-toggle="tab"]':"tabShown",
"click .btn-github":"githubLogin",
"click .btn-facebook":"facebookLogin",
"change .hr-profileData":"updateProfile",
'click label input[type="radio"]':"pickCategory",
"click .hr-end-onboarding":"destroy"
}, Onboarding3View.prototype.pickCategory = function(e) {
var fav;
return fav = $(e.target).val(), this.model.set("favorite_category", fav), mixpanel && mixpanel.track && mixpanel.track("OnboardingSelect", {
category:fav
}), this.model.save(), this.$("#onboarding_window-type label input[type=radio]").parent().removeClass("active"), 
$(e.target).parent().addClass("active"), this;
}, Onboarding3View.prototype.updateProfile = function(e) {
var key, val;
return val = $(e.target).val(), key = $(e.target).attr("data-profile-attr"), this.mxpnl["changed_" + key] = !0, 
this.model.set(key, val), this.model.save(), this;
}, Onboarding3View.prototype.tabShown = function(e) {
var cat_page_mapping;
return this.mxpnl.step = $(e.target).attr("href"), mixpanel.track("tour-intro2", this.mxpnl), 
this.$("li [data-toggle='tab']").parent().removeClass("active"), this.$("li [href=" + $(e.target).attr("href") + "]").parent().addClass("active"), 
this.model.get("favorite_category") && "#onboarding_window-final" === $(e.target).attr("href") && (cat_page_mapping = {
fp:"/categories/fp/intro",
ml:"/categories/ai/machine-learning",
codegolf:"/categories/miscellaneous/normal-languages",
algorithms:"/categories/algorithms/sorting",
games:"/categories/ai/introduction"
}, HR.router.navigate(cat_page_mapping[this.model.get("favorite_category")], {
trigger:!0
})), this;
}, Onboarding3View.prototype.githubLogin = function(e) {
return HR.appController.github_login(e);
}, Onboarding3View.prototype.facebookLogin = function(e) {
return HR.appController.facebook_login(e);
}, Onboarding3View.prototype.applyTemplate = function() {
return this.$el.html(this._template({
model:this.model
}));
}, Onboarding3View;
}(window.HR.GenericView), HR = null != (_ref = window.HR) ? _ref :{}, HR.Onboarding3View = Onboarding3View;
});
}.call(this), function() {
var __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
function ctor() {
