...
intialize:function() {},
url:function() {
return this.isNew() ? "/x/api/v1/instances" :"/x/api/v1/instances/" + this.get("id");
},
...
setPassword:function(pass, sudo, reportname, hours) {
null == hours && (hours = 24), HR.notifications.push("info", "Setting up task, and password on: " + this.get("id")), 
this.save({
...
initialize:function() {},
urlRoot:"/x/api/v1/taskreports",
parse:function(resp) {
return resp.model ? resp.model :resp;
}
}), HR.UserModel = Backbone.Model.extend({
initialize:function() {},
url:"/x/api/v1/tasks/login",
...
logout:function() {
$.get("/x/api/v1/tasks/logout"), setTimeout(function() {
...
setupTask:function() {
var hours, password, reportname, sudoaccess;
password = this.$(".passwd").val(), sudoaccess = this.$(".sudocheck").prop("checked"), 
hours = this.$(".hours").val(), reportname = this.$(".reportname").val(), this.model.setPassword(password, sudoaccess, reportname, hours), 
