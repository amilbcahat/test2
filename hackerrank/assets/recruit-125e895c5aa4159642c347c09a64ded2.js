...
return tests = new HR.TestsCollection(), tests.setPage(page), HR.search || (HR.search = {}), 
HR.search.tests || (HR.search.tests = new HR.SearchItemsCollection()), HR.search.tests.setType("tests"), 
...
return "coding" !== filter && "multiple" !== filter && "others" !== filter && (access = filter, 
...
return null == step && (step = "step1"), alert("reached"), HR.requires([ "compound/x/recruit-basic" ], function() {
var test;
return test = new HR.TestModel({
id:tid
}), test.fetch({
