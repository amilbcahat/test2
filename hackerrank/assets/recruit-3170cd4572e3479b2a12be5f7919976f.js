...
"tests/search/":"testsSearch",
"tests/search/page/:page":"testsSearch_nofilter",
"tests/search/:filters":"testsSearch",
"tests/search/:filters/page/:page":"testsSearch",
...
var render_view, tests, _ref;
return tests = new HR.TestsCollection(), tests.setPage(page), HR.search = null != (_ref = HR.search) ? _ref :{}, 
HR.search.tests = new HR.SearchItemsCollection(), HR.search.tests.setType("tests"), 
...
return null == page && (page = 1), this.tests(page, filters, !0);
}, RecruitRouter.prototype.testsSearch = function(filters, page) {
return null == filters && (filters = ""), null == page && (page = 1), this.tests(page, filters, !0);
