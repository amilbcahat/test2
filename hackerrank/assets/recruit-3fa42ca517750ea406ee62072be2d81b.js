...
jQuery(function() {
var HR, beautifyDates, capitalize, changeTimeZoneDialog, compareArrays, convertToSlug, fixedInfo, formatDate, formatDateRange, formatDateTime, formatTimeInUserTz, getCandidateDetailsMapping, linkify, prettyPrintSeconds, readableQuestionType, track, _ref;
...
return HR.requires("compound/x/recruit-basic", function() {
var api_clients;
return api_clients = new HR.ApiClientsCollection(), api_clients.fetch({
success:function() {
return function() {
var settings_view, track_data;
return track_data = {
