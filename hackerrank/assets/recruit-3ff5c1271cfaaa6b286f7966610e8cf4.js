...
attempt_id:aid,
test_id:tid
}, HR.util.track("Viewed Test Report", track_data), HR.util.trackTotango("Viewed Test Report", "Tests"), 
_showReportView = function(tmodel, trview, tab) {
...
type:type,
test_id:model.get("id")
}, "code" === type || "approx" === type ? (HR.util.track("Added new coding question", track_data), 
HR.util.trackTotango("Added New Coding Question", "Tests")) :(HR.util.track("Added new other question", track_data), 
HR.util.trackTotango("Added New Other Question", "Tests"));
};
}(this),
error:function() {
return console.log("error");
