...
jQuery(function() {
var HR, beautifyDates, capitalize, changeTimeZoneDialog, compareArrays, convertToSlug, fixedInfo, formatDate, formatDateRange, formatDateTime, getCandidateDetailsMapping, linkify, prettyPrintSeconds, readableQuestionType, _ref;
...
HR.util.linkify = linkify, HR.util.fixedInfo = fixedInfo;
});
}.call(this), function() {
