...
model:model,
action:action
}), "download" === action ? (HR.appView.setTopNavigationView(model), HR.appView.setFullContentView(test_questions_view)) :HR.appView.setSplitContentView("test", model, "questions", test_questions_view);
};
}(this),
error:function() {
return console.log("error");
...
return question_create_view = new HR.LibraryQuestionEditView({
qid:qid,
step:step,
type:type
