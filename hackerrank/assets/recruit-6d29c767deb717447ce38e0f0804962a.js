...
jQuery(function() {
var HR, arrayToString, beautifyDates, capitalize, changeTimeZoneDialog, compareArrays, convertToSlug, fixedInfo, formatDate, formatDateRange, formatTimeInUserTz, getCandidateDetailsMapping, linkify, prettyPrintSeconds, readableQuestionType, track, trackTotango, _ref;
...
HR.util.formatDate = formatDate, HR.util.capitalize = capitalize, HR.util.changeTimeZoneDialog = changeTimeZoneDialog, 
HR.util.beautifyDates = beautifyDates, HR.util.linkify = linkify, HR.util.fixedInfo = fixedInfo, 
HR.util.track = track, HR.util.trackTotango = trackTotango, HR.util.formatTimeInUserTz = formatTimeInUserTz, 
...
}, UserModel.prototype.canViewCandidateDetails = function() {
return this.get("company") && this.get("company").developers_see_candidate_details && "False" === this.get("company").developers_see_candidate_details && "developer" === this.get("role") ? !1 :!0;
}, UserModel;
...
this.$("#hre-sidebar").hasClass("open") ? this.$("#hre-content").addClass("open") :this.$("#hre-content").removeClass("open");
...
sidebar = this.$("#hre-sidebar"), $("#hre-content").hasClass("open") ? sidebar.removeClass("closed").addClass("open") :sidebar.removeClass("open").addClass("closed");
...
sidebar.hasClass("open") ? ($(sidebar).removeClass("open").addClass("closed"), content.removeClass("open")) :(content.addClass("open"), 
