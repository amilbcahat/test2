...
jQuery(function() {
var HR, arrayToString, beautifyDates, capitalize, changeTimeZoneDialog, compareArrays, convertToSlug, fixedInfo, formatDate, formatDateRange, formatDateTime, formatTimeInUserTz, getCandidateDetailsMapping, linkify, prettyPrintSeconds, readableQuestionType, track, _ref;
...
HR.util.formatTimeInUserTz = formatTimeInUserTz, HR.util.arrayToString = arrayToString;
});
}.call(this), function() {
...
totango.track("Added New Coding Question", "Tests")) :(HR.util.track("Added new other question", track_data), 
totango.track("Added New Coding Question", "Tests"));
};
}(this),
error:function() {
return console.log("error");
...
track_data = {
step:"Start"
}, HR.util.track("Created Interview", track_data), totango.track("Created Interview", "Interviews");
});
...
}, RecruitRouter.prototype.environment = function() {
return HR.requires("compound/x/recruit-basic", function() {
var view;
return view = new HR.EnvironmentView(), HR.appView.setFullContentView(view);
});
