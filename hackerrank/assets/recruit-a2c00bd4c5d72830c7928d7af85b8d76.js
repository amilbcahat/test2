...
jQuery(function() {
var HR, beautifyDates, capitalize, changeTimeZoneDialog, compareArrays, convertToSlug, formatDate, formatDateRange, formatDateTime, getCandidateDetailsMapping, linkify, prettyPrintSeconds, readableQuestionType, track, _ref;
...
return null == data && (data = {}), null == callback && (callback = ""), void 0 !== typeof mixpanel ? _.isEmpty(callback) ? mixpanel.track(event, data) :mixpanel.track(event, data, callback) :void 0;
...
HR.util.linkify = linkify, HR.util.track = track;
});
}.call(this), function() {
...
Page:type,
test_id:tid
}, subtype && (track_data.sub_type = subtype), HR.util.track("Viewed Test Report", track_data), 
