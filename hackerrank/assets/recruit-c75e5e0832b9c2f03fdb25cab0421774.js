...
url:"/xrest/users",
success:function(m) {
return m.get("id") ? (HR.UserSettings.setId(m.get("id")), HR.appView.setTopNavigationView(HR.currentUser)) :void 0;
},
...
page:page
}), console.log(tests_view), HR.appView.setFullContentView(tests_view);
};
...
console.log("here"), this.contentView && (this.destroyView(this.contentView), this.contentView = null, 
this.$("#hre-content").html(""), this.$("#hre-content").addClass("hidden")), this.fullContentView && this.destroyView(this.fullContentView), 
this.fullContentView = view, console.log(view.render().el), this.$("#hre-full-content").html(view.render().el), 
