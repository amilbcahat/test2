...
}, RecruitController.prototype.log = Backbone.log, RecruitController.prototype.fetchManifest = function() {
return $.ajax({
url:"/misc/manifest/" + HR.MANIFEST_HASH,
dataType:"json",
cache:!0
});
}, RecruitController.prototype.manifest = function() {
var cachedManifest;
...
}, RecruitController.prototype.staticPath = function(path, base_path) {
return null == base_path && (base_path = null), base_path = "/assets", this.manifest() ? path = this.manifest()[path] || path :base_path = "/assets", 
"" + base_path + "/" + path;
...
return this.resizeHandler = __bind(this.resizeHandler, this), RecruitView.__super__.constructor.apply(this, arguments);
}
...
}, RecruitView.prototype.resizeHandler = function() {
var resizeTimer;
return clearTimeout(resizeTimer), resizeTimer = setTimeout(this.leftBarResponsive, 500);
