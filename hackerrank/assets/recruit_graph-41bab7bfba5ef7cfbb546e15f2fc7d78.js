...
this.addStencilPalette("flowchart", "Flowchart", dir + "/flowchart.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1);
}, Sidebar.prototype.addAWSPalette = function(expand) {
var dir = STENCIL_PATH;
this.addStencilPalette("aws", "AWS / Compute ", dir + "/aws/compute.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / Content Delivery ", dir + "/aws/content_delivery.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / Database ", dir + "/aws/database.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / Deployment ", dir + "/aws/deployment_management.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / Groups ", dir + "/aws/groups.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / Messaging ", dir + "/aws/messaging.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / Miscellaneous ", dir + "/aws/misc.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / Networking ", dir + "/aws/networking.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / Non Service Specific ", dir + "/aws/non_service_specific.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / On Demand ", dir + "/aws/on_demand_workforce.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1), 
this.addStencilPalette("aws", "AWS / Storage ", dir + "/aws/storage.xml", ";fillColor=#ffffff;strokeColor=#000000;strokeWidth=2", expand || !1);
}, Sidebar.prototype.addClipartPalette = function() {
var dir = STENCIL_PATH;
...
}, Sidebar.prototype.addBpmnPalette = function(expand) {
this.addPalette("bpmn", "BPMN " + mxResources.get("general"), expand || !1, mxUtils.bind(this, function(content) {
