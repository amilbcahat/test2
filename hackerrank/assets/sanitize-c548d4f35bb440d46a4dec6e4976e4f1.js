...
var list = m1, list_type = m2.search(/[*+-]/g) > -1 ? "ul" :"ol", result = _ProcessListItems(list, list_type);
...
return contains_double_newline || last_item_had_a_double_newline ? item = _RunBlockGamut(_Outdent(item), !0) :(item = _DoLists(_Outdent(item)), 
item = item.replace(/\n$/, ""), item = _RunSpanGamut(item)), last_item_had_a_double_newline = ends_with_double_newline, 
"<li>" + item + "</li>\n";
