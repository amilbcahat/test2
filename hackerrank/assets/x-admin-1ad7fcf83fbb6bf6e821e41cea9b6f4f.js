...
return id = result.id, primary = HR.util.htmlEncode(result.primary), secondary = HR.util.htmlEncode(result.secondary), 
markup = "<table class='result-result'><tr>", markup += primary ? "<td class='result-info'><div class='result-title'>" + id + " : " + primary + "</div>" :"<td class='result-info'><div class='result-title'>" + id + "</div>", 
secondary && (markup += "<div class='result-data'>" + secondary + "</div>"), markup += "</td></tr></table>";
}, formatSelection = function(result) {
var primary;
return primary = HR.util.htmlEncode(result.primary), primary ? "" + result.id + " : " + primary :void 0;
...
}, XAdminController.prototype.logicalTemplatePath = function(template) {
...
}(window.HR.CommonController), HR = null != (_ref = window.HR) ? _ref :{}, HR.XAdminController = XAdminController;
});
}.call(this), function() {
...
"admin/attempts":"attemptsDashboard",
"admin/user/change_email":"user_change_email",
"admin/company/extend_trial":"companyExtendTrial",
"admin/company/add_invites":"companyAddInvites",
"admin/question/duplicate":"question_duplicate",
"admin/question/change_owner":"questionChangeOwner",
"admin/question/duplicate_from_hr":"duplicateQuestionFromHR",
"admin/reports/invites":"adminInviteReports",
"admin/reports/attempts":"adminAttemptReports",
"admin/reports/periodic":"adminPeriodicReports",
"admin/reports/periodic/add":"createAdminPeriodicReports",
"admin/reports/periodic/:id/edit":"editAdminPeriodicReports",
...
"analytics/users/signups":"analyticsUserSignups",
...
}, XAdminRouter.prototype.attemptsDashboard = function() {
return HR.requires([ "compound/x-admin/basic" ], function() {
var view;
return view = new HR.AttemptsDashboardView(), HR.appView.setSplitContentView("admin", null, "attempts_dashboard", view);
});
...
}, XAdminRouter.prototype.questionChangeOwner = function() {
return HR.requires([ "compound/x-admin/basic" ], function() {
var view;
return view = new HR.QuestionChangeOwnerView(), HR.appView.setSplitContentView("admin", null, "change_question_owner", view);
});
}, XAdminRouter.prototype.duplicateQuestionFromHR = function() {
return HR.requires([ "compound/x-admin/basic" ], function() {
var view;
return view = new HR.QuestionDuplicateFromHRView(), HR.appView.setSplitContentView("admin", null, "duplicate_q_from_hr", view);
});
...
}, XAdminRouter.prototype.companyAddInvites = function() {
return HR.requires([ "compound/x-admin/basic" ], function() {
var view;
return view = new HR.CompanyAddInvitesView(), HR.appView.setSplitContentView("admin", null, "add_invites", view);
});
}, XAdminRouter.prototype.adminInviteReports = function() {
return HR.requires([ "compound/x-admin/basic" ], function() {
var view;
return view = new HR.AdminInviteReportsView(), HR.appView.setSplitContentView("admin", null, "invite_reports", view);
});
}, XAdminRouter.prototype.adminAttemptReports = function() {
return HR.requires([ "compound/x-admin/basic" ], function() {
var view;
return view = new HR.AdminAttemptReportsView(), HR.appView.setSplitContentView("admin", null, "attempt_reports", view);
});
}, XAdminRouter.prototype.adminPeriodicReports = function() {
return HR.requires([ "compound/x-admin/basic" ], function() {
var collection;
return collection = new HR.PeriodicReportsCollection(), collection.fetch({
success:function(collection) {
var view;
return view = new HR.AdminPeriodicReportsView({
collection:collection
}), HR.appView.setSplitContentView("admin", null, "periodic_reports", view);
}
});
});
}, XAdminRouter.prototype.createAdminPeriodicReports = function() {
return HR.requires([ "compound/x-admin/basic" ], function() {
var view;
return view = new HR.AdminAddPeriodicReportsView(), HR.appView.setSplitContentView("admin", null, "periodic_reports", view);
});
}, XAdminRouter.prototype.editAdminPeriodicReports = function(id) {
return HR.requires([ "compound/x-admin/basic" ], function() {
var model;
return model = new HR.PeriodicReportModel({
id:id
}), model.fetch({
success:function(model) {
var view;
return view = new HR.AdminEditPeriodicReportsView({
entity:model
}), HR.appView.setSplitContentView("admin", null, "periodic_reports", view);
}
});
...
return HR.requires([ "compound/x-analytics/basic" ], function() {
var view;
return view = new HR.CompaniesDashboardView(), HR.appView.setSplitContentView("analytics", null, "companies_dash", view);
});
...
return HR.requires([ "compound/x-analytics/basic" ], function() {
var view;
return view = new HR.CompanySignupsView(), HR.appView.setSplitContentView("analytics", null, "trial_signups", view);
});
}, XAdminRouter.prototype.analyticsUserSignups = function() {
return HR.requires([ "compound/x-analytics/basic" ], function() {
var view;
return view = new HR.UserSignupsView(), HR.appView.setSplitContentView("analytics", null, "user_signups", view);
});
