...
"analytics/watchlist":"analytics_watchlist",
"404":"not_found",
"*notFound":"catchall"
...
}, XAdminRouter.prototype.analytics_watchlist = function() {
return HR.requires("compound/x-analytics/basic", function() {
var collection;
return collection = new HR.WatchlistCollection(), collection.fetch({
success:function(collection) {
var view;
return view = new HR.WatchlistView({
collection:collection
}), HR.appView.setSplitContentView("analytics", null, "watchlist", view);
}
});
});
